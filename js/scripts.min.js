...
var ib = ib || {};
ib.Config = ib.Config || {}, ib.Config = $.extend(ib.Config, {
    assetBasePath: `https://${window.location.hostname}`,
    SKIP_INTRO: !1,
    START_KEYFRAME_INDEX: 1,
    MUTE_AUDIO: !1
});
var ib = ib || {};
ib.isIE = /MSIE (\d+\.\d+);/.test(navigator.userAgent), function () {
...
!function (a, b) {
    ...
    l.prototype = {
        compiler: l, disassemble: function () {
    ...
    m.prototype = {
        nameLookup: function (a, b) {
        ...
        }, namespace: "Handlebars", compile: function (b, c, d, e) {
            this.environment = b, this.options = c || {}, a.log(a.logger.DEBUG, this.environment.disassemble() + "\n\n"), this.name = this.environment.name, this.isChild = !!d, this.context = d || {
                ...
                environments: [],
                aliases: {}
            }, this.preamble(), this.stackSlot = 0, this.stackVars = [], this.registers = {list: []}, this.compileStack = [], this.inlineStack = [], this.compileChildren(b, c);
            var f, g = b.opcodes;
            ...
            var c = this.setupHelper(0, a, b), d = this.lastHelper = this.nameLookup("helpers", a, "helper"),
                e = this.nameLookup("depth" + this.lastContext, a, "context"), f = this.nextStack();
        ...
        }, compiler: m, compileChildren: function (a, b) {
    ...
    m.isValidJavaScriptVariableName = function (a) {
        ...
        template: function (b) {
            ...
            return function (d, e) {
                e = e || {};
                var f = b.call(c, a, d, e.helpers, e.partials, e.data), g = c.compilerInfo || [], h = g[0] || 1,
...
}(Handlebars),/*! Copyright (c) 2011 Brandon Aaron (http://brandonaaron.net)
 ...
 **/
    (window._gsQueue || (window._gsQueue = [])).push(function () {
        ...
        window._gsDefine("TweenMax", ["core.Animation", "core.SimpleTimeline", "TweenLite"], function (a, b, c) {
            ...
            e.version = "1.10.3", g.constructor = e, g.kill()._gc = !1, e.killTweensOf = e.killDelayedCallsTo = c.killTweensOf, e.getTweensOf = c.getTweensOf, e.ticker = c.ticker, g.invalidate = function () {
                ...
                var d, e, f, g, i, j, k, l = this._dirty ? this.totalDuration() : this._totalDuration, m = this._time,
                    n = this._totalTime, o = this._cycle;
            ...
            e.killAll = function (a, c, d, e) {
                ...
                if (null != a) {
                    ...
                    if ("string" == typeof a && (a = c.selector(a) || a), f(a) && (a = d(a, 0)), a instanceof Array) for (j = a.length; --j > -1;) e.killChildTweensOf(a[j], b); else {
                        g = [];
                        for (i in l) for (h = l[i].target.parentNode; h;) h === a && (g = g.concat(l[i].tweens)), h = h.parentNode;
            ...
            return d.version = "1.10.3", i.constructor = d, i.kill()._gc = !1, i.to = function (a, b, d, e) {
                ...
                var m, n = new d({onComplete: j, onCompleteParams: k, onCompleteScope: l});
                ...
                if (b.prototype.add.call(this, e, f), this._gc && !this._paused && this._duration < this.duration()) for (m = this, n = m.rawTime() > e._startTime; m._gc && m._timeline;) m._timeline.smoothChildTiming && n ? m.totalTime(m._totalTime, !0) : m._enabled(!0, !1), m = m._timeline;
                return this
            }, i.remove = function (b) {
                ...
                var d, f, g, h, i, j = this._dirty ? this.totalDuration() : this._totalDuration, k = this._time,
                    l = this._startTime, m = this._timeScale, n = this._paused;
            ...
            return h.constructor = d, h.kill()._gc = !1, d.version = "1.10.3", h.invalidate = function () {
                ...
                c = c || {};
                var d, g, h = {ease: f, overwrite: 2, useFrames: this.usesFrames(), immediateRender: !1};
                for (d in c) h[d] = c[d];
                ...
                this._gc && this._enabled(!0, !1);
                var d, f, g, h, i, j, k = this._dirty ? this.totalDuration() : this._totalDuration, l = this._duration,
                    m = this._time, n = this._totalTime, o = this._startTime, p = this._timeScale,
                    q = this._rawPrevTime, r = this._paused, s = this._cycle;
                if (a >= k ? (this._locked || (this._totalTime = k, this._cycle = this._repeat), this._reversed || this._hasPausedChild() || (f = !0, h = "onComplete", 0 === l && (0 === a || 0 > this._rawPrevTime) && this._rawPrevTime !== a && this._first && (i = !0, this._rawPrevTime > 0 && (h = "onReverseComplete"))), this._rawPrevTime = a, this._yoyo && 0 !== (1 & this._cycle) ? this._time = a = 0 : (this._time = l, a = l + 1e-6)) : 1e-7 > a ? (this._locked || (this._totalTime = this._cycle = 0), this._time = 0, (0 !== m || 0 === l && this._rawPrevTime > 0 && !this._locked) && (h = "onReverseComplete", f = this._reversed), 0 > a ? (this._active = !1, 0 === l && this._rawPrevTime >= 0 && this._first && (i = !0), this._rawPrevTime = a) : (this._rawPrevTime = a, a = 0, this._initted || (i = !0))) : (this._time = this._rawPrevTime = a, this._locked || (this._totalTime = a, 0 !== this._repeat && (j = l + this._repeatDelay, this._cycle = this._totalTime / j >> 0, 0 !== this._cycle && this._cycle === this._totalTime / j && this._cycle--, this._time = this._totalTime - this._cycle * j, this._yoyo && 0 !== (1 & this._cycle) && (this._time = l - this._time), this._time > l ? (this._time = l, a = l + 1e-6) : 0 > this._time ? this._time = a = 0 : a = this._time))), this._cycle !== s && !this._locked) {
                    var t = this._yoyo && 0 !== (1 & s), u = t === (this._yoyo && 0 !== (1 & this._cycle)),
                        v = this._totalTime, w = this._cycle, x = this._rawPrevTime, y = this._time;
                ...
                if (!(this._time !== m && this._first || c || i)) return n !== this._totalTime && this._onUpdate && (b || this._onUpdate.apply(this.vars.onUpdateScope || this, this.vars.onUpdateParams || e)), void 0;
            ...
            var a = 180 / Math.PI, b = Math.PI / 180, c = [], d = [], e = [], f = {}, g = function (a, b, c, d) {
                ...
                i = function (a, b, c, d) {
                    ...
                    propName: "bezier", priority: -1, API: 2, global: !0, init: function (a, b, c) {
                        ...
                        if (n = this._autoRotate) for (n[0] instanceof Array || (this._autoRotate = n = [n]), f = n.length; --f > -1;) for (g = 0; 3 > g; g++) d = n[f][g], this._func[d] = "function" == typeof a[d] ? a[d.indexOf("set") || "function" != typeof a["get" + d.substr(3)] ? d : "get" + d.substr(3)] : !1;
                        return !0
                    }, set: function (b) {
            ...
            var j, k, l, m, n, o, p = /(?:\d|\-\d|\.\d|\-\.\d)+/g,
                q = /(?:\d|\-\d|\.\d|\-\.\d|\+=\d|\-=\d|\+=.\d|\-=\.\d)+/g,
                r = /(?:\+=|\-=|\-|\b)[\d\-\.]+[a-zA-Z0-9]*(?:%|\b)/gi, s = /[^\d\-\.]/g, t = /(?:\d|\-|\+|=|#|\.)*/g,
                u = /opacity *= *([^)]*)/, v = /opacity:([^;]*)/, w = /alpha\(opacity *=.+?\)/i, x = /^(rgb|hsl)/,
                y = /([A-Z])/g, z = /-([a-z])/gi, A = /(^(?:url\(\"|url\())|(?:(\"\))$|\)$)/gi, B = function (a, b) {
                    return b.toUpperCase()
                }, C = /(?:Left|Right|Width)/i, D = /(M11|M12|M21|M22)=[\d\-\.e]+/gi,
                E = /progid\:DXImageTransform\.Microsoft\.Matrix\(.+?\)/i, F = /,(?=[^\)]*(?:\(|$))/gi,
                G = Math.PI / 180, H = 180 / Math.PI, I = {}, J = document, K = J.createElement("div"),
                L = J.createElement("img"), M = g._internals = {_specialProps: h}, N = navigator.userAgent,
                O = function () {
                ...
                _ = ["marginLeft", "marginRight", "marginTop", "marginBottom"], ab = function (a, b, c) {
                    ...
                    var c = a.split(" "), d = -1 !== a.indexOf("left") ? "0%" : -1 !== a.indexOf("right") ? "100%" : c[0],
            ...
            var jb = function (a, b, c, d) {
                ...
                var e, f = b ? (a.match(ib) || [""])[0] : "", g = a.split(f).join("").match(r) || [],
                    h = a.substr(0, a.indexOf(g[0])), i = ")" === a.charAt(a.length - 1) ? ")" : "",
                    j = -1 !== a.indexOf(" ") ? " " : ",", k = g.length, l = k > 0 ? g[0].replace(p, "") : "";
            ...
            var sb = "scaleX,scaleY,scaleZ,x,y,z,skewX,rotation,rotationX,rotationY,perspective".split(","),
                tb = T("transform"), ub = R + "transform", vb = T("transformOrigin"), wb = null !== T("perspective"),
                xb = function (a, b, c, d) {
                    if (a._gsTransform && c && !d) return a._gsTransform;
                    var e, f, h, i, j, k, l, m, n, o, p, q, r, s = c ? a._gsTransform || {skewY: 0} : {skewY: 0},
                        t = 0 > s.scaleX, u = 2e-5, v = 1e5, w = -Math.PI + 1e-4, x = Math.PI - 1e-4,
                    ...
                    if (16 === f.length) {
                        ...
                        if (s.zOrigin && (F = -s.zOrigin, C = z * F - f[12], E = A * F - f[13], F = B * F + s.zOrigin - f[14]), !c || d || null == s.rotationX) {
                            var G, H, I, J, K, L, M, N = f[0], O = f[1], P = f[2], Q = f[3], R = f[4], S = f[5],
                                T = f[6], U = f[7], W = f[11], X = s.rotationX = Math.atan2(T, B), Y = w > X || X > x;
                        ...
                        var Z = f.length >= 6, $ = Z ? f[0] : 1, _ = f[1] || 0, ab = f[2] || 0, bb = Z ? f[3] : 1;
                    ...
                    var b, c, d = this.data, e = -d.rotation, f = e + d.skewX, g = 1e5,
                        h = (0 | Math.cos(e) * d.scaleX * g) / g, i = (0 | Math.sin(e) * d.scaleX * g) / g,
                        j = (0 | Math.sin(f) * -d.scaleY * g) / g, k = (0 | Math.cos(f) * d.scaleY * g) / g,
                        l = this.t.style, m = this.t.currentStyle;
                    if (m) {
                        c = i, i = -j, j = -c, b = m.filter, l.filter = "";
                        var n, p, q = this.t.offsetWidth, r = this.t.offsetHeight, s = "absolute" !== m.position,
                    ...
                    var a, b, c, d, e, f, g, h, i, j, k, l, n, o, p, q, r, s, t, u, v, w, x, y, z, A, B = this.data,
                        C = this.t.style, D = B.rotation, E = B.scaleX, F = B.scaleY, G = B.scaleZ, H = B.perspective;
                    if (m && (y = C.top ? "top" : C.bottom ? "bottom" : parseFloat(V(this.t, "top", null, !1)) ? "bottom" : "top", u = V(this.t, y, null, !1), z = parseFloat(u) || 0, A = u.substr((z + "").length) || "px", B._ffFix = !B._ffFix, C[y] = (B._ffFix ? z + .05 : z - .05) + A), D || B.skewX) s = Math.cos(D), t = Math.sin(D), a = s, e = t, B.skewX && (D -= B.skewX, s = Math.cos(D), t = Math.sin(D)), b = -t, f = s; else {
                        if (!(B.rotationY || B.rotationX || 1 !== G || H)) return C[tb] = "translate3d(" + B.x + "px," + B.y + "px," + B.z + "px)" + (1 !== E || 1 !== F ? " scale(" + E + "," + F + ")" : ""), void 0;
                        a = f = 1, b = e = 0
                    }
                    k = 1, c = d = g = h = i = j = l = n = o = 0, p = H ? -1 / H : 0, q = B.zOrigin, r = 1e5, D = B.rotationY, D && (s = Math.cos(D), t = Math.sin(D), i = k * -t, n = p * -t, c = a * t, g = e * t, k *= s, p *= s, a *= s, e *= s), D = B.rotationX, D && (s = Math.cos(D), t = Math.sin(D), u = b * s + c * t, v = f * s + g * t, w = j * s + k * t, x = o * s + p * t, c = b * -t + c * s, g = f * -t + g * s, k = j * -t + k * s, p = o * -t + p * s, b = u, f = v, j = w, o = x), 1 !== G && (c *= G, g *= G, k *= G, p *= G), 1 !== F && (b *= F, f *= F, j *= F, o *= F), 1 !== E && (a *= E, e *= E, i *= E, n *= E), q && (l -= q, d = c * l, h = g * l, l = k * l + q), d = (u = (d += B.x) - (d |= 0)) ? (0 | u * r + (0 > u ? -.5 : .5)) / r + d : d, h = (u = (h += B.y) - (h |= 0)) ? (0 | u * r + (0 > u ? -.5 : .5)) / r + h : h, l = (u = (l += B.z) - (l |= 0)) ? (0 | u * r + (0 > u ? -.5 : .5)) / r + l : l, C[tb] = "matrix3d(" + [(0 | a * r) / r, (0 | e * r) / r, (0 | i * r) / r, (0 | n * r) / r, (0 | b * r) / r, (0 | f * r) / r, (0 | j * r) / r, (0 | o * r) / r, (0 | c * r) / r, (0 | g * r) / r, (0 | k * r) / r, (0 | p * r) / r, d, h, l, H ? 1 + -l / H : 1].join(",") + ")"
                }, Ab = function () {
            ...
            qb("transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,transformPerspective,directionalRotation,parseTransform,force3D", {
                parser: function (a, b, c, d, f, g, h) {
                    ...
                    var i, j, k, l, m, n, o, p = d._transform = xb(a, e, !0, h.parseTransform), q = a.style, r = 1e-6,
                        s = sb.length, t = h, u = {};
                    if ("string" == typeof t.transform && tb) k = q.cssText, q[tb] = t.transform, q.display = "block", i = xb(a, null, !1), q.cssText = k; else if ("object" == typeof t) {
                        if (i = {
                ...
                defaultValue: "0 0", parser: function (a, b, c, d, f, g) {
                    var h, i, j, k, l, m, n = "background-position", p = e || U(a, null),
                ...
                defaultValue: "50% 50%",
                prefix: !0
            }), qb("transformStyle", {prefix: !0}), qb("backfaceVisibility", {prefix: !0}), qb("margin", {parser: kb("marginTop,marginRight,marginBottom,marginLeft")}), qb("padding", {parser: kb("paddingTop,paddingRight,paddingBottom,paddingLeft")}), qb("clip", {
            ...
            var Eb = function (a) {
                if ((1 === a || 0 === a) && this.data._totalTime === this.data._totalDuration) {
                    ...
                    if ("all" === this.e) f.cssText = "", e = !0; else for (b = this.e.split(","), d = b.length; --d > -1;) c = b[d], h[c] && (h[c].parse === g ? e = !0 : c = "transformOrigin" === c ? vb : h[c].p), Cb(f, c);
            ...
            i = g.prototype, i._firstPT = null, i._onInitTween = function (a, b, h) {
                ...
                if (1 !== a || this._tween._time !== this._tween._duration && 0 !== this._tween._time) if (a || this._tween._time !== this._tween._duration && 0 !== this._tween._time || this._tween._rawPrevTime === -1e-6) for (; e;) {
                    if (b = e.c * a + e.s, e.r ? b = b > 0 ? 0 | b + .5 : 0 | b - .5 : f > b && b > -f && (b = 0), e.type) if (1 === e.type) if (d = e.l, 2 === d) e.t[e.p] = e.xs0 + b + e.xs1 + e.xn1 + e.xs2; else if (3 === d) e.t[e.p] = e.xs0 + b + e.xs1 + e.xn1 + e.xs2 + e.xn2 + e.xs3; else if (4 === d) e.t[e.p] = e.xs0 + b + e.xs1 + e.xn1 + e.xs2 + e.xn2 + e.xs3 + e.xn3 + e.xs4; else if (5 === d) e.t[e.p] = e.xs0 + b + e.xs1 + e.xn1 + e.xs2 + e.xn2 + e.xs3 + e.xn3 + e.xs4 + e.xn4 + e.xs5; else {
            ...
            var Fb = function (a, b, c) {
                var d, e, f, g;
                if (a.slice) for (e = a.length; --e > -1;) Fb(a[e], b, c); else for (d = a.childNodes, e = d.length; --e > -1;) f = d[e], g = f.type, f.style && (b.push(Y(f)), c && c.push(f)), 1 !== g && 9 !== g && 11 !== g || !f.childNodes.length || Fb(f, b, c)
            };
            ...
            propName: "attr", API: 2, init: function (a, b) {
                var c;
            ...
            propName: "directionalRotation", API: 2, init: function (a, b) {
            ...
            var b, c, d, e = window.GreenSockGlobals || window, f = e.com.greensock, g = 2 * Math.PI, h = Math.PI / 2,
    ...
    var b, c, d, e, f, g = a.GreenSockGlobals || a, h = function (a) {
        ...
        return d
    }, i = h("com.greensock"), j = [].slice, k = function () {
    }, l = {}, m = function (b, c, d, e) {
        ...
        this.check = function (i) {
            ...
            if (0 === q && d) for (k = ("com.greensock." + b).split("."), n = k.pop(), o = h(k.join("."))[n] = this.gsClass = d.apply(d, f), e && (g[n] = o, "function" == typeof define && define.amd ? define((a.GreenSockAMDPath ? a.GreenSockAMDPath + "/" : "") + b.split(".").join("/"), [], function () {
                return o
    ...
    var p = [0, 0, 1, 1], q = [], r = o("easing.Ease", function (a, b, c, d) {
        ...
        for (var e, f, g, h, j = b.split(","), k = j.length, l = (c || "easeIn,easeOut,easeInOut").split(","); --k > -1;) for (f = j[k], e = d ? o("easing." + f, null, !0) : i.easing[f] || {}, g = l.length; --g > -1;) h = l[g], s[f + "." + h] = s[h + f] = e[h] = a.getRatio ? a : a[h] || new a
    };
    ...
    d = u.prototype, d.addEventListener = function (a, b, c, d, g) {
        ...
        j.splice(k, 0, {c: b, s: c, up: d, pr: g}), this !== e || f || e.wake()
    ...
    A(), d.play = function (a, b) {
        ...
        if (this._timeline) {
            if (0 > a && !c && (a += this.totalDuration()), this._timeline.smoothChildTiming) {
                ...
                if (a > d && !c && (a = d), this._startTime = (this._paused ? this._pauseTime : g._time) - (this._reversed ? d - a : a) / this._timeScale, g._dirty || this._uncache(!1), g._timeline) for (; g._timeline;) g._timeline._time !== (g._startTime + g._totalTime) / g._timeScale && g.totalTime(g._totalTime, !0), g = g._timeline
            }
    ...
    var F = C._internals = {}, G = C._plugins = {}, H = C._tweenLookup = {}, I = 0, J = F.reservedProps = {
            ease: 1,
            delay: 1,
            overwrite: 1,
            onComplete: 1,
        ...
        L = z._rootFramesTimeline = new B, M = z._rootTimeline = new B;
    ...
    d._init = function () {
        var a, b, c, d, e = this.vars, f = this._overwrittenProps, g = this._duration, h = e.immediateRender,
            i = e.ease;
        if (e.startAt) {
            if (this._startAt && this._startAt.render(-1, !0), e.startAt.overwrite = 0, e.startAt.immediateRender = !0, this._startAt = C.to(this.target, 0, e.startAt), h) if (this._time > 0) this._startAt = null; else if (0 !== g) return
        } else if (e.runBackwards && e.immediateRender && 0 !== g) if (this._startAt) this._startAt.render(-1, !0), this._startAt = null; else if (0 === this._time) {
            c = {};
            for (d in e) J[d] && "autoCSS" !== d || (c[d] = e[d]);
            return c.overwrite = 0, this._startAt = C.to(this.target, 0, c), void 0
        }
        ...
        if (b && C._onPluginEvent("_onInitAllProps", this), f && (this._firstPT || "function" != typeof this.target && this._enabled(!1, !1)), e.runBackwards) for (c = this._firstPT; c;) c.s += c.c, c.c = -c.c, c = c._next;
        ...
        for (f in this.vars) {
            if (k = this.vars[f], J[f]) k instanceof Array && -1 !== k.join("").indexOf("{self}") && (this.vars[f] = k = this._swapSelfInParams(k, this)); else if (G[f] && (i = new G[f])._onInitTween(b, this.vars[f], this)) {
                for (this._firstPT = j = {
                    _next: this._firstPT,
                    t: i,
                    p: "setRatio",
        ...
        if (a >= this._duration) this._totalTime = this._time = this._duration, this.ratio = this._ease._calcEnd ? this._ease.getRatio(1) : 1, this._reversed || (d = !0, e = "onComplete"), 0 === this._duration && ((0 === a || 0 > this._rawPrevTime) && this._rawPrevTime !== a && (c = !0, this._rawPrevTime > 0 && (e = "onReverseComplete", b && (a = -1))), this._rawPrevTime = a); else if (1e-7 > a) this._totalTime = this._time = 0, this.ratio = this._ease._calcEnd ? this._ease.getRatio(0) : 0, (0 !== g || 0 === this._duration && this._rawPrevTime > 0) && (e = "onReverseComplete", d = this._reversed), 0 > a ? (this._active = !1, 0 === this._duration && (this._rawPrevTime >= 0 && (c = !0), this._rawPrevTime = a)) : this._initted || (c = !0); else if (this._totalTime = this._time = a, this._easeType) {
        ...
        var c, d, e, f, g, h, i, j;
        if ((b instanceof Array || D(b)) && "number" != typeof b[0]) for (c = b.length; --c > -1;) this._kill(a, b[c]) && (h = !0); else {
            if (this._targets) {
        ...
        if (f || e.wake(), a && this._gc) {
            ...
            if (d) for (c = d.length; --c > -1;) this._siblings[c] = N(d[c], this, !0); else this._siblings = N(this.target, this, !0)
        }
    ...
    if (d = Q.prototype, Q.version = "1.10.1", Q.API = 2, d._firstPT = null, d._addTween = function (a, b, c, d, e, f) {
        ...
        }, a.global === !0), h = g.prototype = new Q(c);
...
mejs.version = "2.13.0", mejs.meIndex = 0, mejs.plugins = {
    ...
    create: function (a, b) {
        var c = mejs.MediaElementDefaults, d = "string" == typeof a ? document.getElementById(a) : a,
            e = d.tagName.toLowerCase(), f = "audio" === e || "video" === e,
        ...
        var f, g, h, i, j = [],
            k = {method: "", url: "", htmlMediaElement: a, isVideo: "audio" != a.tagName.toLowerCase()};
        ...
        var g, h = 1, i = 1, j = "me_" + a.method + "_" + mejs.meIndex++,
            k = new mejs.PluginMediaElement(j, a.method, a.url), l = document.createElement("div");
 ...
 */
    ...
    mejs.MepDefaults = {
        ...
        hasFocus: !1, controlsAreVisible: !0, init: function () {
            ...
            if ("undefined" != typeof b && (this.width = b), "undefined" != typeof c && (this.height = c), this.height.toString().indexOf("%") > 0 || "100%" === this.$node.css("max-width") || 1 === parseInt(this.$node.css("max-width").replace(/px/, ""), 10) / this.$node.offsetParent().width() || this.$node[0].currentStyle && "100%" === this.$node[0].currentStyle.maxWidth) {
    ...
    a.extend(MediaElementPlayer.prototype, {
        buildprogress: function (b, c, d, e) {
            ...
            var h = c.find(".mejs-time-current"), i = c.find(".mejs-time-handle"), j = c.find(".mejs-time-float"),
                k = c.find(".mejs-time-float-current"), l = function (a) {
                    a = a.pageX;
                    ...
                    if (function () {
                        ...
                        var l, m = function () {
                            var a = g.offset().left - f.container.offset().left,
                                b = g.offset().top - f.container.offset().top, c = g.outerWidth(!0),
                                d = g.outerHeight(!0), e = f.container.width(), h = f.container.height();
...
var ib = ib || {};
ib.isIphone = function () {
    var a = navigator.userAgent.match(/iPhone/i) || navigator.userAgent.match(/iPod/i);
    return a
}(),/*! Motio 2.2.1 - 18th Apr 2013 | https://github.com/Darsain/motio */
    function (a, b) {
        function c(g, h) {
            function i(a) {
                D.reversed = a, v || (z.isPaused = !1, m("play"), k())
            }

            function j() {
                w = 0, t = A ? Math.round(s.x) + "px " + Math.round(s.y) + "px" : B[E], t !== u && (g.style.backgroundPosition = u = t), m("frame"), D.finite && D.to === E && (z.pause(), "function" === d(D.callback) && D.callback.call(z))
            }

            function k() {
                D.finite && D.to === E || (v = D.immediate ? 0 : 60 <= o.fps ? f(k) : setTimeout(k, 1e3 / o.fps), A ? (s.x += o.speedX / o.fps, s.y += o.speedY / o.fps, o.bgWidth && Math.abs(s.x) > o.bgWidth && (s.x %= o.bgWidth), o.bgHeight && Math.abs(s.y) > o.bgHeight && (s.y %= o.bgHeight)) : (D.finite ? E = D.immediate ? D.to : E + (E > D.to ? -1 : 1) : D.reversed ? 0 >= --E && (E = B.length - 1) : ++E >= B.length && (E = 0), z.frame = E), w || (w = f(j)))
            }

            function l(a, b) {
                for (x = 0, y = C[a].length; y > x; x++) if (C[a][x] === b) return x;
                return -1
            }

            function m(a, b) {
                if (C[a]) for (x = 0, y = C[a].length; y > x; x++) C[a][x].call(z, a, b)
            }

            function n(b) {
                return a.getComputedStyle ? a.getComputedStyle(g, null)[b] : g.currentStyle[b]
            }

            var o, p, q = h, r = {}, q = "object" === d(q) ? q : {};
            for (p in c.defaults) r[p] = (q.hasOwnProperty(p) ? q : c.defaults)[p];
            o = r;
            var s, t, u, v, w, x, y, z = this, A = !o.frames, B = [], C = {}, D = {}, E = 0;
            if (z.element = g, z.width = o.width || g.clientWidth, z.height = o.height || g.clientHeight, z.options = o, z.isPaused = !0, z.pause = function () {
                return e(v), clearTimeout(v), v = 0, z.isPaused || (z.isPaused = !0, m("pause")), z
            }, z.play = function (a) {
                return D.finite = !1, D.callback = b, D.immediate = !1, i(a), z
            }, z.toggle = function () {
                return z[v ? "pause" : "play"](), z
            }, z.toStart = function (a, b) {
                return z.to(0, a, b)
            }, z.toEnd = function (a, b) {
                return z.to(B.length - 1, a, b)
            }, z.to = function (a, b, c) {
                if (A || isNaN(parseFloat(a)) || !isFinite(a) || 0 > a || a >= B.length) return z;
                if ("function" === d(b) && (c = b, b = !1), a === E) if (0 === a) E = B.length; else {
                    if (a !== B.length - 1) return "function" === d(c) && c.call(z), z.pause(), z;
                    E = -1
                }
                return D.finite = !0, D.to = a, D.immediate = !!b, D.callback = c, i(), z
            }, z.set = function (a, b) {
                return o[a] = b, z
            }, z.on = function (a, b) {
                if ("object" === d(a)) for (var c in a) a.hasOwnProperty(c) && z.on(c, a[c]); else if ("function" === d(b)) {
                    c = a.split(" ");
                    for (var e = 0, f = c.length; f > e; e++) C[c[e]] = C[c[e]] || [], -1 === l(c[e], b) && C[c[e]].push(b)
                } else if ("array" === d(b)) for (c = 0, e = b.length; e > c; c++) z.on(a, b[c]);
                return z
            }, z.off = function (a, b) {
                if (b instanceof Array) for (var c = 0, e = b.length; e > c; c++) z.off(a, b[c]); else for (var c = a.split(" "), e = 0, f = c.length; f > e; e++) if (C[c[e]] = C[c[e]] || [], "undefined" === d(b)) C[c[e]].length = 0; else {
                    var g = l(c[e], b);
                    -1 !== g && C[c[e]].splice(g, 1)
                }
                return z
            }, z.destroy = function () {
                return z.pause(), g.style.backgroundPosition = "", z
            }, q = (n("backgroundPosition") || n("backgroundPositionX") + " " + n("backgroundPositionY")).replace(/left|top/gi, 0).split(" "), s = {
                x: 0 | parseInt(q[0], 10),
                y: 0 | parseInt(q[1], 10)
            }, A) z.pos = s; else {
                for (q = B.length = 0; q < o.frames; q++) o.vertical ? s.y = q * -z.height : s.x = q * -z.width, B.push(s.x + "px " + s.y + "px");
                z.frames = B.length, z.frame = 0
            }
        }
        ...
        for (var e = a.cancelAnimationFrame || a.cancelRequestAnimationFrame, f = a.requestAnimationFrame, g = ["moz", "webkit", "o"], h = 0, i = 0, j = g.length; j > i && !e; ++i) f = (e = a[g[i] + "CancelAnimationFrame"] || a[g[i] + "CancelRequestAnimationFrame"]) && a[g[i] + "RequestAnimationFrame"];
        e || (f = function (b) {
            var c = +new Date, d = Math.max(0, 16 - (c - h));
            return h = c + d, a.setTimeout(function () {
                b(c + d)
            }, d)
        }, e = function (a) {
            clearTimeout(a)
...
var ib = ib || {};
ib.sfx = ["wd-ctos_all_section-text-highlights-blue-dot-01", "wd-ctos_all_section-transition-whoosh-01", "wd-ctos_all_text", "wd-ctos_all_top-nav-rollover-01", "wd-ctos_believe_black-bar-large-text-starts-in", "wd-ctos_believe_city-first-move-rotate-down-01", "wd-ctos_believe_city-second-move-long-pan-01", "wd-ctos_believe_dot-pattern-fades-out-to-city-01", "wd-ctos_believe_dot-pattern-slowly-zooms-out-01", "wd-ctos_believe_photo-rollover-01", "wd-ctos_believe_photo-rotates-in-01", "wd-ctos_believe_photo-rotates-out-01", "wd-ctos_believe_privacy-safety-healthcare-text-appears-01", "wd-ctos_believe_utilities-text-appears-01", "wd-ctos_connect_left-text-builds-in-01", "wd-ctos_connect_numbers-fly-out-of-map-01", "wd-ctos_connect_share-rollover-01", "wd-ctos_discover_circle-connecting-lines-draw-in-01", "wd-ctos_discover_circle-highlight-dot-appears-01", "wd-ctos_discover_city-block-glows-01", "wd-ctos_discover_city-long-pan-rotate-01", "wd-ctos_discover_city-short-pan-rotate-01", "wd-ctos_discover_city-to-dots-transition-01", "wd-ctos_discover_environ-text-appears-01", "wd-ctos_discover_people-photo-falls-in-01", "wd-ctos_discover_people-photo-rollover-01", "wd-ctos_discover_security-water-text-rollover-01", "wd-ctos_discover_security-water-text-rollovers-appear-01", "wd-ctos_discover_the-result-text-in-01", "wd-ctos_discover_vast-network-dots-grow-in-01", "wd-ctos_discover_you-text-appears-01", "wd-ctos_discover_yourfamily-text-appears-01", "wd-ctos_imagine_accept-button-click-transition-01", "wd-ctos_imagine_accept-button-rollover-01", "wd-ctos_imagine_braile-button-rollover-01", "wd-ctos_imagine_most-appealing-rollover-01", "wd-ctos_intro_ctos-black-bar-slides-down-01", "wd-ctos_intro_learn-more-click-fade-out-01", "wd-ctos_intro_learn-more-rolloff-01", "wd-ctos_intro_learn-more-rollover-01", "wd-ctos_intro_loading-animates-to-learn-more-01", "wd-ctos_intro_logo-build-in-01", "wd-ctos_intro_logo-build-out-01", "wd-ctos_intro_sections-text-animates-in-01", "wd-ctos_all_music-ambient-loop-01"];
var ib = ib || {};
ib.ChapterData = ib.ChapterData || {}, ib.ChapterData["chapter-1"] = ib.ChapterData["chapter-1"] || {}, ib.ChapterData["chapter-1"].getText = function () {
    return {
        cctv: [{
            webm: ib.Config.assetBasePath + "/video/cctv1.webm",
            mp4: ib.Config.assetBasePath + "/video/cctv1.mp4"
        }, {
            webm: ib.Config.assetBasePath + "/video/cctv2.webm",
            mp4: ib.Config.assetBasePath + "/video/cctv2.mp4"
        }, {
            webm: ib.Config.assetBasePath + "/video/cctv3.webm",
            mp4: ib.Config.assetBasePath + "/video/cctv3.mp4"
        }, {webm: ib.Config.assetBasePath + "/video/cctv4.webm", mp4: ib.Config.assetBasePath + "/video/cctv4.mp4"}]
    }
};
var ib = ib || {};
ib.ChapterData = ib.ChapterData || {}, ib.ChapterData["chapter-2"] = ib.ChapterData["chapter-2"] || {}, ib.ChapterData["chapter-2"].getText = function () {
    return {
        chicagoMarkerCCTVs: ["businesses", "citycenters", "streets", "parks"],
        testimonials: [{text: "A few months ago when I felt faint, I simply signed in to <span class='smaller'>ct</span>OS, found the closest doctor and my medical records were all right there."}, {
            textClass: "left-text",
            text: "I don't have to worry about my mom anymore. When I’m away, I just sign on and make sure she’s ok."
        }, {text: "Thanks to <span class='smaller'>ct</span>OS, my morning commute is a breeze. Instead of spending my whole morning in traffic, I now have time to enjoy a coffee and read the paper."}, {text: "When I go for my evening jog, I know I’ll always have a clean and beautiful view of the city. And I always feel safe!"}, {text: "<span class='smaller'>ct</span>OS saves the city tax dollars and my property tax is affordable. Chicago is the city I took my first steps in and I know it will be where I take my last."}, {
            extraContainerClass: "large-only",
            text: "In recent years, my partner and I stopped taking our evening walks due to neighborhood crime. But now there are cameras on every corner, we never have to worry!"
        }, {
            extraContainerClass: "large-only",
            text: "When my son swallowed some cleaning detergent, all I had to do was give the hospital his name and they had all his medical records on file when we arrived."
        }, {
            extraContainerClass: "large-only",
            text: "It’s like I live in a completely new city. Only in this version of Chicago I never have to worry about traffic, muggers or...anything."
        }],
        cityHighlights: [{
            title: "Power",
            details: "To guard against power outages, ctOS continuously monitors individual household power usage and is programmed to divert and shut down power in emergency situations.",
            glowImage: ib.Config.assetBasePath + "/images/chapter-2/power-glow.jpg",
            image: ib.Config.assetBasePath + "/images/chapter-2/highlight-power.jpg"
        }, {
            title: "Security",
            details: "A citywide CCTV network dynamically monitors all activity 24/7, from high-traffic city centers to suburban districts.",
            glowImage: ib.Config.assetBasePath + "/images/chapter-2/security-glow.jpg",
            image: ib.Config.assetBasePath + "/images/chapter-2/highlight-security.jpg"
        }, {
            title: "Transit",
            details: "A sophisticated algorithm regulates traffic flow in concert with a network of citywide traffic signals and surveillance cameras.",
            glowImage: ib.Config.assetBasePath + "/images/chapter-2/transit-glow.jpg",
            image: ib.Config.assetBasePath + "/images/chapter-2/highlight-transit.jpg"
        }, {
            title: "Water",
            details: "The city’s water supply is tested continually for neutral ph levels and to detect foreign contamination.",
            glowImage: ib.Config.assetBasePath + "/images/chapter-2/water-glow.jpg",
            image: ib.Config.assetBasePath + "/images/chapter-2/highlight-water.jpg"
        }, {
            title: "Sewage",
            details: "Each household’s liquid waste is treated upon entry into the system. Sewage is disposed of and clean water is reintroduced all without human involvement.",
            glowImage: ib.Config.assetBasePath + "/images/chapter-2/sewage-glow.jpg",
            image: ib.Config.assetBasePath + "/images/chapter-2/highlight-sewage.jpg"
        }]
    }
};
var ib = ib || {};
ib.ChapterData = ib.ChapterData || {}, ib.ChapterData["chapter-3"] = ib.ChapterData["chapter-3"] || {}, ib.ChapterData["chapter-3"].getText = function () {
    return {
        questions: [{
            topic: "Traffic",
            ask: 'without <span class="smaller">CT</span>OS',
            question: "Traffic congestion hinders businesses and affects your personal life.",
            answer: {
                confirm: 'with <span class="smaller">CT</span>OS',
                headline: "195,854 miles of traffic were avoided last year.",
                body: ""
            },
            ui: {
                component: "ib.InfographicQuestion",
                opts: {
                    next: "next",
                    accept: "agree",
                    classes: "traffic",
                    questionStatistics: [{
                        ...
                        value: 45,
                        suffix: "mins."
                    }, {title: "delayed trains", subtitle: "citywide", value: 5, suffix: "%"}],
                    answerStatistics: [{
                        title: "average commute time",
                        subtitle: "citywide",
                        value: 10,
            ...
            topic: "Health",
            ask: 'without <span class="smaller">CT</span>OS',
            question: "Your community requires more efficient healthcare services.",
            answer: {
                confirm: 'with <span class="smaller">CT</span>OS',
                headline: "Waiting time in ER has reduced by <strong>23%</strong> over the past 2 years.",
                body: ""
            },
            ui: {
                component: "ib.InfographicQuestion",
                opts: {
                    ...
                    classes: "health",
                    questionStatistics: [{
                        title: "e.r.<br>wait time ",
                        subtitle: "citywide",
                        value: 90,
                        suffix: "mins"
                    }, {title: "healthcare expenditure", subtitle: "per capita", value: 7290, prefix: "$"}],
                    answerStatistics: [{
                        title: "e.r.<br>wait time ",
                        subtitle: "citywide",
                        value: 70,
                        suffix: "mins"
                    }, {title: "healthcare expenditure", subtitle: "per capita", value: 1e3, prefix: "$"}]
                }
            }
        }, {
            topic: "Crime",
            ask: 'without <span class="smaller">CT</span>OS',
            question: "Violent crime is a serious threat to you and your loved ones.",
            answer: {
                confirm: 'with <span class="smaller">CT</span>OS',
                headline: "In the past year, a crime has been prevented every <strong>12.5</strong> minutes",
                body: ""
            },
            ui: {
                component: "ib.InfographicQuestion",
                opts: {
                    ...
                    questionStatistics: [{
                        ...
                        value: 33,
                        suffix: "%"
                    }, {title: "murder", subtitle: "citywide", value: 31, suffix: "%"}],
                    answerStatistics: [{
                        title: "assault",
                        subtitle: "citywide",
                        value: 5,
                        suffix: "%"
                    }, {title: "murder", subtitle: "citywide", value: 3, suffix: "%"}]
                }
            }
        }, {
            topic: "Benefits",
            ask: "&nbsp;",
            question: 'Select the most appealing benefit of <span class="smaller">CT</span>OS',
            answer: {
                confirm: "Welcome",
                headline: "You have been identified as a <strong>potential region advocate</strong>",
                body: '<span class="smaller">CT</span>OS is here to help'
            },
            ui: {
                component: "ib.MultipleChoiceQuestion",
                opts: {
                    next: "connect",
                    classes: "benefits",
                    choices: [{
                        title: "Crime Control",
                        iconClass: "crime-control",
                        choice: "crime"
                    }, {
                        title: "Traffic Reduction",
                        iconClass: "traffic-reduction",
                        choice: "traffic"
                    }, {title: "Health Care", iconClass: "accessible-health-care", choice: "healthcare"}]
                }
            }
        }]
    }
...
var ib = ib || {};
ib.ChapterData = ib.ChapterData || {}, ib.ChapterData["chapter-4"] = ib.ChapterData["chapter-4"] || {}, ib.ChapterData["chapter-4"].getText = function () {
    return {
        facts: {
            crime: {
                headline: "Twelve point five minutes",
                factNum: 25,
                fact: "A crime is prevented every 12.5 minutes",
                image: ib.Config.assetBasePath + "/images/share/crime.png"
            },
            healthcare: {
                headline: "THIRTY FIVE HUNDRED",
                factNum: 1,
                fact: "3500 medical consultations take place online every month",
                image: ib.Config.assetBasePath + "/images/share/healthcare.png"
            },
            traffic: {
                headline: "THIRTY TWO PERCENT",
                factNum: 13,
                fact: "Shipping and handling in the harbor is 32% faster",
                image: ib.Config.assetBasePath + "/images/share/traffic.png"
            }
        },
        shareCopy: ["Can’t wait for ctOS to come to my city #Watchdogs #ctOS", "With ctOS, I don’t have to worry because my city knows everything about me #ctOS #Watchdogs", "I trust ctOS to manage traffic, healthcare and crime throughout my city #ctOS #Watchdogs"],
        mapData: [{x: .12313937753721245, y: .1335676625659051, count: 89}, {
            x: .10825439783491204,
            y: .17398945518453426,
            count: 69
        }, {x: .12449255751014884, y: .19156414762741653, count: 48}, {
            x: .10554803788903924,
            y: .18629173989455183,
            count: 3
        }, {x: .16238159675236807, y: .26537785588752194, count: 48}, {
            x: .07848443843031123,
            y: .28646748681898065,
            count: 35
        }, {x: .07848443843031123, y: .30755711775043937, count: 98}, {
            x: .06765899864682003,
            y: .3339191564147627,
            count: 87
        }, {x: .06901217861975643, y: .4112478031634446, count: 80}, {
            x: .07577807848443843,
            y: .45518453427065025,
            count: 37
        }, {x: .08795669824086604, y: .47451669595782076, count: 40}, {
            x: .09607577807848444,
            y: .4973637961335677,
            count: 43
        }, {x: .10825439783491204, y: .5149384885764499, count: 86}, {
            x: .16779431664411368,
            y: .5448154657293497,
            count: 67
        }, {x: .10148849797023005, y: .44639718804920914, count: 70}, {
            x: .16779431664411368,
            y: .44112478031634444,
            count: 20
        }, {x: .16644113667117727, y: .46924428822495606, count: 97}, {
            x: .2070365358592693,
            y: .4077328646748682,
            count: 71
        }, {x: .2557510148849797, y: .38137082601054484, count: 32}, {
            x: .2598105548037889,
            y: .36203866432337434,
            count: 67
        }, {x: .29905277401894453, y: .3216168717047452, count: 12}, {
            x: .19350473612990526,
            y: .2548330404217926,
            count: 74
        }, {x: .21380243572395127, y: .29701230228471004, count: 24}, {
            x: .2665764546684709,
            y: .2548330404217926,
            count: 28
        }, {x: .2936400541271989, y: .22319859402460457, count: 7}, {
            x: .35047361299052776,
            y: .23374340949033393,
            count: 60
        }, {x: .36129905277401897, y: .23725834797891038, count: 96}, {
            x: .2719891745602165,
            y: .22319859402460457,
            count: 43
        }, {x: .42760487144790255, y: .22319859402460457, count: 82}, {
            x: .4709066305818674,
            y: .23198594024604569,
            count: 82
        }, {x: .5412719891745602, y: .27768014059753954, count: 98}, {
            x: .5060893098782138,
            y: .26537785588752194,
            count: 29
        }, {x: .39783491204330174, y: .29701230228471004, count: 84}, {
            x: .4100135317997294,
            y: .38137082601054484,
            count: 55
        }, {x: .516914749661705, y: .36906854130052724, count: 93}, {
            x: .35994587280108253,
            y: .39718804920913886,
            count: 64
        }, {x: .33964817320703655, y: .4024604569420035, count: 80}, {
            x: .3234100135317997,
            y: .3216168717047452,
            count: 84
        }, {x: .2746955345060893, y: .5184534270650264, count: 32}, {
            x: .2354533152909337,
            y: .5008787346221442,
            count: 55
        }, {x: .34100135317997293, y: .5289982425307557, count: 19}, {
            x: .39918809201623817,
            y: .5817223198594025,
            count: 14
        }, {x: .4370771312584574, y: .6502636203866432, count: 16}, {
            x: .39242219215155616,
            y: .655536028119508,
            count: 4
        }, {x: .4857916102841678, y: .6397188049209139, count: 10}, {
            x: .4140730717185386,
            y: .6625659050966608,
            count: 56
        }, {x: .456021650879567, y: .6994727592267135, count: 24}, {
            x: .4817320703653586,
            y: .680140597539543,
            count: 67
        }, {x: .5290933694181326, y: .6572934973637962, count: 64}, {
            x: .5534506089309879,
            y: .6502636203866432,
            count: 91
        }, {x: .5426251691474966, y: .5448154657293497, count: 66}, {
            x: .4817320703653586,
            y: .5360281195079086,
            count: 59
        }, {x: .5588633288227334, y: .4833040421792619, count: 30}, {
            x: .6008119079837618,
            y: .4270650263620387,
            count: 35
        }, {x: .7009472259810555, y: .4200351493848858, count: 76}, {
            x: .6427604871447903,
            y: .4182776801405975,
            count: 70
        }, {x: .7090663058186739, y: .37082601054481545, count: 57}, {
            x: .6941813261163735,
            y: .3110720562390158,
            count: 90
        }, {x: .6102841677943166, y: .29876977152899825, count: 66}, {
            x: .6211096075778079,
            y: .34797891036906853,
            count: 37
        }, {x: .6305818673883626, y: .37785588752196836, count: 12}, {
            x: .618403247631935,
            y: .35676625659050965,
            count: 53
        }, {x: .6373477672530447, y: .36731107205623903, count: 76}, {
            x: .7753721244925575,
            y: .40597539543058,
            count: 89
        }, {x: .7889039242219216, y: .37785588752196836, count: 24}, {
            x: .8213802435723951,
            y: .335676625659051,
            count: 45
        }, {x: .8497970230040596, y: .28646748681898065, count: 5}, {
            x: .8728010825439784,
            y: .27943760984182775,
            count: 66
        }, {x: .871447902571042, y: .2530755711775044, count: 52}, {
            x: .8971583220568335,
            y: .23198594024604569,
            count: 61
        }, {x: .8619756427604871, y: .30755711775043937, count: 35}, {
            x: .8281461434370772,
            y: .36379613356766255,
            count: 34
        }, {x: .8416779431664412, y: .3602811950790861, count: 36}, {
            x: .8159675236806495,
            y: .4024604569420035,
            count: 66
        }, {x: .8213802435723951, y: .43936731107205623, count: 0}, {
            x: .8119079837618404,
            y: .5149384885764499,
            count: 29
        }, {x: .7374830852503383, y: .5131810193321616, count: 8}, {
            x: .774018944519621,
            y: .4710017574692443,
            count: 29
        }, {x: .7564276048714479, y: .5043936731107206, count: 17}, {
            x: .6982408660351827,
            y: .5149384885764499,
            count: 5
        }, {x: .7699594046008119, y: .5694200351493849, count: 48}, {
            x: .6576454668470907,
            y: .539543057996485,
            count: 82
        }, {x: .7158322056833559, y: .632688927943761, count: 31}, {
            x: .7550744248985115,
            y: .6695957820738138,
            count: 73
        }, {x: .7523680649526387, y: .632688927943761, count: 31}, {
            x: .7916102841677943,
            y: .7328646748681898,
            count: 66
        }, {x: .6765899864682002, y: .6449912126537786, count: 89}, {
            x: .6238159675236806,
            y: .6203866432337434,
            count: 17
        }, {x: .6035182679296346, y: .6748681898066784, count: 28}, {
            x: .36129905277401897,
            y: .6678383128295254,
            count: 45
        }, {x: .41136671177266576, y: .5694200351493849, count: 47}, {
            x: .34100135317997293,
            y: .562390158172232,
            count: 66
        }, {x: .4519621109607578, y: .7363796133567663, count: 79}, {
            x: .45331529093369416,
            y: .46572934973637964,
            count: 88
        }, {x: .4993234100135318, y: .45518453427065025, count: 94}, {
            x: .476319350473613,
            y: .38137082601054484,
            count: 95
        }, {x: .4736129905277402, y: .30052724077328646, count: 14}, {
            x: .4668470906630582,
            y: .30755711775043937,
            count: 96
        }, {x: .3044654939106901, y: .44815465729349735, count: 8}, {
            x: .6062246278755075,
            y: .23550087873462214,
            count: 75
        }, {x: .3044654939106901, y: .21616871704745166, count: 9}, {
            x: .8254397834912043,
            y: .4710017574692443,
            count: 32
        }, {x: .9228687415426252, y: .15114235500878734, count: 18}, {
            x: .9350473612990527,
            y: .17750439367311072,
            count: 19
        }, {x: .9201623815967523, y: .16695957820738136, count: 3}, {
            x: .9242219215155616,
            y: .12478031634446397,
            count: 86
        }, {x: .2638700947225981, y: .7873462214411248, count: 51}, {
            x: .10825439783491204,
            y: .6906854130052724,
            count: 38
        }, {x: .07848443843031123, y: .6678383128295254, count: 73}, {
            x: .2462787550744249,
            y: .5782073813708261,
            count: 17
        }, {x: .2895805142083897, y: .6028119507908611, count: 31}, {
            x: .11502029769959404,
            y: .1687170474516696,
            count: 259
        }, {x: .10284167794316644, y: .4903339191564148, count: 676}, {
            x: .6332882273342354,
            y: .35676625659050965,
            count: 772
        }, {x: .851150202976996, y: .3268892794376098, count: 961}, {
            x: .6102841677943166,
            y: .6854130052724078,
            count: 263
        }, {x: .7834912043301759, y: .687170474516696, count: 284}, {
            x: .8213802435723951,
            y: .5589455184534271,
            count: 270
        }, {x: .4795669824086604, y: .69701230228471, count: 306}]
    }
};
var ib = ib || {};
ib.ChapterData = ib.ChapterData || {}, ib.ChapterData["chapter-1"] = ib.ChapterData["chapter-1"] || {}, ib.ChapterData["chapter-1"] = $.extend(ib.ChapterData["chapter-1"], {
    totalScrollValue: 4e4,
    storyKeyframes: [{frame: .001, duration: 2e3}, {
        frame: .45,
        duration: 15e3,
        continueOnComplete: !0,
        audio: {delay: 1e3, startValue: 0 + (ib.isIE ? 500 : 0), endValue: 12500 + (ib.isIE ? 500 : 0)}
    }, {
        frame: .549,
        duration: 17e3,
        audio: {startValue: 13e3 + (ib.isIE ? 1e3 : 0), endValue: 27400 + (ib.isIE ? 1e3 : 0)}
    }, {
        frame: .975,
        duration: 23e3,
        video: {delay: 1e3, startValue: 0, endValue: 2e4},
        audio: {delay: 2e3, startValue: 27500 + (ib.isIE ? 1e3 : 0), endValue: 49500 + (ib.isIE ? 500 : 0)}
    }, {frame: .9999, duration: 1e3, continueOnComplete: !0, video: {delay: 0, startValue: 21e3, endValue: 22e3}}],
    sfxTriggers: [{start: .28, sfxId: "wd-ctos_believe_black-bar-large-text-starts-in"}, {
        start: .283,
        sfxId: "wd-ctos_all_text",
        duration: 800
    }, {start: .453, sfxId: "wd-ctos_believe_dot-pattern-slowly-zooms-out-01"}, {
        start: .483,
        sfxId: "wd-ctos_believe_black-bar-large-text-starts-in"
    }, {start: .485, sfxId: "wd-ctos_all_text", duration: 1e3}, {
        start: .549,
        sfxId: "wd-ctos_believe_dot-pattern-fades-out-to-city-01"
    }, {start: .56, sfxId: "wd-ctos_believe_city-first-move-rotate-down-01"}, {
        start: .539,
        sfxId: "wd-ctos_all_text",
        duration: 800
    }, {start: .71, sfxId: "wd-ctos_believe_city-second-move-long-pan-01"}, {
        start: .885,
        sfxId: "wd-ctos_believe_black-bar-large-text-starts-in"
    }, {start: .9, sfxId: "wd-ctos_all_text", duration: 1e3}, {
        start: .976,
        sfxId: "wd-ctos_all_section-transition-whoosh-01"
    }],
    headerControlSteps: [{start: 0, end: .9999, removeClass: "light"}],
    animationElements: [{
        target: "#intro-mask-wrap",
        steps: [{
            start: .03,
            end: .1,
            remove: !0,
            properties: [{name: "opacity", unit: "", startValue: 1, endValue: 0, easing: "easeOutQuad"}]
        }]
    }, {
        target: ".video-mask",
        steps: [{
            ...
            properties: [{name: "opacity", unit: "", startValue: 0, endValue: .75}]
        }, {start: .9751, end: .99, properties: [{name: "opacity", unit: "", startValue: .75, endValue: 0}]}]
    }, {
        target: ".smart-city-program .block-reveal.blue-border .content",
        steps: [{
            start: .28,
            end: .3,
            properties: [{name: "width", unit: "%", easing: "easeOutCubic", startValue: 0, endValue: 100}]
        }, {
            start: .42,
            end: .44,
            properties: [{name: "width", unit: "%", easing: "easeOutCubic", startValue: 100, endValue: 0}]
        }]
    }, {
        target: ".we-are-all-connected .block-reveal.blue-border .content",
        steps: [{
            start: .483,
            end: .486,
            properties: [{name: "width", unit: "%", startValue: 0, endValue: 100, easing: "easeOutCubic"}]
        }, {
            start: .501,
            end: .504,
            properties: [{name: "width", unit: "%", startValue: 100, endValue: 0, easing: "easeOutCubic"}]
        }]
    }, {
        target: ".lift-container .block-reveal.blue-border .content",
        steps: [{
            start: .885,
            end: .92,
            properties: [{name: "width", unit: "%", startValue: 0, endValue: 100, easing: "easeOutSine"}]
        }, {
            start: .9752,
            end: .99,
            properties: [{name: "width", unit: "%", startValue: 100, endValue: 0, easing: "easeOutSine"}]
        }]
    }, {
        target: ".block-reveal.scroll-indicator-0 .content",
        steps: [{
            start: .539,
            end: .55,
            properties: [{name: "width", unit: "%", startValue: 0, endValue: 100, easing: "easeOutSine"}]
            ...
            properties: [{
                ...
                endValue: 0,
                easing: "easeOutSine"
            }, {name: "padding-right", unit: "px", startValue: 20, endValue: 0, easing: "easeOutSine"}]
        }]
    }, {
        target: ".block-reveal.scroll-indicator .content",
        steps: [{
            start: .91,
            end: .95,
            properties: [{name: "width", unit: "%", startValue: 0, endValue: 100, easing: "easeOutSine"}]
        ...
        target: ".copy-1 .content",
        steps: [{
            start: .9752,
            end: .99,
            properties: [{name: "opacity", unit: "", startValue: 1, endValue: 0, easing: "easeOutSine"}]
        }]
    }, {
        target: ".mask",
        steps: [{start: .9998, end: .9999, properties: [{name: "bottom", unit: "%", startValue: 0, endValue: 100}]}]
    }],
    animationComponents: [{
        target: ".smart-city-program h2.content",
        componentClass: "ib.Oomph",
        opts: {start: .283, end: .41, duration: 600, fadeOut: !0}
    }, {
        target: ".we-are-all-connected h2.content",
        componentClass: "ib.Oomph",
        opts: {start: .485, end: .51, duration: 600, fadeOut: !0}
    }, {
        target: ".copy-1 .content",
        componentClass: "ib.Oomph",
        opts: {start: .9, end: 1, duration: 900, fadeOut: !1}
    }, {
        target: ".network-canvas", componentClass: "ib.Network.Dots", opts: {
            start: 0,
            end: .57,
            zoomNormalKeyframe: .452,
            zoomNormalZ: 0,
            connectionBegin: .1,
            connectionEnd: .5493,
            zoomOutDuration: 7,
            zoomOutEasing: "easeInCubic",
            dotColor: "#1e1e1e",
            highlightColor: "#32c8f4",
            cctvCanvasTarget: ".dots-canvas",
            cctvContextTarget: ".connected-cctv",
            initialYRange: .75,
            CCTVOpts: {
                lineDuration: 450,
                borderDuration: 1100,
                ...
                lineSfx: "wd-ctos_discover_circle-connecting-lines-draw-in-01",
                easing: "easeOutCubic",
                cams: [{
                    x: .58,
                    y: .15,
                    startLineX: .5,
                    startLineY: .5,
                    target: ".smart-city-image",
                    imageStart: .32,
                    borderStart: .318,
                    forcedEnd: .44,
                    src: ib.Config.assetBasePath + "/images/chapter-1/smart-city.jpg",
                    height: 334,
                    width: 500,
                    imageActive: !1,
                    lineActive: !1,
                    ...
                    imageStart: .46,
                    borderStart: .458,
                    video: [{webm: ib.Config.assetBasePath + "/video/cctv1.webm"}, {mp4: ib.Config.assetBasePath + "/video/cctv1.mp4"}],
                    height: 116,
                    width: 208,
                    imageActive: !1,
                    lineActive: !1,
                    ...
                    imageStart: .502,
                    borderStart: .5,
                    video: [{webm: ib.Config.assetBasePath + "/video/cctv2.webm"}, {mp4: ib.Config.assetBasePath + "/video/cctv2.mp4"}],
                    height: 116,
                    width: 208,
                    imageActive: !1,
                    lineActive: !1,
                    ...
                    imageStart: .47,
                    borderStart: .468,
                    video: [{webm: ib.Config.assetBasePath + "/video/cctv3.webm"}, {mp4: ib.Config.assetBasePath + "/video/cctv3.mp4"}],
                    height: 116,
                    width: 208,
                    imageActive: !1,
                    lineActive: !1,
                    ...
                    imageStart: .515,
                    borderStart: .513,
                    video: [{webm: ib.Config.assetBasePath + "/video/cctv4.webm"}, {mp4: ib.Config.assetBasePath + "/video/cctv4.mp4"}],
                    height: 116,
                    width: 208,
                    imageActive: !1,
                    lineActive: !1,
        ...
        opts: {
            ...
            fadeOutDuration: 500,
            maxDelayStagger: 200,
            dots: [{type: "text", content: "+"}, {type: "text", content: "+"}, {
                type: "text",
                content: "+"
                ...
                type: "text",
                content: "+"
            }, {type: "text", content: "+"}, {type: "text", content: "10"}, {type: "text", content: "07"}]
        }
    }, {
        target: ".dots-2",
        componentClass: "ib.Dots",
    ...
    }, {target: "#intro-mask-wrap", componentClass: "ib.IntroLogo", opts: {}}, {
        target: ".super",
        componentClass: "ib.Super",
        opts: {
            start: .648,
            end: .72,
            steps: [{
                sfxId: "wd-ctos_believe_privacy-safety-healthcare-text-appears-01",
                delay: 0,
                duration: 300
            }, {
                sfxId: "wd-ctos_believe_privacy-safety-healthcare-text-appears-01",
                ...
                delay: 1700,
                duration: 300
            }, {sfxId: "wd-ctos_believe_utilities-text-appears-01", delay: 2550, duration: 300}]
        }
    }],
    introLogoOpts: {
        start: 0, end: .01, duration: 1e3, startFrameNum: 0, numFrames: 17, getFilename: function (a) {
            if (0 === a) return "data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7";
            var b = 16 === a ? "png" : "jpg";
            return a = "00000" + a, a = a.slice(-5), ib.Config.assetBasePath + "/images/chapter-1/sequences/logo/logo_" + a + "." + b
        }
    }
});
var ib = ib || {};
ib.ChapterData = ib.ChapterData || {}, ib.ChapterData["chapter-2"] = ib.ChapterData["chapter-2"] || {}, ib.ChapterData["chapter-2"] = $.extend(ib.ChapterData["chapter-2"], {
    totalScrollValue: 3e4,
    storyKeyframes: [{
        frame: .599,
        duration: 39e3,
        video: {delay: 0, startValue: 22e3, endValue: 63e3},
        audio: {delay: 1e3, startValue: 49500 + (ib.isIE ? 1e3 : 0), endValue: 86e3 + (ib.isIE ? 1e3 : 0)}
    }, {
        frame: .915,
        duration: 21e3,
        video: {startValue: 63e3, endValue: 63e3},
        audio: {delay: 50, startValue: 86e3 + (ib.isIE ? 500 : 0), endValue: 107e3}
    }, {frame: .9999, duration: 2e3, continueOnComplete: !0}],
    sfxTriggers: [{
        sfxId: "wd-ctos_discover_city-block-glows-01",
        start: .048
    }, {sfxId: "wd-ctos_discover_city-block-glows-01", start: .07}, {
        sfxId: "wd-ctos_discover_city-block-glows-01",
        start: .09
    }, {sfxId: "wd-ctos_discover_city-block-glows-01", start: .11}, {
        sfxId: "wd-ctos_discover_city-block-glows-01",
        start: .12
    }, {sfxId: "wd-ctos_discover_city-block-glows-01", start: .13}, {
        sfxId: "wd-ctos_discover_city-block-glows-01",
        start: .16
    }, {sfxId: "wd-ctos_discover_city-block-glows-01", start: .18}, {
        sfxId: "wd-ctos_discover_city-block-glows-01",
        start: .2
    }, {start: .23, sfxId: "wd-ctos_discover_city-long-pan-rotate-01"}, {
        start: .52,
        sfxId: "wd-ctos_discover_city-short-pan-rotate-01"
    }, {start: .61, sfxId: "wd-ctos_all_text", duration: 1e3}, {
        start: .72,
        sfxId: "wd-ctos_all_text",
        duration: 1e3
    }, {start: .917, sfxId: "wd-ctos_all_section-transition-whoosh-01"}],
    headerControlSteps: [{start: 0, end: .00999, removeClass: "light"}, {
        start: .01,
        end: .6,
        addClass: "light"
    }, {start: .6, end: 1, removeClass: "light"}],
    animationElements: [{
        target: ".city-highlights-indicator .content",
        steps: [{
            start: .597,
            end: .598999,
            properties: [{name: "width", unit: "%", startValue: 0, endValue: 100, easing: "easeOutSine"}]
        ...
        steps: [{
            ...
            properties: [{name: "opacity", unit: "", startValue: 0, endValue: 1, easing: "easeOutQuad"}]
        }]
    }, {
        target: ".top-copy > .scroll-indicator .content",
        steps: [{
            start: .905,
            end: .914,
            properties: [{name: "width", unit: "%", startValue: 0, endValue: 100, easing: "easeOutSine"}]
        ...
        target: ".mask",
        steps: [{start: .96, end: 1, properties: [{name: "bottom", unit: "%", startValue: 0, endValue: 100}]}]
    }],
    animationComponents: [{
        target: ".top-copy.copy-1 .content",
        componentClass: "ib.Oomph",
        opts: {start: .61, end: .708, fadeOut: !0}
    }, {
        target: ".copy-2 .content",
        componentClass: "ib.Oomph",
        opts: {start: .72, end: .916}
    }, {
        target: ".testimonials",
        componentClass: "ib.Testimonials",
        opts: {
            start: .609,
            end: .92,
            resetWaitTime: 0,
            ...
            delay: 0,
            duration: 400,
            firstTestimonyDelay: 5e3,
            easing: "easeOutQuad",
            maxDelayStagger: 200,
            testimonials: ib.ChapterData["chapter-2"].getText().testimonials,
            numImages: 8
        }
    }, {
        target: "#cctv-image-launcher-1",
        componentClass: "ib.CCTVImageLauncher",
        opts: {
            start: .05,
            end: .5,
            cctvContextTarget: ".cctv-image-launcher",
            CCTVOpts: {
                imageDuration: 800,
                start: .05,
                end: .4,
                ...
                cams: [{
                    x: .4,
                    y: .3,
                    target: ".cctv-image-populous",
                    src: ib.Config.assetBasePath + "/images/chapter-2/CTOS_Discover_1populous.jpg",
                    imageStart: .11,
                    forcedEnd: .22,
                    height: 344,
                    width: 611,
                    ...
                    x: .1,
                    y: .45,
                    target: ".cctv-image-infrastructure",
                    src: ib.Config.assetBasePath + "/images/chapter-2/CTOS_Discover_2infrastructure.jpg",
                    imageStart: .27,
                    forcedEnd: .35,
                    height: 448,
                    width: 672,
                    ...
                    x: .62,
                    y: .15,
                    target: ".cctv-image-controlcenters",
                    src: ib.Config.assetBasePath + "/images/chapter-2/CTOS_Discover_3controlcenters.jpg",
                    imageStart: .32,
                    forcedEnd: .35,
                    height: 345,
                    width: 522,
        ...
        opts: {
            ...
            CCTVOpts: {
                ...
                cams: [{
                    x: .1,
                    y: .4,
                    target: ".cctv-image-reducedenergy",
                    src: ib.Config.assetBasePath + "/images/chapter-2/CTOS_Discover_8reducedenergyoutput.jpg",
                    imageStart: .49,
                    forcedEnd: .585,
                    height: 194,
                    width: 345,
                    ...
                    x: .45,
                    y: .55,
                    target: ".cctv-image-reducedmaintenance",
                    src: ib.Config.assetBasePath + "/images/chapter-2/CTOS_Discover_9reducedmaintenanceresponse.jpg",
                    imageStart: .51,
                    forcedEnd: .585,
                    height: 194,
                    width: 345,
                    ...
                    x: .7,
                    y: .3,
                    target: ".cctv-image-reducedspending",
                    src: ib.Config.assetBasePath + "/images/chapter-2/CTOS_Discover_10reducedcityspending.jpg",
                    imageStart: .54,
                    forcedEnd: .585,
                    height: 209,
                    width: 370,
        ...
        target: "#arbitrary-building-markers",
        componentClass: "ib.BuildingMarkers",
        opts: {
            start: .47,
            end: .59,
            markers: [{top: 60, left: 15, lineFromIndex: 0, start: .471}, {
                top: 45,
                left: 33,
                lineFromIndex: 0,
                start: .48
            }, {top: 70, left: 30, lineFromIndex: 1, start: .5}, {
                top: 50,
                left: 52,
                lineFromIndex: 1,
                start: .51
            }, {top: 69, left: 70, lineFromIndex: 3, start: .52}, {
                top: 75,
                left: 60,
                lineFromIndex: 2,
                start: .53
            }, {top: 25, left: 85, lineFromIndex: 3, start: .54}, {top: 38, left: 89, lineFromIndex: 4, start: .55}]
        }
    }, {
        target: ".network-canvas", componentClass: "ib.Network.Dots", opts: {
            start: .6,
            end: .955,
            zoomNormalKeyframe: .605,
            zoomNormalZ: -40,
            connectionBegin: .605,
            connectionEnd: .93,
            zoomOutDuration: 3,
            ...
            dotColor: "#1e1e1e",
            highlightColor: "#32c8f4",
            cctvCanvasTarget: ".testimonial-canvas",
            cctvContextTarget: ".testimonial-cctv",
            initialYRange: .75,
            CCTVOpts: {
                lineDuration: 650,
                borderDuration: 0,
                ...
                easing: "easeOutCubic",
                rolloverSfxId: "wd-ctos_discover_people-photo-rollover-01",
                rotateInSfxId: "wd-ctos_discover_people-photo-falls-in-01",
                rotateOutSfxId: null,
                cams: [{
                    x: .45,
                    y: .08,
        ...
        target: ".city-highlights-wrap",
        componentClass: "ib.CityHighlights",
        opts: {start: .5989, end: .6, startDelay: 0}
    }, {
        target: ".super.constrain",
        componentClass: "ib.Super",
        opts: {
            start: .48,
            end: .59,
            steps: [{sfxId: "wd-ctos_discover_the-result-text-in-01", delay: 0, duration: 300}]
        }
    }, {
        target: ".top-copy .super",
        componentClass: "ib.Super",
        opts: {
            start: .6393,
            end: .708,
            steps: [{
                sfxId: "wd-ctos_discover_you-text-appears-01",
                delay: 0,
                duration: 300
            }, {
                sfxId: "wd-ctos_discover_yourfamily-text-appears-01",
                delay: 900,
                duration: 300
            }, {sfxId: "wd-ctos_discover_environ-text-appears-01", delay: 2500, duration: 300}]
        }
    }, {
        target: "#connected-building-markers",
        componentClass: "ib.BuildingMarkers",
        opts: {
            start: .01,
            end: .23,
            markers: [{top: 12.6, left: 81.5, lineFromIndex: 0, start: .048}, {
                top: 11.5,
                left: 54.6,
                lineFromIndex: 0,
                start: .07
            }, {top: 64.6, left: 75.9, lineFromIndex: 0, start: .09}, {
                top: 12.9,
                left: 40.9,
                lineFromIndex: 2,
                start: .11
            }, {top: 29.8, left: 17.7, lineFromIndex: 3, start: .12}, {
                top: 41.2,
                left: 94.4,
                lineFromIndex: 0,
                start: .13
            }, {top: 60.8, left: 42, lineFromIndex: 5, start: .16}, {
                top: 10,
                left: 8.5,
                lineFromIndex: 4,
                start: .18
            }, {top: 41.9, left: 59, lineFromIndex: 4, start: .2}]
        }
    }, {
        target: "#chicago-building-markers", componentClass: "ib.ChicagoBuildingMarkers", opts: {
            start: .23,
            end: .59,
            rotationStart: .36,
            rotationDuration: 3e3,
            zoomOutStart: .34,
            zoomOutDuration: 3e3,
            translateToSuperStart: .46,
            translateToSuperDuration: 1500,
            translateToSuperTarget: ".result-super-wrap",
            lineDuration: 800,
            cctvCanvasTarget: ".chicago-cctv-canvas",
            cctvContextTarget: ".chicago-cctv",
            CCTVOpts: {
                lineDuration: 650,
                borderDuration: 0,
                imageDuration: 800,
                ...
                lineSfx: "wd-ctos_discover_circle-connecting-lines-draw-in-01",
                cams: [{
                    src: ib.Config.assetBasePath + "/images/chapter-2/CTOS_Discover_4businesses.jpg",
                    x: .12,
                    y: .12,
                    markerIndex: 6,
                    target: ".cctv-businesses",
                    imageStart: .398,
                    borderStart: .395,
                    forcedEnd: .46,
                    height: 159,
                    ...
                    src: ib.Config.assetBasePath + "/images/chapter-2/CTOS_Discover_6streets.jpg",
                    x: .23,
                    y: .66,
                    markerIndex: 16,
                    target: ".cctv-streets",
                    ...
                    src: ib.Config.assetBasePath + "/images/chapter-2/CTOS_Discover_7parks.jpg",
                    x: .67,
                    y: .6,
                    markerIndex: 17,
                    target: ".cctv-parks",
                    ...
                    src: ib.Config.assetBasePath + "/images/chapter-2/CTOS_Discover_5citycenters.jpg",
                    x: .68,
                    y: .15,
                    markerIndex: 7,
                    target: ".cctv-citycenters",
                    imageStart: .428,
                    borderStart: .425,
                    forcedEnd: .46,
                    height: 152,
            ...
            markers: [{xpos: -115, ypos: -55, zpos: 0, lineFromIndex: 0, start: .235}, {
                xpos: -100,
                ypos: -40,
                zpos: 15,
                lineFromIndex: 0,
                start: .238
            }, {xpos: -76, ypos: -42, zpos: 5, lineFromIndex: 1, start: .241}, {
                xpos: -92,
                ypos: -70,
                zpos: 25,
                lineFromIndex: 2,
                start: .244
            }, {xpos: -63, ypos: -68, zpos: -15, lineFromIndex: 2, start: .247}, {
                xpos: -48,
                ypos: -59,
                zpos: -20,
                lineFromIndex: 2,
                ...
                lineFromIndex: 2,
                start: .253,
                cctv: {src: ib.Config.assetBasePath + "/images/chapter-2/CTOS_Discover_4businesses.jpg"}
            }, {
                xpos: -35,
                ypos: -31,
                zpos: 30,
                lineFromIndex: 6,
                start: .256,
                cctv: {src: ib.Config.assetBasePath + "/images/chapter-2/CTOS_Discover_5citycenters.jpg"}
            }, {xpos: -73, ypos: -15, zpos: -2, lineFromIndex: 7, start: .259}, {
                xpos: -40,
                ypos: 13,
                zpos: -32,
                lineFromIndex: 7,
                start: .262
            }, {xpos: -26, ypos: 4, zpos: 18, lineFromIndex: 9, start: .265}, {
                xpos: -72,
                ypos: 10,
                zpos: 22,
                lineFromIndex: 10,
                start: .268
            }, {xpos: -20, ypos: 25, zpos: -22, lineFromIndex: 10, start: .271}, {
                xpos: -41,
                ypos: 38,
                zpos: -13,
                lineFromIndex: 10,
                start: .274
            }, {xpos: -73, ypos: 44, zpos: 1, lineFromIndex: 14, start: .277}, {
                xpos: -8,
                ypos: 44,
                zpos: -2,
                lineFromIndex: 14,
                ...
                lineFromIndex: 11,
                start: .283,
                cctv: {src: ib.Config.assetBasePath + "/images/chapter-2/CTOS_Discover_6streets.jpg"}
            }, {
                xpos: -7,
                ypos: 80,
                zpos: -10,
                lineFromIndex: 14,
                start: .286,
                cctv: {src: ib.Config.assetBasePath + "/images/chapter-2/CTOS_Discover_7parks.jpg"}
            }, {xpos: -54, ypos: 46, zpos: 16, lineFromIndex: 14, start: .289}, {
                xpos: -53,
                ypos: 56,
                zpos: -8,
                lineFromIndex: 18,
...
var ib = ib || {};
ib.ChapterData = ib.ChapterData || {}, ib.ChapterData["chapter-3"] = ib.ChapterData["chapter-3"] || {}, ib.ChapterData["chapter-3"] = $.extend(ib.ChapterData["chapter-3"], {
    totalScrollValue: 8e3,
    storyKeyframes: [{frame: .46, duration: 1500}, {frame: .999, duration: 1200, continueOnComplete: !0}],
    sfxTriggers: [{start: .003, sfxId: "wd-ctos_believe_black-bar-large-text-starts-in"}, {
        start: .6,
        sfxId: "wd-ctos_all_section-transition-whoosh-01"
    }],
    animationElements: [{
        target: ".block-reveal.blue-border .content",
        steps: [{
            start: .003,
            end: .1,
            properties: [{name: "width", unit: "%", startValue: 0, endValue: 100, easing: "easeOutQuad"}]
        }, {start: .75, end: .9, properties: [{name: "width", unit: "%", startValue: 100, endValue: 0}]}]
    }, {
        target: ".grid-reveal .question-0",
        steps: [{
            start: .2,
            end: .25,
            properties: [{name: "opacity", unit: "", startValue: 0, endValue: 1}]
        }, {start: .68, end: .73, properties: [{name: "opacity", unit: "", startValue: 1, endValue: 0}]}]
    }, {
        target: ".grid-reveal .question-1",
        steps: [{
            start: .23,
            end: .28,
            properties: [{name: "opacity", unit: "", startValue: 0, endValue: 1}]
        }, {start: .64, end: .69, properties: [{name: "opacity", unit: "", startValue: 1, endValue: 0}]}]
    }, {
        target: ".grid-reveal .question-2",
        steps: [{
            start: .26,
            end: .31,
            properties: [{name: "opacity", unit: "", startValue: 0, endValue: 1}]
        }, {start: .6, end: .65, properties: [{name: "opacity", unit: "", startValue: 1, endValue: 0}]}]
    }, {
        target: ".grid-reveal .question-3",
        steps: [{
            start: .29,
            end: .34,
            properties: [{name: "opacity", unit: "", startValue: 0, endValue: 1}]
        }, {start: .56, end: .61, properties: [{name: "opacity", unit: "", startValue: 1, endValue: 0}]}]
    }, {
        target: ".block-reveal.scroll-indicator .content",
        steps: [{
            start: .3,
        ...
        steps: [{
            ...
            properties: [{name: "opacity", unit: "", startValue: 0, endValue: 1}]
        }, {start: .85, end: .9, properties: [{name: "opacity", unit: "", startValue: 1, endValue: 0}]}]
    }, {
        target: ".q-and-a",
        steps: [{
            start: .01,
            ...
            properties: [{name: "opacity", unit: "", startValue: 0, endValue: 1}]
        }, {start: .52, end: .65, properties: [{name: "opacity", unit: "", startValue: 1, endValue: 0}]}]
    }, {
        target: ".mask",
        steps: [{start: .999, end: .9999, properties: [{name: "bottom", unit: "%", startValue: 0, endValue: 100}]}]
    }],
    animationComponents: [{
        target: ".dots",
        componentClass: "ib.Dots",
        ...
        componentClass: "ib.SurveyController",
        opts: {start: .11, end: .96, surveyData: ib.ChapterData["chapter-3"].getText().questions}
    }]
});
var ib = ib || {};
ib.ChapterData = ib.ChapterData || {}, ib.ChapterData["chapter-4"] = ib.ChapterData["chapter-4"] || {}, ib.ChapterData["chapter-4"] = $.extend(ib.ChapterData["chapter-4"], {
    totalScrollValue: 2e3,
    storyKeyframes: [{frame: 1, duration: 1400}],
    sfxTriggers: [{start: .18, sfxId: "wd-ctos_connect_left-text-builds-in-01"}],
    headerControlSteps: [{start: 0, end: 1, removeClass: "light"}],
    animationElements: [{
        target: ".blue-border .content",
        steps: [{
            start: .02,
            end: .25,
            properties: [{name: "width", unit: "%", startValue: 0, endValue: 100, easing: "easeOutQuad"}]
        ...
        target: ".social-map figure",
        steps: [{start: .25, end: .45, properties: [{name: "opacity", unit: "", startValue: 0, endValue: 1}]}]
    }, {
        target: ".hashtag",
        steps: [{start: .42, end: .54, properties: [{name: "opacity", unit: "", startValue: 0, endValue: 1}]}]
    }, {
        target: ".share-cta",
        steps: [{
            start: .42,
        ...
        steps: [{
            ...
            properties: [{name: "height", unit: "%", startValue: 0, endValue: 100, easing: "easeOutQuad"}]
        }]
    }, {
        target: ".sharing .twitterx",
        steps: [{
            start: .7,
            end: .85,
            properties: [{name: "height", unit: "%", startValue: 0, endValue: 100, easing: "easeOutQuad"}]
    ...
    animationComponents: [{
        target: ".social-map p",
        componentClass: "ib.Oomph",
        opts: {scramble: !0, scrambleDelay: 10, scrambleLettersDelay: 5, start: .8, end: 1.1, fadeOut: !1}
    }, {
        target: ".dots",
        componentClass: "ib.Dots",
        opts: {
            ...
            dots: [{type: "text", content: "+"}, {type: "text", content: "+"}, {
                ...
                type: "text",
                content: "+"
            }, {type: "text", content: "+"}, {type: "text", content: "+"}, {type: "text", content: "07"}, {
                type: "text",
                content: "10"
            }]
        }
        ...
        target: ".social-dots",
        componentClass: "ib.SocialMap",
        opts: {start: .75, end: 1, dots: ib.ChapterData["chapter-4"].getText().mapData}
    }]
}), this.ib = this.ib || {}, this.ib.Templates = this.ib.Templates || {}, this.ib.Templates["building-marker.html"] = Handlebars.template(function (a, b, c, d, e) {
    function f(a) {
        var b, c = "";
        return c += 'style="top:' + j((b = a.top, typeof b === i ? b.apply(a) : b)) + "%;left:" + j((b = a.left, typeof b === i ? b.apply(a) : b)) + '%;"'
    }

    this.compilerInfo = [4, ">= 1.0.0"], c = this.merge(c, a.helpers), e = e || {};
    var g, h = "", i = "function", j = this.escapeExpression, k = this;
    return h += "<li ", g = c["if"].call(b, b, {
        hash: {},
        inverse: k.noop,
        fn: k.program(1, f, e),
        data: e
    }), (g || 0 === g) && (h += g), h += "></li>"
}), this.ib.Templates["chapter-1.html"] = Handlebars.template(function (a, b, c, d, e) {
    function f(a, b) {
        var c, d = "";
    ...
    function g(a, b) {
        var d, e, f = "";
        return f += '\n  <li class="testimonial testimonial-' + l((d = b, d = null == d || d === !1 ? d : d.index, typeof d === k ? d.apply(a) : d)) + " ", (e = c.extraContainerClass) ? e = e.call(a, {
            hash: {},
            data: b
        }) : (e = a.extraContainerClass, e = typeof e === k ? e.apply(a) : e), f += l(e) + '">\n    <img draggable="false" src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7">\n    <p class="' + l((d = a.textClass, typeof d === k ? d.apply(a) : d)) + '">', d = a.text, e = typeof d === k ? d.apply(a) : d, (e || 0 === e) && (f += e), f += "</p>\n  </li>\n  "
    }
    ...
    return l += '<div class="infographic-question ', (j = c.classes) ? j = j.call(b, {
        hash: {},
        data: e
    }) : (j = b.classes, j = typeof j === m ? j.apply(b) : j), l += n(j) + '">\n  <div class="data-visualization-wrapper">\n      <div class="dashes-wrapper">\n        <canvas></canvas>\n      </div>\n\n      <div class="question-wrap">\n        <a class="accept">', (j = c.accept) ? j = j.call(b, {
        hash: {},
        data: e
    }) : (j = b.accept, j = typeof j === m ? j.apply(b) : j), l += n(j) + '</a>\n          <figure class="data-visualization">\n            ', j = c.each.call(b, b.questionStatistics, {
        hash: {},
        inverse: o.noop,
        fn: o.program(1, f, e),
        data: e
    }), (j || 0 === j) && (l += j), l += '\n          </figure>\n        </div>\n        <div class="answer-wrap">\n          <a class="next">' + n((j = b.next, typeof j === m ? j.apply(b) : j)) + '</a>\n          <figure class="data-visualization">\n            ', k = c.each.call(b, b.answerStatistics, {
        hash: {},
        inverse: o.noop,
        fn: o.program(6, i, e),
        data: e
    }), (k || 0 === k) && (l += k), l += "\n          </figure>\n      </div>\n  </div>\n</div>"
}), this.ib.Templates["map-dot.html"] = Handlebars.template(function (a, b, c, d, e) {
    this.compilerInfo = [4, ">= 1.0.0"], c = this.merge(c, a.helpers), e = e || {};
    var f, g = "", h = "function", i = this.escapeExpression;
    return g += "<li>", (f = c.displayedCount) ? f = f.call(b, {
        hash: {},
        data: e
    }) : (f = b.displayedCount, f = typeof f === h ? f.apply(b) : f), g += i(f) + "</li>"
}), this.ib.Templates["multiple-choice-question.html"] = Handlebars.template(function (a, b, c, d, e) {
    function f(a) {
        var b, c = "";
    ...
    this.compilerInfo = [4, ">= 1.0.0"], c = this.merge(c, a.helpers), e = e || {};
    var g, h = "", i = "function", j = this.escapeExpression, k = this;
    return h += '<div class="multiple-choice-question">\n  <div class="question-wrap">\n    <div class="dashes-wrapper">\n      <canvas></canvas>\n    </div>\n    <ul class="choices">\n      ', g = c.each.call(b, b.choices, {
        hash: {},
        inverse: k.noop,
        fn: k.program(1, f, e),
        data: e
...
ib.ComponentLoader = function () {
    function a(a) {
        a = a || $("body"), $("." + i, a).each(function (a) {
            if (-1 !== $.inArray(this, h)) return -1;
            h.push(this);
            var b = null, c = $(this).data(j), d = null;
            $el = $(this), void 0 !== e[c] && (b = new e[c]($(this)), d = $el.data("id") ? $el.data("id") : i + Math.floor(1e5 * Math.random()) + "" + a, b.id = d, g[d] = b, "undefined" == typeof f[c] ? f[c] = [b] : f[c].push(b), b.init())
        })
    }
    ...
    var e = [], f = [], g = [], h = [], i = "ib-component", j = "component";
    return {init: a, register: b, registeredClasses: e, findInstanceById: c, findInstancesByType: d}
}();
var ib = ib || {};
ib.Dashes = function (a, b) {
    this.context = a, this.canvas = a.find("canvas"), this.ctx = this.canvas[0].getContext("2d"), this.dashes = [], this.tronLines = [], this.rafIndex = void 0, this.canvasWidth = 0, this.canvasHeight = 0, this.animating = !1, this.tronLineLoop = 0, this.tronLineTimer = null, this.fillStyle = null, this.strokeStyle = null, this.opts = $.extend({
        minDashSpeed: 10,
        maxDashSpeed: 25,
        numDashes: 20,
        numLines: 3,
        ...
        tronLinesDelay: .2,
        tronLineDuration: .4,
        tronLineInterval: 3e3
    }, b || a.data())
}, ib.Dashes.prototype = {
    init: function () {
        this.toggleColor(!1), this.reset(), $(window).on("resize", $.throttle(1e3, $.proxy(this.reset, this)))
    }, reset: function () {
        this.resizeCanvas(), this.createDashes(), this.createTronLines()
    }, resizeCanvas: function () {
        this.canvas[0].width = this.canvasWidth = this.context.width(), this.canvas[0].height = this.canvasHeight = this.context.height(), this.canvas.css({marginLeft: -this.canvasWidth / 2})
    }, createDashes: function () {
        this.dashes = [];
        for (var a = 0; a < this.opts.numDashes; a++) {
            var b = Math.floor(Math.random() * this.opts.dashWidthMax) + this.opts.dashWidthMin,
                c = Math.random() > .5 ? 0 : this.canvasWidth, d = Math.random() * this.canvasHeight,
                e = new ib.Dash(b, this.opts.dashHeight, c, d, this.opts.minDashSpeed, this.opts.maxDashSpeed);
            e.init(), this.dashes.push(e)
        }
    }, createTronLines: function () {
        this.tronLines = [];
        for (var a = 0; a < this.opts.numTronLines; a++) {
            var b = new ib.TronLine(this.canvasWidth, this.canvasHeight);
            b.init(), this.tronLines.push(b)
        }
    }, render: function () {
        this.rafIndex = window.requestAnimationFrame($.proxy(this.render, this)), this.canvas[0].width = this.canvasWidth, this.renderDashes(), this.renderTronLines()
    }, renderDashes: function () {
        for (var a = 0; a < this.opts.numDashes; a++) {
            var b = this.dashes[a];
            b.update(this.canvasWidth), this.ctx.beginPath(), this.ctx.fillStyle = this.fillStyle, this.ctx.fillRect(b.x, b.y, b.width, b.height), this.ctx.closePath()
        }
    }, renderTronLines: function () {
        for (var a = 0; a < this.opts.numTronLines; a++) {
            var b = this.tronLines[a];
            this.ctx.beginPath(), this.ctx.moveTo(b.start.x, b.start.y);
            for (var c = 0; c < b.segments.length; c++) {
                var d = b.segments[c];
                d.draw && this.ctx.lineTo(d.x, d.y)
            }
            this.ctx.strokeStyle = this.strokeStyle, this.ctx.lineWidth = 2, this.ctx.stroke(), this.ctx.closePath()
        }
    }, play: function () {
        this.render(), this.tronProgress = 0, this.tronLineTimer = setInterval($.proxy(this.tweenTronLines, this), this.opts.tronLineInterval)
    }, toggleColor: function (a) {
        a ? (this.fillStyle = "#000000", this.strokeStyle = "#c9c9c9") : (this.fillStyle = "#ffffff", this.strokeStyle = "#4f4f4f")
    }, tweenTronLines: function () {
        for (var a = this, b = 0; b < this.opts.numTronLines; b++) {
            var c = this.tronLines[b];
            TweenLite.to(c, this.opts.tronLineDuration, {
                delay: this.opts.tronLinesDelay * (b + 1),
                progress: 1,
                onUpdate: function () {
                    for (var a = 0; a < this.target.segments.length; a++) {
                        var b = this.target.segments[a],
                            c = Math.max(0, Math.min(1, (this.target.progress - b.threshold.start) / (b.threshold.end - b.threshold.start)));
                        c && (b.x = b.line.start.x + (b.line.end.x - b.line.start.x) * c, b.y = b.line.start.y + (b.line.end.y - b.line.start.y) * c)
                    }
                },
                onComplete: function () {
                    TweenLite.to(this.target, a.opts.tronLineDuration, {
                        tailProgress: 1, onUpdate: function () {
                            for (var a = 0; a < this.target.segments.length; a++) {
                                var b = this.target.segments[a],
                                    c = Math.max(0, Math.min(1, (this.target.tailProgress - b.threshold.start) / (b.threshold.end - b.threshold.start)));
                                c && (this.target.start.x = b.line.start.x - (b.line.start.x - b.line.end.x) * c, this.target.start.y = b.line.start.y - (b.line.start.y - b.line.end.y) * c, c >= 1 && (b.draw = !1))
                            }
                        }, onComplete: function () {
                            this.target.reset()
                        }
        ...
        this.canvas.fadeOut("fast", $.proxy(function () {
            "undefined" != typeof this.rafIndex && (window.cancelAnimationFrame(this.rafIndex), this.rafIndex = void 0, clearInterval(this.tronLineTimer))
        }, this))
    }
}, ib.Dash = function (a, b, c, d, e, f) {
    this.width = a, this.height = b, this.x = c, this.y = d, this.minDashSpeed = e, this.maxDashSpeed = f, this.goLeft = !1, this.speed = 0
}, ib.Dash.prototype = {
    init: function () {
        this.resetSpeed()
    }, resetSpeed: function () {
        this.speed = Math.floor(Math.random() * this.maxDashSpeed) + this.minDashSpeed
    }, update: function (a) {
        this.x >= a + this.width && (this.resetSpeed(), this.goLeft = !0), this.x <= -this.width && (this.resetSpeed(), this.goLeft = !1), this.goLeft ? this.x -= this.speed : this.x += this.speed
    }
}, ib.TronLine = function (a, b) {
    this.canvasWidth = a, this.canvasHeight = b, this.progress = 0, this.tailProgress = 0, this.segments = [], this.start = {}
}, ib.TronLine.prototype = {
    init: function () {
        this.reset()
    }, reset: function () {
        var a = this.canvasWidth, b = this.canvasHeight / 2 - 10 + 20 * Math.random(),
            c = Math.random() > .5 ? a - this.canvasWidth / 4 - 20 + 20 * Math.random() : this.canvasWidth / 4 - 20 + 20 * Math.random(),
            d = b + (Math.random() > .5 ? -(10 * Math.random()) - 5 : 10 * Math.random() + 5), e = 0;
        this.progress = 0, this.tailProgress = 0, this.segments = [{
            line: {
                start: {x: a, y: b},
                end: {x: c, y: b}
            }
        }, {line: {start: {x: c, y: b}, end: {x: c, y: d}}}, {
            line: {
                start: {x: c, y: d},
                end: {x: e, y: d}
            }
        }], this.start = {x: this.segments[0].line.start.x, y: this.segments[0].line.start.y};
        for (var f = 0, g = 0; g < this.segments.length; g++) {
            var h = this.segments[g];
            h.draw = !0;
            var i = h.line.start.x - h.line.end.x;
            h.length = Math.abs(i || h.line.start.y - h.line.end.y), f += h.length
        }
        for (var j = 0, g = 0; g < this.segments.length; g++) {
            var h = this.segments[g];
            h.threshold = {start: j, end: j + h.length / f}, j = h.threshold.end
        }
    }
};
var ib = ib || {};
ib.Events = {
    BG_VIDEO_DID_RESIZE: "ib::BG_VIDEO_DID_RESIZE",
    FACT_CHOSEN: "ib::ib.Events.FACT_CHOSEN",
    PAGE_DID_BECOME_VISIBLE: "ib::PAGE_DID_BECOME_VISIBLE",
    INTRO_LOGO_REVEALED: "ib::INTRO_LOGO_REVEALED",
    PRELOADER_DID_HIDE: "ib::PRELOADER_DID_HIDE",
    PRELOAD_READY_FOR_DOTS: "ib::PRELOAD_READY_FOR_DOTS",
    NETWORK_DID_BEGIN: "ib::NETWORK_DID_BEGIN",
    NETWORK_DID_ZOOM_IN: "ib::NETWORK_DID_ZOOM_IN",
    NETWORK_DID_ZOOM_OUT: "ib::NETWORK_DID_ZOOM_OUT",
    PRELOADER_COMPLETE: "ib::PRELOADER_COMPLETE",
    STORY_SCROLL_DID_BEGIN: "ib::STORY_SCROLL_DID_BEGIN",
    STORY_SCROLL_DID_END: "ib::STORY_SCROLL_DID_END",
    QUESTION_ANSWERED: "ib::QUESTION_ANSWERED",
    NEXT_QUESTION_REQUESTED: "ib::NEXT_QUESTION_REQUESTED",
    NAV_STATE_DID_CHANGE: "ib::NAV_STATE_DID_CHANGE",
    PAGE_DID_CHANGE: "ib::PAGE_DID_CHANGE",
    CHAPTER_DID_CHANGE: "ib::CHAPTER_DID_CHANGE",
    SCROLLER_DID_SCROLL: "ib::SCROLLER_DID_SCROLL",
    SCROLLBAR_DID_SCROLL: "ib::SCROLLBAR_DID_SCROLL",
    ASSETS_LOADED: "ib::ASSETS_LOADED",
    PAUSE_SCROLLING: "ib::PAUSE_SCROLLING",
    RESUME_SCROLLING: "ib::RESUME_SCROLLING",
    VO_PROGRESS_UPDATE: "ib::VO_PROGRESS_UPDATE",
    VO_PLAY: "ib::VO_PLAY",
    VO_STOP: "ib::VO_STOP",
    SHOW_OVERLAY_LOGO: "ib::SHOW_OVERLAY_LOGO",
    HIDE_OVERLAY_LOGO: "ib::HIDE_OVERLAY_LOGO"
};
var ib = ib || {};
ib.Geom = ib.Geom || {}, ib.Geom.Point = function (a, b) {
    null === a && (a = 0), null === b && (b = 0), this.x = a, this.y = b
}, ib.Geom.Point.distance = function (a, b) {
    var c = b.x - a.x, d = b.y - a.y;
    return Math.sqrt(c * c + d * d)
}, ib.Geom.Point.polar = function (a, b) {
    var c = b * Math.PI / 180, d = a * Math.sin(c), e = a * Math.cos(c);
    return new ib.Geom.Point(d, e)
}, ib.Geom.Point.prototype = {
    init: function () {
    }, clone: function () {
        var a = new ib.Geom.Point(this.x, this.y);
        return a
    }, lerp: function (a, b, c) {
        return a + c * (b - a)
    }
...
ib.Global = function () {
    function a() {
        h = new Motio(e[0], {
            ...
            h.to(0), g.stop().fadeOut(250, "easeOutCubic")
        }), c.on("mouseleave", function () {
            f.show(), h.toEnd(), g.fadeIn(250, "easeOutCubic")
        }), h.on("frame", function () {
            0 === h.frame ? (f.hide(), d.addClass("animate")) : d.removeClass("animate")
        }), $(ib).on(ib.Events.SHOW_OVERLAY_LOGO, function () {
            f.show(), g.fadeIn(250, "easeOutCubic"), i && (i = !1, h.to(0, !0), h.toEnd()), c.css("pointer-events", "auto")
        }), $(ib).on(ib.Events.HIDE_OVERLAY_LOGO, function () {
            i = !0, f.fadeOut(250, "easeOutCubic"), g.stop().fadeOut(250, "easeOutCubic"), c.css("pointer-events", "none")
        })
    }

    var c = $("#header .blume-logo-wrapper"), d = c.find("a"), e = $(".blume-logo", c), f = $(".blume-logo-mask", c),
        g = c.find("figcaption"), h = null, i = !0;
    return {init: a}
}();
var ib = ib || {};
ib.Resizer = function () {
    function a() {
        Modernizr.backgroundsize || ($(window).on("resize", $.throttle(1e3, d)), $(ib).on(ib.Events.ASSETS_LOADED, c))
    }

    function b(a) {
        var b, c, e, f;
        $(".aspect-fill-centered", a).add(".aspect-fill-bottom-centered", a).each(function () {
            c = $(this), 0 === $("img", c).length && (b = c.css("background-image"), c.css("background-image", "none"), b = b.replace(/^url\(["']?/, "").replace(/["']?\)$/, ""), f = ib.Preloader.ratioForImage(b), e = $('<img src="' + b + '" data-ratio="' + f + '" data-original-url="' + b + '">'), c.addClass("backgroundsize-fallback-wrap"), c.append(e))
        }), d()
    }

    function c() {
        var a, b, c;
        $(".backgroundsize-fallback-wrap img").each(function () {
            b = $(this), 0 === $("img", b).length && (a = b.data("original-url"), c = ib.Preloader.ratioForImage(a), $("img", b).data("ratio", c))
        }), d()
    }

    function d() {
        var a, b, c, d, e, f, g, h, i, j;
        $(".backgroundsize-fallback-wrap").each(function () {
            a = $(this), a.hasClass("force-full-size") ? (i = ib.ScrollController.width(), j = ib.ScrollController.height()) : (i = a.width(), j = a.height()), b = $("img", a), d = i / Math.max(1, j), (0 === d || d > 500) && (d = ib.ScrollController.width() / ib.ScrollController.height()), c = b.data("ratio"), d > c ? (e = i, f = e / c) : (f = j, e = f * c), g = Math.round((e - i) / 2), h = Math.round((f - j) / 2), b.css({
                height: Math.round(f),
                "margin-left": Math.min(0, -g),
                "margin-top": Math.min(0, -h),
                width: Math.round(e)
            })
        })
    }

    return {init: a, createFallbackMarkup: b}
}(), ib.Sharing = function () {
    function a() {
        $("body").on("click", ".facebook", share_facebook), $("body").on("click", ".twitterx", share_x), $("body").on("click", ".reddit", share_reddit), $(".sharing li").on("mouseenter", b);
        var a = ib.ChapterData["chapter-4"].getText().facts.crime;
        g = location_origin + a.image;
        var i = ib.ChapterData["chapter-4"].getText().shareCopy;
        fact = i[Math.floor(Math.random() * i.length)], $(ib).on(ib.Events.FACT_CHOSEN, function (a, b) {
            var c = ib.ChapterData["chapter-4"].getText().facts[b.fact];
            g = location_origin + c.image
        })
    }

    function b() {
        ib.SoundController.playSfx("wd-ctos_connect_share-rollover-01")
    }

    function share_facebook(a) {
        a.preventDefault();
        var b = "https://www.facebook.com/sharer/sharer.php?u=" + encodeURIComponent(location_origin);
        window.open(b, "", "width=700,height=400,left=300,top=200,resizable=yes,scrollbars=no,directories=no,titlebar=no,toolbar=no,location=yes,status=no,menubar=no")
    }

    function share_x(a) {
        a.preventDefault();
        var b = "https://x.com/intent/post?text=" + fact + " " + encodeURIComponent(location_origin);
        window.open(b, "", "width=700,height=400,left=300,top=200,resizable=yes,scrollbars=no,directories=no,titlebar=no,toolbar=no,location=yes,status=no,menubar=no")
    }

    function share_reddit(a) {
        a.preventDefault();
        var b = "https://www.reddit.com/submit?url=" + encodeURIComponent(location_origin) + "&title=" + encodeURIComponent(fact);
        window.open(b, "", "width=700,height=500,left=300,top=200,resizable=yes,scrollbars=yes,directories=no,titlebar=no,toolbar=no,location=yes,status=no,menubar=no");
    }
...
var ib = ib || {};
ib.StoryAnimationHandler = function () {
    function a(a, c) {
        var d = b(a, c);
        a.$el.css(d)
    }
    ...
    function b(a, b) {
        ...
        for (var k in i.properties) {
            f = i.properties[k];
            var l = i.end - i.start, m = Math.max(0, Math.min(l, b - i.start)), n = f.startValue,
                o = f.endValue - f.startValue;
            h = $.easing[f.easing] ? $.easing[f.easing](null, m, n, o, l) : o * m / l + n, h = d(f, h), g = e(f.name, f.skipUpgrade), j[g] = h
        }
        return j
    }
    ...
    function c(a, b) {
        var c = a.steps, d = c[0];
        for (var e in c) {
            if (c[e].start >= b) break;
            d = c[e], d.remove && b >= d.end && $(a.target).remove()
        }
        return d
    }

    function d(a, b) {
        return Modernizr.csstransforms3d && !a.skipUpgrade ? "left" === a.name ? (b = "%" === a.unit ? Math.round(b * ib.ScrollController.width() / 100) : Math.round(b), b = "translate3d(" + b + "px,0,0)") : "top" === a.name ? (b = "%" === a.unit ? Math.round(b * ib.ScrollController.height() / 100) : Math.round(b), b = "translate3d(0," + b + "px,0)") : ("px" === a.unit && (b = Math.round(b)), b += a.unit) : ("px" === a.unit && (b = Math.round(b)), b += a.unit), b
    }

    function e(a, b) {
        return !Modernizr.csstransforms3d || "left" !== a && "top" !== a || b || (a = "transform"), a
    }

    return {updateElements: a, cssForElement: b}
}();
var ib = ib || {};
ib.StoryImageSequenceHandler = function () {
    function a() {
        for (var a in g) {
            var b = g[a];
            b.canvas.width = b.$canvas.width(), b.canvas.height = b.$canvas.height()
        }
    }

    function b(a) {
        g.push({canvas: a[0], $canvas: a})
    }

    function c(a, b) {
        var c = f(a.steps, b), e = c.end - c.start, g = Math.max(0, Math.min(e, b - c.start)), h = c.startFrameNum,
            i = c.numFrames - 1, j = Math.round(i * g / e + h), k = c.getFilename(j);
        a.currentFrameNum != j && (a.currentFrameNum = j, Modernizr.canvas ? d(k, a) : Modernizr.backgroundsize ? a.$el.css("background-image", "url(" + k + ")") : $("img", a.$el)[0].src = k)
    }

    function d(a, b) {
        var c = ib.Preloader.getCachedAsset(a);
        if (c) {
            var d = b.$el[0], e = b.$el.width(), f = b.$el.height();
            d.width = e, d.height = f;
            var g, h, i, j, k = e / f, l = c.width / c.height;
            k > l ? (g = e, h = g / l) : (h = f, g = h * l), i = Math.round((g - e) / 2), j = Math.round((h - f) / 2);
            var m = d.getContext("2d");
            m.drawImage(c, Math.min(0, -i), Math.min(0, -j), Math.round(g), Math.round(h))
        } else b.currentFrameNum = null
    }

    function e(a, b) {
        var c = f(a.steps, b), d = c.end - c.start, e = Math.max(0, Math.min(d, b - c.start)), g = c.startFrameNum,
            h = c.numFrames - 1;
        return Math.round(h * e / d + g)
    }

    function f(a, b) {
        var c = a[0];
        for (var d in a) {
            if (a[d].start >= b) break;
            c = a[d]
        }
        return c
    }
    ...
    var g = [];
    return $(window).on("resize", $.throttle(1e3, a)), {
        updateSequence: c,
        getCurrentFrameNum: e,
        registerCanvasVideo: b
    }
}();
var ib = ib || {};
ib.History = function () {
    function a() {
        $(ib).on(ib.Events.PAGE_DID_CHANGE, c), b()
    }
    ...
    function e(a) {
        var b, c = null, d = window.location.hash;
        if (d = d.replace(/^#!/, "").replace(/\/$/, ""), d && d.length > 0 && (b = d.split("/"), b.length > a + 1 && (c = b[a + 1])), !c) {
            var e = window.location.pathname;
            e = e.replace(/\/$/, ""), e && e.length > 0 && (b = e.split("/"), b.length > a + 1 && (c = b[a + 1]))
        }
        return c
    }
...
ib.Main = function () {
    ...
    function b() {
        return minChapterIndex
    }

    function c() {
        (d() || ib.Config.FAKE_TABLET_MODE) && e(), ib.Resizer.init(), ib.VideoController.init(), ib.ComponentLoader.init(), ib.Navigation.init(), ib.StoryController.init(), ib.ScrollController.init(), ib.ScrollController.populateSections(), ib.Sharing.init(), ib.Preloader.init(), ib.Global.init()
    }
    ...
    function e() {
        initialChapterIndex = 1, minChapterIndex = 1, $("html").addClass("is-tablet-trimmed"), $(".audio-levels-bar").remove(), $("#city-video").remove(), $("#header nav li:lt(1)").hide(), ib.ChapterData["chapter-1"].totalScrollValue = 0, ib.ChapterData["chapter-1"].storyKeyframes = [], ib.ChapterData["chapter-1"].sfxTriggers = [];
        for (var a in ib.ChapterData["chapter-1"].animationComponents) {
            var b = ib.ChapterData["chapter-1"].animationComponents[a];
            ".network-canvas" === b.target && (b.opts.cctvCanvasTarget = null, b.opts.cctvContextTarget = null, b.opts.CCTVOpts = null)
        }
        ib.ChapterData["chapter-2"].storyKeyframes = [{frame: .599, duration: 2e3}, {
            frame: .915,
            duration: 21e3
        }, {
            frame: .9999,
            duration: 2e3,
            continueOnComplete: !0
        }], ib.ChapterData["chapter-2"].sfxTriggers = [], $("#chapter-2").on("click", ".testimonials-click-target-tablet", ib.ScrollController.forceNextKeyframe)
    }

    return initialChapterIndex = 0, minChapterIndex = 0, {
        init: c,
        isNonDesktop: d,
        getMinChapterIndex: b,
        getInitialChapterIndex: a
    }
}();
var ib = ib || {};
ib.Navigation = function () {
    function a() {
        g = ib.ComponentLoader.findInstanceById("header"), $(ib).on(ib.Events.CHAPTER_DID_CHANGE, b)
    }

    function b() {
        i = h.CHAPTERS[ib.ScrollController.getCurrentChapterIndex()], $(ib).trigger(ib.Events.PAGE_DID_CHANGE)
    }
    ...
    function d(a) {
        if (f(a)) {
            i = a;
            var b = $.inArray(a, h.CHAPTERS);
            ib.ScrollController.jumpToChapter(b, !1)
        }
    }

    function e(a) {
        return isFormPage(a) || f(a) || isVideo(a)
    }

    function f(a) {
        return -1 !== $.inArray(a, h.CHAPTERS)
    }

    var g = null, h = {CHAPTERS: ["believe", "discover", "imagine", "connect"]}, i = h.CHAPTERS[0];
    return {init: a, isValidPage: e, isChapterPage: f, getCurrentPage: c, handleLandingPage: d}
}();
var ib = ib || {};
ib.Preloader = function () {
    function a() {
        $(ib).on(ib.Events.INTRO_LOGO_REVEALED, b), ib.Config.SKIP_INTRO && (F = 1, $(".watch", p).on("click", o).addClass("complete")), $("body").fadeIn(500, function () {
            ib.isIE ? setTimeout(function () {
                $(ib).trigger(ib.Events.PAGE_DID_BECOME_VISIBLE)
            }, 2e3) : $(ib).trigger(ib.Events.PAGE_DID_BECOME_VISIBLE)
        }), TweenMax.to($("#intro-mask .blue-border"), 0, {
            height: 0,
            delay: .5,
            ease: Quart.easeOut
        }), animateQuestion = new ib.Oomph($(".preloader-content p"), {
            animationDelay: 10,
            animationDuration: 40
        }), animateQuestion.init()
    }

    function b() {
        q = $("#intro-mask-wrap"), r = $(".load-border", q), s = $(".preloader-content", q), $("p", s).fadeIn(600, "easeOutQuad"), $(".watch", s).delay(200).fadeIn(800, "easeOutQuad", e);
        var a = $(".watch", q), b = $(".default", a);
        t = $(".loaded", a), loadingTextAnimation = new ib.Oomph(b, {
            animationStartDelay: 1300,
            animationDelay: 60,
            animationDuration: 1500,
            scramble: !0
        }), loadingTextAnimation.init(), watchTextAnimation = new ib.Oomph(t, {
            animationStartDelay: 100,
            animationDelay: 60,
            animationDuration: 1500,
            scramble: !0
        }), watchTextAnimation.init(), $("#preloader .load-header").show(), TweenMax.to($("#preloader .load-header"), 0, {y: -140}), TweenMax.to($("#preloader .load-header"), 1, {
            y: 0,
            delay: 1,
            ease: Quart.easeOut
        }), $("#header").show(), TweenMax.to($("#header"), 0, {y: -200}), TweenMax.to($("#header"), 1, {
            y: 0,
            delay: 1,
            ease: Quart.easeOut
        }), TweenMax.to($("#intro-mask .inner"), 1, {
            y: 20,
            delay: 1,
            ease: Quart.easeOut
        }), TweenMax.to($("#intro-mask .blue-border"), 0, {
    ...
    function k() {
        ...
        var a = x / y;
        if (0 !== a && (z = a), .01 > Math.abs(z - A) ? A != z && (A = z, n()) : (A += Math.min(F, B * (z - A)), n()), A >= 1) {
            cancelAnimationFrame(C), $(ib).trigger(ib.Events.PRELOADER_COMPLETE);
            var b = $(".watch", q);
            b.hasClass("complete") || (ib.Config.SKIP_INTRO && o(), b.on("touchstart click", o).addClass("complete"), $(".default", b).fadeOut(250, "easeOutCubic", function () {
                watchTextAnimation.animate(), ib.SoundController.playSfx("wd-ctos_intro_loading-animates-to-learn-more-01")
            }), TweenMax.to(r, .35, {
                height: 5,
                ease: Quad.easeInOut
            }), $("#intro-mask .blue-border").on("mouseenter", l), $("#intro-mask .blue-border").on("mouseleave", m))
        }
    }

    function l() {
        ib.SoundController.playSfx("wd-ctos_intro_learn-more-rollover-01"), TweenMax.to(r, .5, {
            height: 45,
            ease: Expo.easeInOut
        }), TweenMax.to(t, .1, {top: 2, ease: Expo.easeInOut})
    }

    function m() {
        ib.SoundController.playSfx("wd-ctos_intro_learn-more-rolloff-01"), TweenMax.to(r, .5, {
            height: 5,
            ease: Expo.easeInOut
        }), TweenMax.to(t, .1, {top: 0, ease: Expo.easeInOut})
    }
    ...
    function o(a) {
        E || (E = !0, $("#intro-mask .blue-border").off("mouseenter", l), $("#intro-mask .blue-border").off("mouseleave", m), ib.Main.isNonDesktop() && setTimeout(function () {
            $(ib).trigger(ib.Events.NETWORK_DID_ZOOM_OUT)
        }, 1e3), ib.SoundController.playSfx("wd-ctos_intro_learn-more-click-fade-out-01"), s.add(p).delay(100).fadeOut(400, "easeOutCubic", function () {
            "function" == typeof a && a(), ib.History.init(), $(ib).trigger(ib.Events.PRELOADER_DID_HIDE), $(ib).trigger(ib.Events.RESUME_SCROLLING)
        }))
    }

    var p = $("#preloader"), q = null, r = null, s = null, t = null, u = [], v = {}, w = {}, x = 0, y = 0, z = 0, A = 0,
        B = .2, C = null, D = !1, E = !1, F = .01;
    return {init: a, assetHasBeenLoaded: i, getCachedAsset: j, ratioForImage: h}
}();
var ib = ib || {};
ib.ScrollController = function () {
    function a() {
        E = ib.ComponentLoader.findInstancesByType("ib.Chapter"), l(), b(), D.on("resize", f), $(document).on("mousewheel", q), $(ib).on(ib.Events.PAUSE_SCROLLING, k), $(ib).on(ib.Events.RESUME_SCROLLING, j), $(ib).on(ib.Events.SCROLLBAR_DID_SCROLL, t), $(document).on("touchstart", n), requestAnimationFrame(u), e(), c(), $(ib).on(ib.Events.PRELOADER_DID_HIDE, d)
    }

    function b() {
        for (var a in E) {
            var b = E[a].story.storyKeyframes;
            for (var c in b) b[c].chapterIndex = a, b[c].scrollValue = b[c].frame * E[a].totalScrollValue + E[a].startingScrollValue, b[c].globalIndex = T.length, T.push($.extend(!0, {}, b[c]))
        }
    }

    function c() {
        var a = T[0];
        ib.StoryController.triggerKeyframe(a, 0)
    }

    function d() {
        var a = T[ib.Config.START_KEYFRAME_INDEX], b = ib.Config.START_KEYFRAME_DURATION || a.duration;
        ib.StoryController.triggerKeyframe(a, b)
    }

    function e() {
        $("body").keydown(function (a) {
            K || (40 === a.keyCode ? r(-2 * V) : 32 === a.keyCode ? r(-2 * V) : 38 === a.keyCode && r(2 * V))
        })
    }

    function f() {
        M = D.height() - $("#header").height(), N = D.width(), $(".force-full-size", C).css({
            height: M,
            width: N
        }), K || w(!0)
    }
    ...
    function l() {
        J = 0;
        for (var a in E) E[a].startingScrollValue = J, J += E[a].totalScrollValue
    }

    function m() {
        for (var a in E) E[a].setContent();
        f()
    }

    function n(a) {
        K || R || (W = a.originalEvent.touches[0].clientY, X = W, $(document).on("touchmove", o).on("touchend", p))
    }

    function o(a) {
        return X = a.originalEvent.touches[0].clientY, !1
    }

    function p() {
        $(document).off("touchmove", o).off("touchend", p), W - X > Y ? r(-2 * V) : -Y > W - X && r(2 * V)
    }
    ...
    function r(a) {
        if (!ib.StoryController.onCooldown()) {
            S -= a;
            var b;
            if (S > U) b = s(), S = 0, b && !ib.StoryController.hasControl() && ib.StoryController.triggerKeyframe(b, b.duration); else if (-V > S) {
                var c = F;
                c = ib.StoryController.hasControl() && !ib.StoryController.justBegan() || !ib.StoryController.hasControl() && 2 > F ? F : Math.max(ib.Main.getMinChapterIndex(), F - 1), x(c, !1), S = 0
            }
        }
    }
    ...
    function s() {
        var a = null;
        for (var b in T) {
            if (a = T[b], b == T.length - 1 && Math.abs(I - a.scrollValue) < 100) return;
            if (a.scrollValue > I) break
        }
        return a
    }

    function t(a, b) {
        K || (I = b.progress * J, I = Math.max(0, Math.min(J, I)))
    }

    function u() {
        requestAnimationFrame(u), K || H != I && (H = I, w(), v())
    }

    function v() {
        $(ib).trigger(ib.Events.SCROLLER_DID_SCROLL, {progress: H / J})
    }

    function w(a) {
        for (var b, c, d, e = E.length, f = 0; e > f; f++) b = E[f].startingScrollValue, c = E[f].totalScrollValue, d = Math.min(1, Math.max(0, H - b) / c), E[f].setProgress(d, a), H >= b && b + c > H && F != f && (F = f, $(ib).trigger(ib.Events.CHAPTER_DID_CHANGE, {index: F}), $(".active-chapter", C).removeClass("active-chapter"), E[f].$context.addClass("active-chapter"))
    }

    function x(a, b, c) {
        R = !0, ib.StoryController.resignControl(), clearInterval(Q);
        var d = E[a], e = d.startingScrollValue;
        if (a == ib.Main.getInitialChapterIndex() && (e = T[0].scrollValue), c = "undefined" == typeof c ? O : c, b) {
            var f = 0, g = (e - I) * (P / c);
            Q = setInterval(function () {
                return f += P, f > c ? (clearInterval(Q), I = e, R = !1, r(-2 * U), void 0) : (I += g, void 0)
            }, P)
        } else H = e, I = H += a == ib.Main.getInitialChapterIndex() ? .1 : 1, Q = setInterval(function () {
            var a = e - I;
            15 > a && (clearInterval(Q), R = !1, r(-2 * U)), I += .15 * a
        }, P)
    }
    ...
    function z(a, b, c) {
        clearInterval(Q), b = 0 === b ? 1 : b, b = "undefined" == typeof b ? O : b;
        var d = (new Date).getTime(), e = I;
        Q = setInterval(function () {
            var f = (new Date).getTime(), g = f - d;
            if (g > b) {
                if (I = a, H == I) return clearInterval(Q), "function" == typeof c && c(), void 0
            } else I = e + g / b * (a - e)
        }, P)
    }
    ...
    var C = $("#chapters"), D = $(window), E = [], F = 0, G = 27, H = 0, I = 0, J = 0, K = !0, L = 0, M = 0, N = 0,
        O = 1e3, P = 1e3 / 30, Q = null, R = !1, S = 0, T = [], U = 100, V = 250, W = null, X = null, Y = 150;
    return {
        init: a,
        height: g,
        width: h,
        getNextKeyframe: s,
        forceNextKeyframe: A,
        forcePreviousKeyframe: B,
        populateSections: m,
        jumpToChapter: x,
        getCurrentChapterIndex: i,
        scrollToValue: z,
        isJumpingToChapter: y
    }
}();
var ib = ib || {};
ib.Scrollbar = function () {
    function a() {
        k.on("mousedown", c), $(ib).on(ib.Events.SCROLLER_DID_SCROLL, i), m.on("resize", b), b()
    }

    function b() {
        j.css("height", m.height() - 5), o = j.height(), p = j.position().top, q = k.outerHeight(!0), i(null, {progress: t})
    }

    function c(a) {
        s = a.offsetY, "undefined" == typeof s && (s = a.pageY - $(a.target).offset().top), n = a.clientY - 5 - s, l.on("mousemove", f).on("mouseup", g), d(), a.preventDefault()
    }
    ...
    function g() {
        l.off("mousemove", f).off("mouseup", g), $(ib).on(ib.Events.SCROLLER_DID_SCROLL, i), e()
    }

    function h() {
        r = requestAnimationFrame(h);
        var a = n / (o - q);
        $(ib).trigger(ib.Events.SCROLLBAR_DID_SCROLL, {progress: a})
    }

    function i(a, b) {
        var c = b.progress * (o - q);
        k.css("top", c + "px"), t = b.progress
    }

    var j = $("#scrollbar"), k = $("> div", j), l = $(document), m = $(window), n = 0, o = 0, p = 0, q = 0, r = "",
        s = 0, t = 0;
    return {init: a}
}();
var ib = ib || {};
ib.SoundController = function () {
    function a(a) {
        (ib.Config.MUTE_AUDIO || ib.Config.MUTE_AMBIENT_AUDIO) && j[a].setVolume(0), j[a].looping = !0, c(a)
    }
    ...
    function d(a, b) {
        j[a] && (ib.Config.MUTE_AUDIO && j[a].setVolume(0), "undefined" == typeof b ? j[a].play() : j[a].play({
            from: 0,
            to: b
        }))
    }
    ...
    function g(a) {
        n = !1, clearTimeout(m), ib.Config.MUTE_AUDIO && i.setVolume(0), "undefined" == typeof a || ib.Config.DISABLE_AUDIO || (m = setTimeout(function () {
            n || (soundManager.mute(k), i.play({
                from: a.startValue - .01, to: a.endValue, whileplaying: function () {
                    var b = this.position / this.duration;
                    this.muted && this.position >= a.startValue + .01 && soundManager.unmute(k), $(ib).trigger(ib.Events.VO_PROGRESS_UPDATE, {progress: b})
                }, onplay: function () {
                    $(ib).trigger(ib.Events.VO_PLAY)
                }, onstop: function () {
                    $(ib).trigger(ib.Events.VO_STOP)
                }
            }))
        }, a.delay || 0))
    }
    ...
    var i = null, j = {}, k = "scratch-vo", l = "wd-ctos_all_music-ambient-loop-01", m = null, n = !1;
    return soundManager.defaultOptions = {autoLoad: !0}, soundManager.audioFormats = {
        mp3: {
            type: ['audio/mpeg; codecs="mp3"', "audio/mpeg", "audio/mp3", "audio/MPA", "audio/mpa-robust"],
            required: !1
        }, ogg: {type: ["audio/ogg; codecs=vorbis"], required: !1}
    }, soundManager.setup({
        url: "/swf/", preferFlash: ib.isIE ? !0 : !1, debugMode: !1, onready: function () {
            i = soundManager.createSound({
                id: k,
                url: [{type: "audio/mp3", url: ib.Config.assetBasePath + "/audio/vo.mp3"}, {
                    type: "audio/ogg",
                    url: ib.Config.assetBasePath + "/audio/vo.ogg"
                }]
            });
            for (var b in ib.sfx) j[ib.sfx[b]] = soundManager.createSound({
                id: ib.sfx[b],
                autoLoad: !0,
                url: [{
                    type: "audio/mp3",
                    url: ib.Config.assetBasePath + "/audio/" + ib.sfx[b] + ".mp3"
                }, {type: "audio/ogg", url: ib.Config.assetBasePath + "/audio/" + ib.sfx[b] + ".ogg"}],
                onload: function () {
                    ib.sfx[b] == l && a(l)
                }
            })
        }, ontimeout: function (a) {
            console.log("sound manager timed out.");
            for (var b in a) console.log(b, a[b])
        }
    }), {startLoop: a, stopLoop: b, playAudio: g, stop: h, getVo: f, playSfx: d, stopSfx: e}
}();
var ib = ib || {};
ib.StoryController = function () {
    function a() {
    }
    ...
    function e(a, c, d) {
        ib.ScrollController.isJumpingToChapter() || b() || (j = setTimeout(g, l), clearTimeout(k), k = setTimeout(h, 2 * l), i = !0, $(ib).trigger(ib.Events.STORY_SCROLL_DID_BEGIN), ib.ScrollController.scrollToValue(a.scrollValue, c, function () {
            if ("function" == typeof d && d(), a.continueOnComplete) {
                var b = ib.ScrollController.getNextKeyframe();
                e(b, b.duration)
            } else ib.StoryController.resignControl()
        }), ib.SoundController.stop(), ib.VideoController.stop(), c > 200 && (ib.SoundController.playAudio(a.audio), ib.VideoController.play(a.video)))
    }

    function f() {
        i = !1, $(ib).trigger(ib.Events.STORY_SCROLL_DID_END)
    }
    ...
    var i = !1, j = null, k = null, l = 400;
    return {init: a, hasControl: c, onCooldown: b, justBegan: d, resignControl: f, triggerKeyframe: e}
}();
var ib = ib || {};
ib.SurveyController = function (a, b) {
    this.$context = a, this.$questionNav = $(".question-numbers", a), this.$wrap = $(".q-and-a", a), this.$ask = $(".ask", this.$wrap), this.$question = $(".question", this.$wrap), this.$confirm = $(".confirm", this.$wrap), this.$answerHeadline = $(".headline", this.$wrap), this.$answerBody = $(".body", this.$wrap), this.$topic = $(".topic", a), this.$ui = $(".question-ui-wrap", a), this.$header = $("#header"), this.uiComponent = null, this.surveyData = [], this.questionIndex = 0, this.opts = $.extend(!0, {}, {
        start: 0,
        end: 1,
        askAnimation: {
...
}, ib.SurveyController.prototype = {
    init: function () {
        $("li", this.$questionNav).on("click", $.proxy(this.onQuestionNavClick, this)).on("mouseenter", $.proxy(this.onQuestionNavOver, this))
    }, updateProgress: function (a) {
        a >= this.opts.start && a <= this.opts.end && !this.active ? (this.active = !0, this.setQuestion(this.questionIndex)) : this.active && (a < this.opts.start || a > this.opts.end) && (this.active = !1, this.unsetQuestion())
    }, setQuestion: function (a) {
        a = Math.max(0, a), a = Math.min(this.opts.surveyData.length - 1, a), this.questionIndex = a, this.unsetQuestion(), $(".question-" + a, this.$questionNav).addClass("active");
        var b = this.opts.surveyData[this.questionIndex];
        this.$topic.html(b.topic), this.$ask.html(b.ask), this.$question.html(b.question), this.$confirm.html(b.answer.confirm), this.$answerHeadline.html(b.answer.headline), this.$answerBody.html(b.answer.body);
        var c = ib.ComponentLoader.registeredClasses[b.ui.component], d = $(ib.Templates[c.template](b.ui.opts));
        if (this.uiComponent = new c(d, b.ui.opts), this.$ui.append(d), this.uiComponent.init(), a == this.opts.surveyData.length - 1 ? setTimeout(function () {
            ib.SoundController.playSfx("wd-ctos_all_text", 12 * b.question.length)
        }, 200) : ib.SoundController.playSfx("wd-ctos_all_text", 20 * b.question.length), "&nbsp;" !== b.ask) {
            var e = new ib.Oomph(this.$ask, this.opts.askAnimation);
            e.init(), e.animate()
        }
        var f = new ib.Oomph(this.$question, this.opts.questionAnimation);
        f.init(), f.animate();
        var g = new ib.Oomph(this.$confirm, this.opts.confirmAnimation);
        g.init();
        var h = new ib.Oomph(this.$answerHeadline, this.opts.answerHeadlineAnimation);
        h.init();
        var i = new ib.Oomph(this.$answerBody, this.opts.answerAnimation);
        i.init(), this.uiComponent.$context.on(ib.Events.QUESTION_ANSWERED, $.proxy(this.onQuestionAnswered, this, g, h, i)), this.uiComponent.$context.on(ib.Events.NEXT_QUESTION_REQUESTED, $.proxy(this.showNextQuestion, this))
    }, unsetQuestion: function () {
        this.$context.removeClass("ended"), this.$context.addClass("dark"), this.$header.addClass("light"), $(".active", this.$questionNav).removeClass("active"), this.$topic.html("&nbsp;"), this.$ask.empty(), this.$question.empty(), this.$confirm.empty(), this.$answerHeadline.empty(), this.$answerBody.empty(), this.uiComponent = null, this.$ui.empty()
    }, onQuestionNavClick: function (a) {
        this.setQuestion($(a.currentTarget).index())
    }, onQuestionNavOver: function () {
        ib.SoundController.playSfx("wd-ctos_imagine_braile-button-rollover-01")
    }, onQuestionAnswered: function () {
        for (var a in arguments) {
            var b = arguments[a];
            "animate" in b && (b.animate(), ib.SoundController.playSfx("wd-ctos_all_text", Math.max(1100, 20 * this.opts.surveyData[this.questionIndex].answer.headline.length)))
        }
        this.$context.removeClass("dark"), this.$header.removeClass("light")
    }, showNextQuestion: function () {
        if (this.questionIndex == this.opts.surveyData.length - 1) {
            ib.ScrollController.forceNextKeyframe();
            var a = this;
            setTimeout(function () {
                a.$header.addClass("light"), a.$context.addClass("dark"), a.$context.addClass("ended")
            }, 500)
        } else this.setQuestion(this.questionIndex + 1)
    }
}, ib.ComponentLoader.register("ib.SurveyController", ib.SurveyController);
var ib = ib || {};
ib.VideoController = function () {
    ...
    function b() {
        var a, b, c, d, e = 16 / 9, f = ib.ScrollController.height(), g = ib.ScrollController.width(), i = g / f;
        i > e ? (a = g, b = a / e) : (b = f, a = b * e), c = Math.round((a - g) / 2), d = Math.round((b - f) / 2);
        var j = {
            "margin-left": Math.min(0, -c),
            "margin-top": Math.min(0, -d),
            height: Math.round(b),
            width: Math.round(a)
        };
        h.css(j), $(ib).trigger(ib.Events.BG_VIDEO_DID_RESIZE, {css: j});
        var k = $(".city-highlights-wrap");
        k.length && k.css(j)
    }

    function c() {
        k.on("canplaythrough", function () {
            l = !0
        }), k.on("ended", d), b(), $(ib).on(ib.Events.PAGE_DID_BECOME_VISIBLE, b), $(window).on("resize", $.throttle(1e3, b))
    }
    ...
    function e(a) {
        return "undefined" == typeof a ? (j && j.setCurrentTime(0), void 0) : ((l || !Modernizr.video) && (clearTimeout(n), n = setTimeout(function () {
            b(), o = a.endValue / 1e3, j.setCurrentTime(a.startValue / 1e3), j.play(), clearInterval(m), m = setInterval(g, 10)
        }, a.delay || 0)), void 0)
    }

    function f() {
        clearTimeout(n), j && j.pause()
    }

    function g() {
        k[0].currentTime >= o && (clearInterval(m), f())
    }

    var h = $("#city-video"), i = $("video", h), j = null, k = null, l = !1, m = null, n = null, o = null;
    return {init: a, stop: f, play: e}
}();
var ib = ib || {};
ib.AnimationComponentExample = function (a, b) {
    this.$context = a, this.progress = null, this.opts = $.extend({start: 0, end: 1}, b || a.data())
}, ib.AnimationComponentExample.prototype = {
    init: function () {
        console.log("component AnimationComponentExample initialized")
    }, updateProgress: function (a) {
        var b = this.opts.end - this.opts.start, c = Math.max(0, Math.min(b, a - this.opts.start)), d = c / b;
        d != this.progress && (this.progress = d, this.updateAnimation())
    }, updateAnimation: function () {
    }
}, ib.ComponentLoader.register("ib.AnimationComponentExample", ib.AnimationComponentExample);
var ib = ib || {};
ib.AudioControls = function (a, b) {
    this.$context = a, this.$progressBar = $(".story-progress-bar"), this.soundProgress = 0, this.soundDuration = 0, this.soundStartTime = 0, this.soundStartMs = 0, this.soundUpdateInterval = 0, this.opts = $.extend({}, b || a.data())
}, ib.AudioControls.prototype = {
    init: function () {
        $(ib).on(ib.Events.VO_PLAY, $.proxy(this.onVoPlay, this)), $(ib).on(ib.Events.VO_STOP, $.proxy(this.onVoStop, this))
    }, onVoPlay: function () {
        this.soundStartMs = (new Date).getTime(), this.soundUpdateInterval = setInterval($.proxy(this.onVoProgress, this), 10), this.soundStartTime = ib.SoundController.getVo().position, this.soundDuration = ib.SoundController.getVo().duration
    }, onVoStop: function () {
        clearInterval(this.soundUpdateInterval), TweenMax.set(this.$context, {width: 0})
    }, onVoProgress: function () {
        var a = ib.VoData;
        if (null !== ib.SoundController.getVo()) {
            var b = (new Date).getTime();
            b -= this.soundStartMs, b += this.soundStartTime;
            var c = b / ib.SoundController.getVo().duration, d = Math.round(a.length * c);
            if ("undefined" != typeof a[d]) {
                var e = a[d].l;
                .1 > e && (e = 0), TweenMax.set(this.$context, {width: e * this.$progressBar.width()})
            }
        }
    }
}, ib.ComponentLoader.register("ib.AudioControls", ib.AudioControls);
var ib = ib || {};
ib.BlockReveal = function (a, b) {
    this.$context = a, this.$content = $(".content", a), this.progress = null, this.resetTimeout = null, this.$parentChapter = a.parents(".chapter"), this.complete = !1, this.animating = null, this.opts = $.extend({
        start: 0,
        end: .999,
        resetWaitTime: 2e3,
        width: "100%",
...
}, ib.BlockReveal.prototype = {
    init: function () {
    }, updateProgress: function (a) {
        a >= this.opts.start && a < this.opts.end ? this.complete || this.animating || !this.$parentChapter.hasClass("active-chapter") || (clearTimeout(this.resetTimeout), this.startAnimation()) : (clearTimeout(this.resetTimeout), this.resetTimeout = setTimeout($.proxy(this.reset, this), this.opts.resetWaitTime))
    }, startAnimation: function () {
        this.animating = !0, this.$content.delay(this.opts.delay).animate({width: this.opts.width}, {
            duration: this.opts.duration,
            easing: this.opts.easing,
            complete: $.proxy(this.onComplete, this)
        })
    }, onComplete: function () {
        this.complete = !0, this.animating = !1
    }, reset: function () {
        this.$content.width(0), this.complete = !1, this.animating = !1, clearTimeout(this.resetTimeout), this.resetTimeout = null
    }
}, ib.ComponentLoader.register("ib.BlockReveal", ib.BlockReveal);
var ib = ib || {};
ib.BuildingMarkers = function (a, b) {
    this.$context = a, this.$parentChapter = a.parents(".chapter"), this.$markers = $("ul", this.$context), this.active = !1, this.raf = null, this.driverProgress = 0, this.$canvas = $("canvas", this.$context), this.canvas = null, this.ctx = null, this.opts = $.extend({
        start: 0,
        end: .999,
        markers: [],
        markerDuration: 400,
        lineDuration: 1e3,
        dotRadius: 5,
        dotRadiusDuration: 400
    }, b || a.data())
}, ib.BuildingMarkers.prototype = {
    init: function () {
        this.setupMarkers(), Modernizr.canvas && (this.canvas = this.$canvas[0], this.ctx = this.canvas.getContext("2d"), $(ib).on(ib.Events.BG_VIDEO_DID_RESIZE, $.proxy(this.resize, this)))
    }, resize: function (a, b) {
        this.$context.css(b.css), this.canvas.width = b.css.width, this.canvas.height = b.css.height
    }, setupMarkers: function () {
        for (var a in this.opts.markers) {
            var b = this.opts.markers[a], c = ib.Templates["building-marker.html"](b);
            b.$el = $(c), this.$markers.append(b.$el), "undefined" !== b.lineFromIndex && (b.from = this.opts.markers[b.lineFromIndex]), b.progress = 0, b.radius = null
        }
    }, updateProgress: function (a) {
        this.driverProgress = a, !this.active && a >= this.opts.start && a < this.opts.end ? this.show() : this.active && (a < this.opts.start || a >= this.opts.end) && this.hide()
    }, show: function () {
        this.active = !0;
        var a = this;
        a.$context.show(), this.startAnimation()
    }, hide: function () {
        this.active = !1;
        var a = this;
        this.stopAnimation(), this.$context.fadeOut(600, "easeOutCubic", function () {
            for (var b in a.opts.markers) {
                var c = a.opts.markers[b];
                c.active = !1, c.progress = 0, c.radius = null, c.$el.css({opacity: 0})
            }
        })
    }, startAnimation: function () {
        cancelAnimationFrame(this.raf), this.raf = requestAnimationFrame($.proxy(this.draw, this))
    }, stopAnimation: function () {
        cancelAnimationFrame(this.raf)
    }, clear: function () {
        this.canvas.height = this.$canvas.height(), this.canvas.width = this.$canvas.width(), this.ctx.clearRect(0, 0, this.canvas.width, this.canvas.height)
    }, draw: function () {
        this.raf = requestAnimationFrame($.proxy(this.draw, this)), this.updateMarkerProgress(), this.clear(), this.ctx.lineWidth = 1, this.ctx.strokeStyle = "#fff";
        var a = null;
        for (var b in this.opts.markers) a = this.opts.markers[b], this.drawMarker(a);
        this.ctx.stroke(), this.ctx.beginPath(), this.ctx.fillStyle = "#fff";
        for (var c in this.opts.markers) a = this.opts.markers[c], this.drawMarkerDot(a);
        this.ctx.fill()
    }, drawMarker: function (a) {
        if (a.active) {
            var b = this.$context.width() * a.from.left / 100, c = this.$context.height() * a.from.top / 100,
                d = this.$context.width() * a.left / 100, e = this.$context.height() * a.top / 100,
                f = b + a.progress * (d - b), g = c + a.progress * (e - c);
            this.ctx.moveTo(b, c), this.ctx.lineTo(f, g)
        }
    }, drawMarkerDot: function (a) {
        if (a.active && !(a.progress < .95)) {
            null === a.radius && (a.radius = .1, TweenMax.to(a, this.opts.dotRadiusDuration / 1e3, {
                radius: this.opts.dotRadius,
                ease: Quart.easeOut
            }));
            var b = this.canvas.width * a.left / 100, c = this.canvas.height * a.top / 100;
            this.ctx.moveTo(b, c), this.ctx.arc(b, c, a.radius, 0, 2 * Math.PI, !1)
        }
    }, updateMarkerProgress: function () {
        for (var a in this.opts.markers) {
            var b = this.opts.markers[a];
            !b.active && b.start <= this.driverProgress && (b.active = !0, TweenMax.to(b.$el, this.opts.markerDuration / 1e3, {
                alpha: 1,
                delay: .6 * this.opts.lineDuration / 1e3
            }), TweenMax.to(b, this.opts.lineDuration / 1e3, {
                progress: 1,
                ease: Quart.easeOut
            }), 0 != a && ib.SoundController.playSfx("wd-ctos_discover_circle-connecting-lines-draw-in-01"), setTimeout(function () {
                ib.SoundController.playSfx("wd-ctos_discover_circle-highlight-dot-appears-01")
            }, .6 * this.opts.lineDuration))
        }
    }
}, ib.ComponentLoader.register("ib.BuildingMarkers", ib.BuildingMarkers);
var ib = ib || {};
ib.CCTV = function (a, b) {
    this.$context = a, this.$parentChapter = a.parents(".chapter"), this.$canvas = null, this.driverProgress = 0, this.canvas = null, this.ctx = null, this.raf = null, this.active = !1, this.findNearestDot = null, this.cams = [], this.opts = $.extend({
        lineDuration: 450,
        borderDuration: 650,
        imageDuration: 600,
        easing: "easeOutCubic",
        rolloverSfxId: "wd-ctos_believe_photo-rollover-01",
        rotateInSfxId: "wd-ctos_believe_photo-rotates-in-01",
        rotateOutSfxId: "wd-ctos_believe_photo-rotates-out-01",
        cams: []
    }, b || a.data())
}, ib.CCTV.prototype = {
    init: function (a, b) {
        this.findNearestDot = b, this.$canvas = a, this.canvas = a[0], this.ctx = this.canvas.getContext("2d"), this.setupCams(), $(window).on("resize", $.throttle(1e3, $.proxy(this.resize, this))), this.resize()
    }, initWithoutCanvas: function () {
        this.setupCams()
    }, setupCams: function () {
        this.cams = this.opts.cams;
        for (var a in this.cams) {
            var b = this.cams[a];
            b.$el = $(b.target, this.$context), b.$el.css({
                left: 100 * b.x + "%",
                top: 100 * b.y + "%",
                height: b.height + "px",
                width: b.width + "px"
            ...
            var c = this;
            if (b.$el.on("mouseenter", function () {
                ib.SoundController.playSfx(c.opts.rolloverSfxId)
            }), Modernizr.csstransforms3d) {
                var d = b.x < .5 ? -45 : 45;
                TweenMax.set($(b.$el[0]).parent(), {css: {perspective: 500}}), TweenMax.set(b.$el[0], {
                    rotationY: d,
                    alpha: 0,
                    transformOrigin: "100px 100px"
                })
            } else TweenMax.to(b.$el[0], 0, {alpha: 0});
            b.src ? b.$img = $("img", b.$el) : b.video && (b.$video = $(".cctv-video", b.$el), b.$video.mediaelementplayer({
                enableKeyboard: !1,
                loop: !0,
                pauseOtherPlayers: !1,
                videoWidth: b.width,
                ...
                success: function (a, c, d) {
                    b.player = d, b.mediaElement = $(a)
                }
            }))
        }
    }, resize: function () {
        if (null === this.canvas) return this.updateProgress(this.driverProgress), void 0;
        if (this.canvas.width = this.$canvas.width(), this.canvas.height = this.$canvas.height(), this.stop(), this.clear(), this.resetLines(), this.active && null === this.raf) {
            var a = this;
            setTimeout(function () {
                for (var b in a.cams) {
                    var c = a.cams[b];
                    c.ball = "undefined" != typeof c.markerIndex ? a.requestDotNearPoint(c.markerIndex) : a.requestDotNearPoint({
                        x: c.startLineX * a.canvas.width,
                        y: c.startLineY * a.canvas.height
                    })
                }
                a.start(), a.updateProgress(a.driverProgress)
            }, 0)
        }
    }, requestDotNearPoint: function (a) {
        if ("function" != typeof this.findNearestDot) throw "No dot data source supplied for cctv nearest dot method";
        return this.findNearestDot(a)
    }, updateProgress: function (a) {
        this.driverProgress = a, !this.active && this.opts.start <= a && a < this.opts.end ? this.show() : this.active && (a < this.opts.start || a >= this.opts.end) && this.hide(), this.active && this.updateAnimationProgress(a)
    }, updateAnimationProgress: function (a) {
        for (var b in this.cams) {
            var c = this.cams[b];
            if ("undefined" != typeof c.forcedEnd && c.forcedEnd < a) {
                if (c.imageActive) {
                    ib.SoundController.playSfx(this.opts.rotateOutSfxId), c.imageActive = !1;
                    var d = c.x < .5 ? -45 : 45;
                    Modernizr.csstransforms3d ? TweenMax.to(c.$el[0], .5, {
                        rotationY: d,
                        alpha: 0,
                        transformOrigin: "100px 100px"
                    }) : TweenMax.to(c.$el[0], .5, {alpha: 0})
                }
            } else !c.imageActive && c.imageStart <= a && (this.screenTooSmall(c) || ib.SoundController.playSfx(this.opts.rotateInSfxId), c.video && c.player.play(), c.imageActive = !0, Modernizr.csstransforms3d ? TweenMax.to(c.$el[0], 1, {
                z: 0,
                rotationY: 0,
                alpha: 1,
                transformOrigin: "50% 50%"
            }) : TweenMax.to(c.$el[0], 1, {alpha: 1}));
            "undefined" != typeof c.forcedEnd && c.forcedEnd < a ? (c.lineActive = !1, c.lineProgress = 0) : !c.lineActive && c.borderStart <= a && (c.lineActive = !0, ib.SoundController.playSfx(this.opts.lineSfx), c.ball = "undefined" != typeof c.markerIndex ? this.requestDotNearPoint(c.markerIndex) : this.requestDotNearPoint({
                x: c.startLineX * this.canvas.width,
                y: c.startLineY * this.canvas.height
            }), c.ball.connected = !0, TweenLite.to(c, this.opts.lineDuration / 1e3, {lineProgress: 1}), TweenLite.to(c, this.opts.borderDuration / 1e3, {
                borderProgress: 1,
                delay: this.opts.lineDuration / 1e3
            }))
        }
    }, clear: function () {
        null !== this.canvas && (this.ctx.beginPath(), this.canvas.width = this.$canvas.width(), this.canvas.height = this.$canvas.height(), this.ctx.clearRect(0, 0, this.canvas.width, this.canvas.height), this.ctx.closePath())
    }, stop: function () {
        cancelAnimationFrame(this.raf), this.raf = null
    }, resetLines: function () {
        for (var a in this.cams) {
            var b = this.cams[a];
            b.lineProgress = 0, b.borderProgress = 0, b.lineActive = !1, b.imageActive = !1
        }
    }, start: function () {
        null !== this.canvas && (this.raf = requestAnimationFrame($.proxy(this.step, this)))
    }, step: function () {
        this.raf = requestAnimationFrame($.proxy(this.step, this)), this.clear(), this.ctx.strokeStyle = "#32c8f4", this.ctx.lineWidth = 1;
        var a = this.$context.width(), b = this.$context.height(), c = 0, d = 0, e = 0, f = 0, g = 0, h = 0, i = 0,
            j = 0;
        for (var k in this.cams) {
            var l = this.cams[k];
            if (c = l.x * a, d = l.y * b, l.lineActive && !this.screenTooSmall(l) && l.$el.is(":visible")) {
                e = l.ball.x, f = l.ball.y, g = c + l.borderSteps[0].x * l.width, h = d + l.borderSteps[0].y * l.height - 1, i = e + l.lineProgress * (g - e), j = f + l.lineProgress * (h - f), this.ctx.moveTo(e, f), this.ctx.lineTo(i, j), this.ctx.moveTo(g, h);
                for (var m, n, o = 0, p = 0, q = 1 / (l.borderSteps.length - 1), r = 1, s = l.borderSteps.length; s > r && (m = l.borderSteps[r - 1], n = l.borderSteps[r], p = Math.min(q, l.borderProgress - (r - 1) * q), o = p / q, !(0 >= o)); r++) i = c + m.x * l.width + o * (n.x * l.width - m.x * l.width), j = d + m.y * l.height + o * (n.y * l.height - m.y * l.height), this.ctx.lineTo(i, j)
            }
        }
        this.ctx.stroke()
    }, show: function () {
        this.$context.add(this.$canvas).show(), this.active = !0;
        for (var a in this.cams) this.cams[a].src ? this.cams[a].$img.attr("src", this.cams[a].src) : this.cams[a].video;
        var b = this;
        setTimeout(function () {
            b.resize(), b.start()
        }, 0)
    }, hide: function () {
        this.active = !1, this.stop(), this.clear();
        var a = this;
        this.$context.add(this.$canvas).fadeOut(1e3, this.opts.easing, function () {
            for (var b in a.cams) {
                var c = a.cams[b];
                a.cams[b].src && c.$img.attr("src", "data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7"), c.video && c.player && c.player.pause();
                var d = c.x < .5 ? -90 : 90;
                Modernizr.csstransforms3d ? TweenMax.to(c.$el[0], 0, {
                    rotationY: d,
                    z: 100,
                    alpha: 0
                }) : TweenMax.to(c.$el[0], 0, {alpha: 0})
            }
            a.resetLines()
        })
    }, screenTooSmall: function (a) {
        return a.$el.hasClass("large-only") && ib.ScrollController.width() < 1280
    }
}, ib.ComponentLoader.register("ib.CCTV", ib.CCTV);
var ib = ib || {};
ib.CCTVImageLauncher = function (a, b) {
    this.$context = a, this.$parentChapter = a.parents(".chapter"), this.$markers = $("ul", this.$context), this.active = !1, this.raf = null, this.driverProgress = 0, this.cctv = null, this.opts = $.extend({
        start: 0,
        end: .999,
        cctvContextTarget: null,
        CCTVOpts: {}
    }, b || a.data())
}, ib.CCTVImageLauncher.prototype = {
    init: function () {
        this.setupCCTV()
    }, setupCCTV: function () {
        var a = $(this.opts.cctvContextTarget, this.$parentChapter);
        this.cctv = new ib.CCTV(a, this.opts.CCTVOpts), this.cctv.initWithoutCanvas()
    }, updateProgress: function (a) {
        this.driverProgress = a, !this.active && a >= this.opts.start && a < this.opts.end ? this.show() : this.active && (a < this.opts.start || a >= this.opts.end) && this.hide(), this.cctv && this.cctv.updateProgress(a)
    }, show: function () {
        this.active = !0;
        var a = this;
        a.$context.show()
    }, hide: function () {
        this.active = !1, this.$context.fadeOut(600, "easeOutCubic", function () {
        })
    }
}, ib.ComponentLoader.register("ib.CCTVImageLauncher", ib.CCTVImageLauncher);
var ib = ib || {};
ib.Chapter = function (a, b) {
    this.$context = a, this.$mask = $("> .mask", a), this.$content = $("> .scroll-content", this.$mask), this.animationElements = [], this.imageSequence = null, this.headerComponent = null, this.components = [], this.story = null, this.progress = 0, this.totalScrollValue = 0, this.opts = $.extend({}, b || a.data())
}, ib.Chapter.prototype = {
    init: function () {
        this.story = ib.ChapterData[this.id], this.totalScrollValue = this.story.totalScrollValue, this.titleScrollValue = this.story.titleScrollValue, this.story.headerControlSteps && (this.headerComponent = ib.ComponentLoader.findInstanceById("header")), this.$context.on("click", ".chapter-jump-link", $.proxy(this.onAutomatedScrollClick, this))
    }, setContent: function () {
        this.clearContent();
        var a = this.story.getText();
        a.assetBasePath = ib.Config.assetBasePath, a = $.extend({Modernizr: Modernizr}, a);
        var b = ib.Templates[this.id + ".html"](a);
        this.$content.html(b), Modernizr.backgroundsize || ($(".force-full-size", this.$context).css({
            height: ib.ScrollController.height(),
            width: ib.ScrollController.width()
        }), ib.Resizer.createFallbackMarkup(this.$context)), this.initContent(), this.update()
    }, clearContent: function () {
        this.$content.empty(), this.animationElements = [], this.imageSequence = null
    }, initContent: function () {
        this.cacheAnimationElements(), this.cacheImageSequence(), this.cacheComponents()
    }, cacheAnimationElements: function () {
        var a;
        for (var b in this.story.animationElements) {
            a = $.extend(!0, {}, this.story.animationElements[b]);
            var c = $(a.target, this.$context);
            c.length ? (a.$el = c, this.animationElements.push(a)) : console.log('Animation element not found: "' + a.target + '"\nfrom: "' + this.id + '"')
        }
    }, cacheImageSequence: function () {
        this.story.imageSequence && (this.imageSequence = $.extend(!0, {}, this.story.imageSequence), this.imageSequence.$el = $(this.story.imageSequence.target, this.$context), Modernizr.canvas && ib.StoryImageSequenceHandler.registerCanvasVideo(this.imageSequence.$el))
    }, cacheComponents: function () {
        ib.ComponentLoader.init(this.$context);
        var a = this;
        $(".ib-component", this.$context).each(function () {
            var b = ib.ComponentLoader.findInstanceById($(this).data("id"));
            b && a.components.push(b)
        });
        for (var b in this.story.animationComponents) {
            var c = this.story.animationComponents[b], d = $(c.target, this.$context),
                e = ib.ComponentLoader.registeredClasses[c.componentClass];
            if (d.length && e) {
                var f = new e(d, c.opts);
                f.init(), this.components.push(f)
            } else console.log('Animation component not found: "' + c.target + '"\nfrom: "' + this.id + '"')
        }
    }, setProgress: function (a, b) {
        a != this.progress ? (this.progress = a, this.update()) : b && this.update()
    }, update: function () {
        for (var a in this.animationElements) ib.StoryAnimationHandler.updateElements(this.animationElements[a], this.progress);
        this.imageSequence && ib.StoryImageSequenceHandler.updateSequence(this.imageSequence, this.progress);
        for (var b in this.components) this.components[b].updateProgress(this.progress);
        this.story.headerControlSteps && this.headerComponent.update(this.story.headerControlSteps, this.progress), this.story.sfxTriggers && this.updateSfxTriggers()
    }, onAutomatedScrollClick: function (a) {
        var b = $(a.currentTarget).data("destination-index"), c = $(a.currentTarget).data("animated");
        ib.ScrollController.jumpToChapter(b, c)
    }, updateSfxTriggers: function () {
        for (var a in this.story.sfxTriggers) {
            var b = this.story.sfxTriggers[a];
            !b.played && b.start < this.progress && this.progress - b.start > .04 ? b.played = !0 : !b.played && b.start < this.progress ? (b.played = !0, b.duration ? ib.SoundController.playSfx(b.sfxId, b.duration) : ib.SoundController.playSfx(b.sfxId)) : b.start > this.progress && (b.played = !1)
        }
    }
}, ib.ComponentLoader.register("ib.Chapter", ib.Chapter);
var ib = ib || {};
ib.Geom = ib.Geom || {}, ib.Geom.ConnectionPoint = function () {
    this.xpos = 0, this.ypos = 0, this.zpos = 0, this.x = 0, this.y = 0, this.scaleX = 1, this.scaleY = 1, this.angleY = 0, this.angleX = 0
}, ib.ChicagoBuildingMarkers = function (a, b) {
    this.$context = a, this.$parentChapter = a.parents(".chapter"), this.$markers = $(".building-markers", this.$context), this.$outline = $(".chicago-outline", this.$context), this.$translateToSuperReference = null, this.active = !1, this.raf = null, this.driverProgress = 0, this.rotationDestination = 0, this.zoomed = !0, this.translated = !1, this.superOffsetX = 0, this.superOffsetY = 0, this.fl = 200, this.vpX = 0, this.vpY = 0, this.angleY = 0, this.addedZ = 0, this.$canvas = $(".building-marker-canvas", this.$context), this.canvas = null, this.ctx = null, this.markers = [], this.cctv = null, this.opts = $.extend({
        start: 0,
        end: .999,
        rotationStart: .33,
        rotationDuration: 2e3,
...
}, ib.ChicagoBuildingMarkers.prototype = {
    init: function () {
        Modernizr.canvas && (this.canvas = this.$canvas[0], this.ctx = this.canvas.getContext("2d"), $(ib).on(ib.Events.BG_VIDEO_DID_RESIZE, $.proxy(this.resize, this))), this.$translateToSuperReference = $(this.opts.translateToSuperTarget)
    }, setupCCTV: function () {
        var a = $(".cctv", this.$context);
        this.cctv = new ib.CCTV(a, this.opts.CCTVOpts);
        var b = $(this.opts.cctvCanvasTarget, this.$context);
        this.cctv.init(b, $.proxy(this.pointForIndex, this))
    }, pointForIndex: function (a) {
        return this.markers[a].point
    }, resize: function () {
        this.canvas.width = this.$context.width(), this.canvas.height = this.$context.height(), this.vpX = this.$context.width() / 2, this.vpY = this.$context.height() / 2, this.markers.length || (this.setupMarkers(), this.setupCCTV())
    }, setupMarkers: function () {
        for (var a in this.opts.markers) {
            var b = this.opts.markers[a], c = ib.Templates["building-marker.html"]();
            b.$el = $(c), this.$markers.append(b.$el), b.progress = 0, b.radius = null, b.point = new ib.Geom.ConnectionPoint, b.point.xpos = b.xpos, b.point.ypos = b.ypos, b.point.zpos = b.zpos, this.doPerspective(b), b.$el.css({
                top: b.point.x + "px",
                left: b.point.y + "px"
            }), this.markers.push(b), "undefined" !== b.lineFromIndex && (b.from = this.markers[b.lineFromIndex])
        }
    }, updateProgress: function (a) {
        this.driverProgress = a, !this.active && a >= this.opts.start && a < this.opts.end ? this.show() : this.active && (a < this.opts.start || a >= this.opts.end) && this.hide(), this.cctv && this.cctv.updateProgress(a)
    }, show: function () {
        ...
        this.raf = requestAnimationFrame($.proxy(this.draw, this)), this.updateMarkerProgress(), this.clear(), this.doPerspective(this.markers[0].point);
        var a = this.$translateToSuperReference.offset().left, b = this.$translateToSuperReference.offset().top;
        this.superOffsetX = a - this.markers[0].point.x, this.superOffsetY = b - this.markers[0].point.y - this.$outline.height() / 2;
        for (var c in this.markers) this.doPerspective(this.markers[c].point), this.translated && this.translatePoint(this.markers[c].point);
        TweenMax.set(this.$outline, {
            x: this.translationProgress * this.superOffsetX,
            y: this.translationProgress * this.superOffsetY
        }), this.ctx.lineWidth = 1, this.ctx.strokeStyle = "#fff";
        for (var d in this.markers) this.drawMarker(this.markers[d]);
        this.ctx.stroke(), this.ctx.beginPath(), this.ctx.fillStyle = "#fff";
        for (var e in this.markers) this.drawMarkerDot(this.markers[e]);
        this.ctx.fill()
    }, translatePoint: function (a) {
        a.x += this.translationProgress * this.superOffsetX, a.y += this.translationProgress * this.superOffsetY
    }, drawMarker: function (a) {
        if (a.active) {
            var b = a.from.point.x, c = a.from.point.y, d = a.point.x, e = a.point.y, f = b + a.progress * (d - b),
                g = c + a.progress * (e - c);
            a.$el.css({left: d + "px", top: e + "px"}), this.ctx.moveTo(b, c), this.ctx.lineTo(f, g)
        }
    }, drawMarkerDot: function (a) {
        if (a.active && !(a.progress < .95)) {
            null === a.radius && (a.radius = .1, TweenMax.to(a, this.opts.dotRadiusDuration / 1e3, {
                radius: this.opts.dotRadius,
                ease: Quart.easeOut
            })), this.ctx.moveTo(a.point.x, a.point.y);
            var b = Math.max(4, Math.min(1, .9 * a.point.scaleX) * a.radius);
            this.ctx.arc(a.point.x, a.point.y, b, 0, 2 * Math.PI, !1)
        }
    }, updateMarkerProgress: function () {
        for (var a in this.markers) {
            ...
            !b.active && b.start <= this.driverProgress && (b.active = !0, TweenMax.to(b.$el, this.opts.markerDuration / 1e3, {
                ...
                progress: 1,
                ease: Quart.easeOut
            }), 0 == a && ib.SoundController.playSfx("wd-ctos_discover_vast-network-dots-grow-in-01"))
        }
        !this.zoomed && this.driverProgress > this.opts.zoomOutStart ? this.beginZoomOut() : this.zoomed && this.driverProgress <= this.opts.zoomOutStart && this.resetDots(), this.rotationDestination != this.opts.rotatedAngle && this.driverProgress > this.opts.rotationStart && this.beginRotation(), !this.translated && this.driverProgress > this.opts.translateToSuperStart && this.translateToSuper()
    }, beginZoomOut: function () {
        this.zoomed = !0;
        var a = this, b = this.addedZ;
        TweenMax.to(this, this.opts.zoomOutDuration / 1e3, {
            addedZ: this.opts.zoomValue, onUpdate: function () {
                for (var c in a.markers) {
                    var d = a.markers[c].point;
                    d.zpos += a.addedZ - b
                }
                b = a.addedZ
            }
        }), TweenMax.to($("li", this.$markers), this.opts.markerDuration / 1e3, {alpha: 0, delay: .5})
    }, resetDots: function () {
        this.zoomed = !1, this.translated = !1, this.addedZ = 0, this.rotationDestination = this.opts.startAngle, this.angleY = this.rotationDestination;
        for (var a in this.markers) {
            var b = this.markers[a];
            b.point.zpos = b.zpos, b.point.xpos = b.xpos, b.point.ypos = b.ypos, this.doPerspective(b.point), this.rotateY(b.point, this.angleY - b.point.angleY), b.point.angleY = this.angleY, this.translationProgress = 0
        }
        this.$outline.hide()
    }, beginRotation: function () {
        var a = this;
        this.rotationDestination = this.opts.rotatedAngle, TweenMax.to(this, this.opts.rotationDuration / 1e3, {
            angleY: this.opts.rotatedAngle,
            onUpdate: function () {
                for (var b in a.markers) {
                    var c = a.markers[b];
                    a.rotateY(c.point, a.angleY - c.point.angleY), c.point.angleY = a.angleY
                }
            }
        }), this.$outline.delay(.66 * this.opts.rotationDuration).fadeIn(400, "easeOutCubic")
    }, translateToSuper: function () {
        this.translated = !0, TweenMax.to(this, this.opts.translateToSuperDuration / 1e3, {
            translationProgress: 1,
            ease: Quad.easeOut
        })
    }, rotateY: function (a, b) {
        var c = [a.xpos, a.ypos, a.zpos], d = Math.sin(b), e = Math.cos(b), f = [];
        f[0] = [e, 0, d], f[1] = [0, 1, 0], f[2] = [-d, 0, e];
        var g = this.matrixMultiply(c, f);
        a.xpos = g[0], a.ypos = g[1], a.zpos = g[2]
    }, matrixMultiply: function (a, b) {
        var c = [];
        return c[0] = a[0] * b[0][0] + a[1] * b[1][0] + a[2] * b[2][0], c[1] = a[0] * b[0][1] + a[1] * b[1][1] + a[2] * b[2][1], c[2] = a[0] * b[0][2] + a[1] * b[1][2] + a[2] * b[2][2], c
    }, doPerspective: function (a) {
        var b = 1, c = this.fl + a.zpos;
        .1 > c && c >= 0 ? c = .1 : c > -.1 && 0 >= c && (c = -.1), b = this.fl / c, a.scaleX = a.scaleY = b, a.x = this.vpX + a.xpos * b, a.y = this.vpY + a.ypos * b
    }
}, ib.ComponentLoader.register("ib.ChicagoBuildingMarkers", ib.ChicagoBuildingMarkers);
var ib = ib || {};
ib.CityHighlights = function (a, b) {
    this.$context = a, this.$highlights = a.find(".highlight"), this.active = !1, this.activeAnimationDetailsTitle = null, this.activeAnimationDetailsBody = null, this.isOver = !1, this.hoverTimeout = null, this.textAnimationsDetailsTitle = [], this.textAnimationsDetailsBody = [], this.opts = $.extend({
        start: 0,
        startDelay: 0,
        end: .999
    }, b || a.data())
}, ib.CityHighlights.prototype = {
    init: function () {
        this.$context.find(".hotspot").add(this.$context.find(".highlight")).on("mouseenter", $.proxy(this.onHotspot, this)).on("mouseleave", $.proxy(this.onHotspotOff, this)), this.setupTextAnimationsDetailsTitle()
    }, onHotspotOff: function () {
        clearTimeout(this.hoverTimeout);
        var a = this;
        this.hoverTimeout = setTimeout(function () {
            $(a.$highlights, ".active").removeClass("active")
        }, 100)
    }, onHotspot: function (a) {
        clearTimeout(this.hoverTimeout);
        var b = $(a.currentTarget).parent().index(), c = this.$highlights.eq(b);
        c.hasClass("active") || ($(this.$highlights, ".active").removeClass("active"), this.activeAnimationDetailsTitle && this.activeAnimationDetailsTitle.reset(), this.activeAnimationDetailsBody && this.activeAnimationDetailsBody.reset(), c.addClass("active"), this.activeAnimationDetailsTitle = this.textAnimationsDetailsTitle[b], this.activeAnimationDetailsBody = this.textAnimationsDetailsBody[b], this.animateText(this.activeAnimationDetailsTitle, this.activeAnimationDetailsBody), ib.SoundController.playSfx("wd-ctos_discover_security-water-text-rollover-01"))
    }, animateText: function () {
        for (var a in arguments) {
            var b = arguments[a];
            b.reset(), b.animate()
        }
    }, setupTextAnimationsDetailsTitle: function () {
        $.each(this.$context.find(".details h5"), $.proxy(function (a, b) {
            var c = new ib.Oomph($(b), {animationStartDelay: 200, animationDuration: 400, animationDelay: 2});
            c.init(), this.textAnimationsDetailsTitle.push(c)
        }, this)), $.each(this.$context.find(".details p"), $.proxy(function (a, b) {
            var c = new ib.Oomph($(b), {animationStartDelay: 300, animationDuration: 400, animationDelay: 2});
            c.init(), this.textAnimationsDetailsBody.push(c)
        }, this))
    }, updateProgress: function (a) {
        !this.active && this.opts.start <= a && a < this.opts.end ? this.show() : this.active && (this.opts.start > a || a >= this.opts.end) && this.hide()
    }, show: function () {
        this.active = !0, this.$context.delay(this.opts.startDelay).fadeIn(1e3, "easeOutCubic"), $(".city-highlights-indicator").fadeIn(1e3, "easeOutCubic"), ib.SoundController.playSfx("wd-ctos_discover_security-water-text-rollovers-appear-01")
    }, hide: function () {
        ib.SoundController.playSfx("wd-ctos_discover_city-to-dots-transition-01"), this.active = !1;
        var a = this;
        this.$context.stop().fadeOut(450, "easeOutCubic", function () {
            a.activeAnimationDetailsBody && (a.activeAnimationDetailsBody.reset(), a.activeAnimationDetailsBody = null), $(".active", a.$context).removeClass("active")
        }), $(".city-highlights-indicator").fadeOut(450, "easeOutCubic")
    }
}, ib.ComponentLoader.register("ib.CityHighlights", ib.CityHighlights);
var ib = ib || {};
ib.ClassName = function (a, b) {
    this.$context = a, this.opts = $.extend({}, b || a.data())
...
var ib = ib || {};
ib.Dots = function (a, b) {
    this.$context = a, this.$parentChapter = a.parents(".chapter"), this.progress = null, this.complete = !1, this.animating = null, this.dots = [], this.CCTVDotIndex = null, this.CCTVDots = [], this.CCTVInterval = null, this.cctv = null, this.opts = $.extend({
        start: 0,
        end: .999,
        minScale: .75,
        maxScale: 1.45,
    ...
    init: function () {
        for (var a in this.opts.dots) {
            var b = this.opts.dots[a];
            "undefined" == typeof b.left && (b.left = 2 + 96 * Math.random() + "%", b.top = 2 + 96 * Math.random() + "%"), this.addDot(b)
        }
        this.randomizeScales(), Modernizr.canvas && this.opts.canvasTarget && this.setupCCTV()
    }, setupCCTV: function () {
        var a = $(".cctv", this.$parentChapter);
        this.cctv = new ib.CCTV(a, this.opts.CCTVOpts);
        var b = $(this.opts.canvasTarget, this.$parentChapter);
        this.cctv.init(b)
    }, addDot: function (a) {
        var b = $(ib.Templates["dot.html"](a));
        this.$context.append(b), this.dots.push(b), a.image && (b.data(a), this.CCTVDots.push(b))
    }, randomizeScales: function () {
        var a = 1;
        for (var b in this.dots) a = this.opts.minScale + Math.random() * (this.opts.maxScale - this.opts.minScale), this.dots[b].css({transform: "scale(" + a + ")"})
    }, updateProgress: function (a) {
        a >= this.opts.start && a < this.opts.end ? this.complete || this.animating || !this.$parentChapter.hasClass("active-chapter") || this.startAnimation() : this.complete && this.reset()
    }, startAnimation: function () {
        this.animating = !0, this.show(), this.beginUpdates()
    }, onComplete: function () {
        this.complete = !0, this.animating = !1
    }, beginUpdates: function () {
        this.cctv && 1 === this.CCTVDots.length ? setTimeout($.proxy(this.triggerCCTV, this), this.opts.initialCCTVRevealDelay) : this.cctv && (clearInterval(this.CCTVInterval), this.CCTVInterval = setInterval($.proxy(this.triggerCCTV, this), this.opts.CCTVWaitTime), setTimeout($.proxy(this.triggerCCTV, this), this.opts.initialCCTVRevealDelay))
    }, triggerCCTV: function () {
        null === this.CCTVDotIndex ? this.CCTVDotIndex = Math.floor(Math.random() * this.CCTVDots.length) : (this.CCTVDotIndex++, this.CCTVDotIndex >= this.CCTVDots.length && (this.CCTVDotIndex = 0)), this.cctv.setDot(this.CCTVDots[this.CCTVDotIndex].data(), $.proxy(this.getActiveDotCoords, this))
    }, getActiveDotCoords: function () {
        var a = this.CCTVDots[this.CCTVDotIndex];
        return {x: a.position().left + .5 * a.width(), y: a.position().top + .5 * a.height()}
    }, show: function () {
        var a = this;
        $("> li", this.$context).delay(this.opts.delay).each(function () {
            $(this).delay(Math.random() * a.opts.maxDelayStagger).animate({opacity: 1}, {duration: a.opts.duration})
        }), this.cctv && this.cctv.show(), setTimeout($.proxy(this.onComplete, this), this.opts.duration + this.opts.maxDelayStagger + this.opts.delay)
    }, hide: function () {
        this.opts.fadeOutDuration ? ($("> li", this.$context).animate({opacity: 0}, this.opts.fadeOutDuration), this.canvas && this.canvas.animate({opacity: 0}, this.opts.fadeOutDuration)) : ($("> li", this.$context).css({opacity: 0}), this.cctv && this.cctv.hide())
    }, reset: function () {
        this.hide(), this.complete = !1, this.animating = !1, clearInterval(this.CCTVInterval), this.CCTVInterval = null
    }
}, ib.ComponentLoader.register("ib.Dots", ib.Dots);
var ib = ib || {};
ib.Header = function (a, b) {
    this.$context = a, this.$overlayLogo = $(".blume-logo", a), this.$progressBar = $(".story-progress-bar", a), this.$navLinks = $("nav li a", this.$context), this.navLinkAnimations = [], this.navLinksAnimated = !1, this.soundProgress = 0, this.soundDuration = 0, this.soundStartTime = 0, this.soundStartMs = 0, this.soundUpdateInterval = 0, this.opts = $.extend({}, b || a.data())
}, ib.Header.prototype = {
    init: function () {
        this.setupNavLinks(), $(ib).on(ib.Events.CHAPTER_DID_CHANGE, $.proxy(this.updateNavHighlight, this)), $(ib).on(ib.Events.NETWORK_DID_ZOOM_OUT, $.proxy(this.showOverlayLogo, this)), $(ib).on(ib.Events.NETWORK_DID_ZOOM_IN, $.proxy(this.hideOverlayLogo, this)), $(ib).on(ib.Events.SCROLLER_DID_SCROLL, $.proxy(this.handleScrollUpdate, this)), $(ib).on(ib.Events.PRELOADER_DID_HIDE, $.proxy(this.preloaderDidHide, this)), this.$navLinks.on("mouseenter", $.proxy(this.onNavLinkOver, this))
    }, setupNavLinks: function () {
        var a = this;
        this.$navLinks.each(function (b, c) {
            var d = new ib.Oomph($(c), {scramble: !0, animationStartDelay: 500 * b});
            d.init(), a.navLinkAnimations.push(d)
        }).add(".ctos-logo a", this.$context).on("click", $.proxy(this.onNavClick, this))
    }, handleScrollUpdate: function (a, b) {
        this.$progressBar.css("width", 100 * b.progress + "%")
    }, preloaderDidHide: function () {
        if (!this.navLinksAnimated) {
            var a = 0;
            for (var b in this.navLinkAnimations) {
                var c = this.navLinkAnimations[b];
                c.animate($.proxy(function () {
                    ++a === this.navLinkAnimations.length && setTimeout(this.updateNavHighlight, 200)
                }, this, b))
            }
            this.navLinksAnimated = !0
        }
    }, showOverlayLogo: function () {
        $(ib).trigger(ib.Events.SHOW_OVERLAY_LOGO)
    }, hideOverlayLogo: function () {
        $(ib).trigger(ib.Events.HIDE_OVERLAY_LOGO)
    }, onNavClick: function (a) {
        a.preventDefault();
        var b = $(a.currentTarget);
        ib.ScrollController.jumpToChapter(b.data("chapter-index"), !1), this.showOverlayLogo()
    }, updateNavHighlight: function () {
        $("nav .active", this.$context).removeClass("active"), $("nav li", this.$context).eq(ib.ScrollController.getCurrentChapterIndex()).addClass("active"), ib.SoundController.playSfx("wd-ctos_all_section-text-highlights-blue-dot-01")
    }, onNavLinkOver: function (a) {
        var b = $(a.currentTarget).data("chapter-index"), c = this.navLinkAnimations[parseInt(b, 10)];
        "undefined" != typeof c && (c.opts.animationStartDelay = 0, c.animate()), ib.SoundController.playSfx("wd-ctos_all_top-nav-rollover-01")
    }, update: function (a, b) {
        for (var c in a) {
            step = a[c];
            var d = step.end - step.start, e = Math.max(0, Math.min(d, b - step.start)), f = e / d;
            f > 0 && 1 > f && (step.addClass ? this.$context.addClass(step.addClass) : step.removeClass && this.$context.removeClass(step.removeClass))
        }
    }
}, ib.ComponentLoader.register("ib.Header", ib.Header);
var ib = ib || {};
ib.InfographicQuestion = function (a, b) {
    this.$context = a, this.$question = $(".question-wrap", a), this.$answer = $(".answer-wrap", a), this.$acceptButton = $(".accept", this.$question), this.$nextButton = $(".next", this.$answer), this.$questionStats = $(".statistic .value", this.$question), this.$answerStats = $(".statistic .value", this.$answer), this.$currentStats = null, this.raf = null, this.animStartTime = null, this.dashes = null, this.opts = $.extend({
        duration: 800,
        animationDelay: 200,
        easing: "easeOutCubic"
    }, b || a.data())
}, ib.InfographicQuestion.template = "infographic-question.html", ib.InfographicQuestion.prototype = {
    init: function () {
        this.$acceptButton.on("click", $.proxy(this.showAnswer, this)), this.$acceptButton.on("mouseover", $.proxy(this.onButtonHover, this)), this.$nextButton.on("click", $.proxy(this.completeQuestion, this)), this.$nextButton.on("mouseover", $.proxy(this.onButtonHover, this)), this.start(this.$questionStats)
    }, onButtonHover: function () {
        ib.SoundController.playSfx("wd-ctos_imagine_accept-button-rollover-01")
    }, start: function (a) {
        this.stop(), this.$currentStats = a;
        var b = this;
        setTimeout(function () {
            b.animStartTime = (new Date).getTime(), b.raf = requestAnimationFrame($.proxy(b.step, b))
        }, this.opts.animationDelay)
    }, stop: function () {
        cancelAnimationFrame(this.raf), this.raf = null, Modernizr.canvas && (this.dashes = null, this.dashes = new ib.Dashes(this.$context.find(".dashes-wrapper")), this.dashes.init(), this.dashes.play())
    }, commaSeparateNumber: function (a) {
        for (; /(\d+)(\d{3})/.test(a.toString());) a = a.toString().replace(/(\d+)(\d{3})/, "$1,$2");
        return a
    }, step: function () {
        this.raf = requestAnimationFrame($.proxy(this.step, this));
        var a = this;
        this.$currentStats.each(function () {
            var b = $(this), c = (new Date).getTime(), d = a.opts.duration, e = Math.min(d, c - a.animStartTime), f = 0,
                g = parseInt(b.data("target-value"), 10), h = f;
            h = $.easing[a.opts.easing] ? Math.round($.easing[a.opts.easing](null, e, f, g, d)) : Math.round(g * e / d + f), b.html(a.commaSeparateNumber(h))
        })
    }, showAnswer: function () {
        ib.SoundController.playSfx("wd-ctos_imagine_accept-button-click-transition-01"), this.start(this.$answerStats), this.$context.trigger(ib.Events.QUESTION_ANSWERED);
        var a = this;
        this.$question.fadeOut(250, "easeOutQuad", function () {
            a.$answer.fadeIn(250, "easeOutQuad")
        }), Modernizr.canvas && this.dashes.toggleColor(!0)
    }, completeQuestion: function () {
        this.stop(), this.$context.trigger(ib.Events.NEXT_QUESTION_REQUESTED), Modernizr.canvas && this.dashes.toggleColor(!1)
    }
}, ib.ComponentLoader.register("ib.InfographicQuestion", ib.InfographicQuestion);
var ib = ib || {};
ib.IntroLogo = function (a, b) {
    this.$context = a, this.$image = $(".logo", this.$context), this.$parentChapter = a.parents(".chapter"), this.backwards = !1, this.cachedImages = [], this.numAssetsLoaded = 0, this.numAssetsToLoad = 0, this.raf = null, this.active = !1, this.restartHideTimeout = null, this.startTime = (new Date).getTime(), this.opts = $.extend(ib.ChapterData["chapter-1"].introLogoOpts, b || a.data())
}, ib.IntroLogo.prototype = {
    init: function () {
        $(ib).on(ib.Events.NETWORK_DID_BEGIN, $.proxy(this.onNetworkBegin, this)), this.preloadLogo(), ib.Config.SKIP_INTRO && setTimeout(function () {
            $(ib).trigger(ib.Events.INTRO_LOGO_REVEALED)
        }, 0)
    }, onNetworkBegin: function () {
        $(".bg", this.$context).css({opacity: .9})
    }, preloadLogo: function () {
        for (var a = ib.ChapterData["chapter-1"].introLogoOpts, b = a.startFrameNum + a.numFrames, c = [], d = a.startFrameNum; b > d; d++) c.push(a.getFilename(d));
        this.numAssetsToLoad = c.length;
        for (var e in c) {
            var f = new Image;
            f.onerror = f.onload = $.proxy(this.onAssetLoaded, this), f.src = c[e], this.cachedImages[c[e]] = f
        }
    }, onAssetLoaded: function () {
        if (this.numAssetsLoaded++, this.isReady()) {
            var a = (new Date).getTime(), b = Math.max(0, 2e3 - (a - this.startTime)), c = this;
            setTimeout(function () {
                c.active = !0, c.startAnimation(), setTimeout(function () {
                    ib.Config.SKIP_INTRO || $(ib).trigger(ib.Events.INTRO_LOGO_REVEALED)
                }, 1.5 * c.opts.duration)
            }, b)
        }
    }, startAnimation: function (a) {
        null === this.raf && (this.stopAnimation(), this.backwards = a, this.animationStartTime = (new Date).getTime(), this.raf = requestAnimationFrame($.proxy(this.step, this)), a ? ib.SoundController.playSfx("wd-ctos_intro_logo-build-out-01") : ib.SoundController.playSfx("wd-ctos_intro_logo-build-in-01"))
    }, stopAnimation: function () {
        cancelAnimationFrame(this.raf), this.raf = null
    }, step: function () {
        this.raf = requestAnimationFrame($.proxy(this.step, this));
        var a = (new Date).getTime(), b = this.opts.duration,
            c = this.backwards ? Math.max(0, this.animationStartTime + b - a) : Math.min(b, a - this.animationStartTime),
            d = this.opts.startFrameNum, e = this.opts.numFrames - 1, f = Math.round(e * c / b + d),
            g = this.opts.getFilename(f);
        this.$image[0].src = g, (!this.backwards && f == this.opts.startFrameNum + this.opts.numFrames - 1 || this.backwards && f == this.opts.startFrameNum) && (this.stopAnimation(), this.backwards && this.hide())
    }, isReady: function () {
        return this.numAssetsLoaded == this.numAssetsToLoad && 0 !== this.numAssetsLoaded
    }, updateProgress: function (a) {
        if (a >= this.opts.start && a < this.opts.end) {
            if (this.isReady() && !this.active && this.$parentChapter.hasClass("active-chapter")) {
                var b = this.opts.getFilename(this.opts.startFrameNum + this.opts.numFrames - 1);
                this.$image[0].src = b, clearTimeout(this.restartHideTimeout), this.restartHideTimeout = setTimeout($.proxy(this.animateOut, this), 500)
            }
        } else this.active && this.isReady() && this.animateOut()
    }, animateOut: function () {
        this.active = !1, this.stopAnimation(), this.startAnimation(!0)
    }, show: function () {
        this.active = !0, this.startAnimation()
    }, hide: function () {
        this.active = !1, this.$image[0].src = this.opts.getFilename(this.opts.startFrameNum)
    }
}, ib.ComponentLoader.register("ib.IntroLogo", ib.IntroLogo);
var ib = ib || {};
ib.MultipleChoiceQuestion = function (a, b) {
    this.$context = a, this.$question = $(".question-wrap", a), this.$acceptButton = $(".accept", this.$question), this.$answer = $(".answer-wrap", a), this.$nextButton = $(".next", this.$answer), this.dashes = null, this.opts = $.extend({}, b || a.data())
}, ib.MultipleChoiceQuestion.template = "multiple-choice-question.html", ib.MultipleChoiceQuestion.prototype = {
    init: function () {
        $("li", this.$question).on("click", $.proxy(this.showAnswer, this)).on("mouseenter", $.proxy(this.onBenefitOver, this)), $(".next", this.$next).on("click", $.proxy(this.completeQuestion, this)), this.$acceptButton.on("mouseover", $.proxy(this.onButtonHover, this)), this.$nextButton.on("mouseover", $.proxy(this.onButtonHover, this)), Modernizr.canvas && (this.dashes = new ib.Dashes(this.$context.find(".dashes-wrapper"), {
            numDashes: 15,
            maxDashSpeed: 15
        }), this.dashes.init(), this.dashes.play())
    }, onBenefitOver: function () {
        ib.SoundController.playSfx("wd-ctos_imagine_most-appealing-rollover-01")
    }, onButtonHover: function () {
        ib.SoundController.playSfx("wd-ctos_imagine_accept-button-rollover-01")
    }, showAnswer: function (a) {
        ib.SoundController.playSfx("wd-ctos_imagine_accept-button-click-transition-01");
        var b = $(a.currentTarget).data("choice");
        $(ib).trigger(ib.Events.FACT_CHOSEN, {fact: b}), this.$context.trigger(ib.Events.QUESTION_ANSWERED);
        var c = this;
        this.$question.fadeOut(250, "easeOutQuad", function () {
            c.$answer.fadeIn(250, "easeOutQuad")
        }), Modernizr.canvas && this.dashes.toggleColor(!0)
    }, completeQuestion: function () {
        this.$context.trigger(ib.Events.NEXT_QUESTION_REQUESTED), Modernizr.canvas && this.dashes.toggleColor(!1)
    }
}, ib.ComponentLoader.register("ib.MultipleChoiceQuestion", ib.MultipleChoiceQuestion);
var ib = ib || {};
ib.Network = ib.Network || {}, ib.Network.Dot = function () {
    this.radius = 4, this.xpos = 0, this.ypos = 0, this.zpos = 0, this.xposOriginal = 0, this.yposOriginal = 0, this.vx = 0, this.vy = 0, this.vz = 0, this.mass = 0, this.x = 0, this.y = 0, this.scaleX = 1, this.scaleY = 1, this.connections = [], this.randomIndex = 0, this.connectionProgress = 0
}, ib.Network.distance = function (a, b, c, d) {
    return Math.sqrt((c - a) * (c - a) + (d - b) * (d - b))
}, ib.Network.Dots = function (a, b, c) {
    this.$context = a, this.$parentChapter = a.parents(".chapter"), this.$header = $("#header"), this.raf = null, this.balls = [], this.numBalls = 0, this.fl = 100, this.vpX = 0, this.vpY = 0, this.orbit = 400, this.angleX = 0, this.angleY = 0, this.yDensity = 20, (ib.isIE || b.forceReducedBallCount) && (this.yDensity = 5), this.hiding = !1, this.active = !1, this.lastTimeRandomized = null, this.randomizeTime = 3e3, this.connected = !1, this.randomizing = !0, this.isScaling = !1, this.canBegin = !1, Modernizr.canvas && (this.canvas = this.$context[0], this.ctx = this.canvas.getContext("2d")), this.cctv = null, this.STATES = {
        ZOOMED_IN: -1,
        ZOOMED_NORMAL: 0
    }, this.state = c ? this.STATES.ZOOMED_NORMAL : this.STATES.ZOOMED_IN, this.opts = $.extend({
        start: 0,
        end: 1,
        zoomNormalKeyframe: .29,
        dotColor: "#000",
        lightColor: "#fff",
        highlightColor: "#333",
        easing: "easeOutQuad",
...
}, ib.Network.Dots.prototype = {
    init: function () {
        $(window).on("resize", $.throttle(1e3, $.proxy(this.resize, this))), $(ib).on(ib.Events.PRELOAD_READY_FOR_DOTS, $.proxy(this.initialResize, this)), Modernizr.canvas && this.opts.cctvCanvasTarget && this.setupCCTV()
    }, initialResize: function () {
        this.canBegin = !0, this.show(), this.$context.show(), this.resize(), $(ib).trigger(ib.Events.NETWORK_DID_BEGIN)
    }, changeState: function (a) {
        if (this.state != a) switch (this.state = a, this.updateScale(), a) {
            case this.STATES.ZOOMED_IN:
                this.connected = !1, this.disconnectDots(!1), this.updateScale(), $(ib).trigger(ib.Events.NETWORK_DID_ZOOM_IN);
                break;
            case this.STATES.ZOOMED_NORMAL:
                this.updateScale(), setTimeout(function () {
                    $(ib).trigger(ib.Events.NETWORK_DID_ZOOM_OUT)
                }, 1400)
        }
    }, setupCCTV: function () {
        var a = $(this.opts.cctvContextTarget, this.$parentChapter);
        this.cctv = new ib.CCTV(a, this.opts.CCTVOpts);
        var b = $(this.opts.cctvCanvasTarget, this.$parentChapter);
        this.cctv.init(b, $.proxy(this.dotNearestPoint, this))
    }, dotNearestPoint: function (a) {
        var b = 0, c = ib.Network.distance(this.balls[0].x, this.balls[0].y, a.x, a.y), d = null, e = null;
        for (var f in this.balls) e = this.balls[f], d = ib.Network.distance(e.x, e.y, a.x, a.y), c > d && !e.connected && (b = f, c = d);
        return this.balls[b]
    }, resize: function () {
        if (Modernizr.canvas) {
            this.stop(), this.vpX = this.$context.width() / 2, this.vpY = this.$context.height() / 2, this.canvas.width = this.$context.width(), this.canvas.height = this.$context.height(), this.numBalls = Math.round(.66 * this.canvas.width / 8), (ib.isIE || this.opts.forceReducedBallCount) && (this.numBalls = Math.min(25, this.numBalls)), this.balls = [];
            for (var a = null, b = 0; b < this.numBalls; b++) a = new ib.Network.Dot, a.xpos = 2 * b * this.vpX / this.numBalls - this.vpX + 100 * Math.random() * (Math.random() < .5 ? -1 : 1), a.ypos = .75 === this.opts.initialYRange ? 2 * .75 * (b % this.yDensity) * this.vpY / this.yDensity - .75 * this.vpY : 2 * .35 * (b % this.yDensity) * this.vpY / this.yDensity - .35 * this.vpY, a.ypos += b < this.numBalls / 2.5 ? -this.vpY / 6 : this.vpY / 10, this.numBalls / 3.1 < b && b < this.numBalls / 2.9 && (a.ypos = .03 * Math.random() * this.vpY * (Math.random() < .5 ? -1 : 1)), a.zpos = Math.min(this.opts.zoomNormalZ, 80 * this.state) + -5 * Math.random(), a.xposOriginal = a.xpos, a.yposOriginal = a.ypos, a.connectionProgress = this.connected ? 1 : 0, this.balls.push(a);
            this.randomize(0), this.randomize(0);
            for (var c in this.balls) {
                var d = this.balls[c];
                for (var e in this.balls) if (c != e) {
                    var f = this.balls[e],
                        g = {distance: ib.Network.distance(d.xpos, d.ypos, f.xpos, f.ypos), index: e};
                    d.connections.push(g)
                }
                d.connections.sort(function (a, b) {
                    return a.distance - b.distance
                }), d.connections = d.connections.slice(0, 6)
            }
            this.active && this.start()
        }
    }, updateProgress: function (a) {
        a < this.opts.zoomNormalKeyframe ? this.changeState(this.STATES.ZOOMED_IN) : a < this.opts.end && this.changeState(this.STATES.ZOOMED_NORMAL), a >= this.opts.start && a < this.opts.end ? !this.active && this.$parentChapter.hasClass("active-chapter") && this.show() : this.active && !this.hiding && (this.hide(), this.cctv && this.cctv.hide()), !this.connected && this.opts.connectionBegin < a && a < this.opts.connectionEnd ? this.connectDots() : this.connected && a > this.opts.connectionEnd && (this.disconnectDots(!0), this.scatterDots(.2)), this.cctv && this.cctv.updateProgress(a)
    }, show: function () {
        this.canBegin && (this.randomizing = !0, this.active = !0, this.hiding = !1, this.resize(), this.$context.fadeIn(1500, this.opts.easing))
    }, hide: function () {
        this.hiding = !0, this.CCTVDotIndex = null;
        var a = this;
        this.$context.fadeOut(1e3, this.opts.easing, function () {
            a.hiding = !1, a.stop(), a.active = !1
        })
    }, start: function () {
        this.stop(), this.raf = requestAnimationFrame($.proxy(this.update, this))
    }, stop: function () {
        cancelAnimationFrame(this.raf)
    }, randomize: function (a) {
        this.lastTimeRandomized = (new Date).getTime(), this.angleX = .001 * Math.random() * (Math.random() < .5 ? -1 : 1), this.angleY = .001 * Math.random() * (Math.random() < .5 ? -1 : 1), TweenLite.to(this, 2.9, {
            angleX: 0,
            angleY: 0,
            delay: 1
        });
        for (var b = 20, c = 10 + 60 * Math.random(), d = 0; d < this.numBalls; d++) {
            var e = this.balls[d], f = Math.random() * b;
            f *= Math.random() < .5 ? 1 : -1, f = f > 0 ? Math.min(e.xposOriginal + c - e.xpos, f) : Math.max(e.xposOriginal - c - e.xpos, f);
            var g = Math.random() * b;
            g *= Math.random() < .5 ? 1 : -1, g = g > 0 ? Math.min(e.yposOriginal + c - e.ypos, g) : Math.max(e.yposOriginal - c - e.ypos, g);
            var h = Math.random() * b / 2;
            h *= Math.random() < .5 ? 1 : -1, h = h > 0 ? Math.min(Math.min(this.opts.zoomNormalZ, 80 * this.state) + c - e.zpos, h) : Math.max(Math.min(this.opts.zoomNormalZ, 80 * this.state) - c - e.zpos, h);
            var i = {xpos: e.xpos + f, ypos: e.ypos + g, delay: .005 * d};
            this.isScaling || (i.zpos = e.zpos + h);
            var j = a || 2.9;
            TweenLite.to(e, j, i)
        }
    }, connectDots: function () {
        this.connected = !0;
        for (var a, b, c = 0; c < this.numBalls; c++) a = this.balls[c], b = .5 * Math.random() + 2, TweenLite.to(a, b, {
            connectionProgress: 1,
            delay: 3 * Math.random()
        })
    }, disconnectDots: function (a) {
        this.connected = !1, this.randomizing = !1;
        for (var b, c, d = 0; d < this.numBalls; d++) b = this.balls[d], c = a ? .5 * Math.random() : 0, TweenLite.to(b, c, {connectionProgress: 0})
    }, scatterDots: function (a) {
        for (var b, c, d, e = 0; e < this.numBalls; e++) b = this.balls[e], c = .5 * Math.random() + 3, d = b.ypos / b.xpos, xScatter = this.vpY * (b.ypos < 0 ? -1 : 1) / d, yScatter = d * this.vpX * (b.xpos < 0 ? -1 : 1), TweenLite.to(b, c, {
            xpos: xScatter,
            ypos: yScatter,
            zpos: b.zpos - 100,
            delay: .2 * Math.random() + a
        })
    }, updateScale: function () {
        this.isScaling = !0;
        for (var a = this, b = this.state == this.STATES.ZOOMED_NORMAL ? this.opts.zoomOutDuration : .1, c = 0; c < this.numBalls; c++) {
            var d = this.balls[c];
            TweenLite.killTweensOf(d), TweenLite.to(d, b, {
                zpos: Math.min(this.opts.zoomNormalZ, 80 * this.state),
                easing: this.opts.zoomOutEasing,
                complete: function () {
                    a.isScaling = !1
                }
            })
        ...
        this.raf = requestAnimationFrame($.proxy(this.update, this));
        for (var a = 0; a < this.balls.length; a++) {
            var b = this.balls[a];
            this.rotateX(b, this.angleX), this.rotateY(b, this.angleY), this.doPerspective(b)
        }
        this.draw();
        var c = (new Date).getTime();
        this.randomizing && c - this.lastTimeRandomized > this.randomizeTime && this.randomize()
    }, draw: function () {
        if (Modernizr.canvas) {
            this.ctx.clearRect(0, 0, this.canvas.width, this.canvas.height), this.ctx.strokeStyle = "#d5d5d5", this.ctx.lineWidth = .4 - .5 * this.state;
            var a = 0, b = 0, c = 0, d = 0, e = 0, f = 0, g = null, h = null;
            this.ctx.beginPath();
            for (var i = 0; i < this.balls.length; i++) {
                g = this.balls[i], a = g.x, b = g.y;
                for (var j in g.connections) h = this.balls[g.connections[j].index], c = h.x, d = h.y, e = g.connectionProgress * (c - a) + a, f = g.connectionProgress * (d - b) + b, this.ctx.moveTo(a, b), this.ctx.lineTo(e, f)
            }
            this.ctx.stroke();
            var k = 0, l = 0, m = 3;
            this.ctx.beginPath(), this.ctx.fillStyle = this.$header.hasClass("light") ? this.opts.lightColor : this.opts.dotColor;
            for (var n = 0; n < this.balls.length; n++) k = this.balls[n].x, l = this.balls[n].y, m = Math.min(6, 2 * this.balls[n].scaleX), this.ctx.moveTo(k, l), this.ctx.arc(k, l, m, 0, 2 * Math.PI, !1);
            this.ctx.fill()
        }
    }, rotateX: function (a, b) {
        var c = [a.xpos, a.ypos, a.zpos], d = Math.sin(b), e = Math.cos(b), f = [];
        f[0] = [1, 0, 0], f[1] = [0, e, d], f[2] = [0, -d, e];
        var g = this.matrixMultiply(c, f);
        a.xpos = g[0], a.ypos = g[1], a.zpos = g[2]
    }, rotateY: function (a, b) {
        var c = [a.xpos, a.ypos, a.zpos], d = Math.sin(b), e = Math.cos(b), f = [];
        ...
        var b = 1;
        a.visible = a.zpos > -this.fl, a.visible && (b = this.fl / (this.fl + a.zpos), a.scaleX = a.scaleY = b, a.x = this.vpX + a.xpos * b, a.y = this.vpY + a.ypos * b)
    }
}, ib.ComponentLoader.register("ib.Network.Dots", ib.Network.Dots);
var ib = ib || {};
ib.Network2 = ib.Network2 || {}, ib.Network2.Lattice1 = function (a) {
    this.POLAR = com.jeffyamada.geom.Point.polar, this.points = null, this.opts = $.extend({}, a)
}, ib.Network2.Lattice1.prototype = {
    setPoints: function (a) {
        this.points = a
    }, setPositions: function () {
        var a = 30, b = 100;
        this.points.length / 20 * (b / 2);
        var c = 5 * b;
        for (i = 0; i < this.points.length; i++) {
            var d = this.points[i], e = 90, f = this.points.length / a * (e / 2),
                g = Math.floor(i / a) * e - f + i % 2 * (e / 2), h = this.POLAR(g, 1e3);
            console.log("p:", h.x, h.y), d.position.x = h.x, d.position.z = h.y, d.position.y = i % 10 * b - c
        }
    }
};
var ib = ib || {};
ib.Network2 = function (a, b) {
    this.$context = a, this.aspectRatio = window.innerWidth / window.innerHeight, this.scene = new THREE.Scene, this.camera = null, this.material = null, this.renderer = null, this.groupd = null, this.opts = $.extend({}, b || a.data())
}, ib.Network2.prototype = {
    init: function () {
        this.createCamera(), this.createMaterial(), this.createRenderer(), this.group = new THREE.Object3D, this.group.position.z = 0, this.scene.add(this.group);
        for (var a = [], b = 0; 300 > b; b++) particle = new THREE.Particle(this.material), particle.scale.x = particle.scale.y = 10, a.push(particle), this.group.add(particle);
        var c = new ib.Network2.Lattice1;
        c.setPoints(a), c.setPositions(), console.log(c);
        var d = this.group.children.length - 1;
        for (b = 0; 300 > b; b++) {
            var e = this.group.children[Math.round(Math.random() * d)],
                f = this.group.children[Math.round(Math.random() * d)], g = new THREE.LineBasicMaterial({color: 0}),
                h = new THREE.Geometry;
            h.vertices.push(new THREE.Vector3(e.position.x, e.position.y, e.position.z)), h.vertices.push(new THREE.Vector3(f.position.x, f.position.y, f.position.z)), new THREE.Line(h, g)
        }
        this.animate()
    }, updateProgress: function () {
    }, drawBallMethod: function (a) {
        var b = 2 * Math.PI;
        a.beginPath(), a.arc(0, 0, 1, 0, b, !0), a.fill()
    }, addListeners: function () {
        document.addEventListener("mousemove", onDocumentMouseMove, !1), document.addEventListener("touchstart", onDocumentTouchStart, !1), document.addEventListener("touchmove", onDocumentTouchMove, !1), window.addEventListener("resize", onWindowResize, !1)
    }, createCamera: function () {
        this.camera = new THREE.PerspectiveCamera(100, this.aspectRatio, 2, 6e3), this.camera.position.z = 1e3
    }, createMaterial: function () {
        var a = {};
        a.color = 0, a.program = $.proxy(this.drawBallMethod, this), this.material = new THREE.ParticleCanvasMaterial(a)
    }, createRenderer: function () {
        this.renderer = new THREE.CanvasRenderer, this.renderer.setSize(window.innerWidth, window.innerHeight), this.$context.append(this.renderer.domElement)
    }, onWindowResize: function () {
        windowHalfX = window.innerWidth / 2, windowHalfY = window.innerHeight / 2, this.camera.aspect = window.innerWidth / window.innerHeight, this.camera.updateProjectionMatrix(), this.renderer.setSize(window.innerWidth, window.innerHeight)
    }, onDocumentMouseMove: function (a) {
        this.mouseX = a.clientX - windowHalfX, mouseY = a.clientY - windowHalfY
    }, onDocumentTouchStart: function (a) {
        1 === a.touches.length && (a.preventDefault(), mouseX = a.touches[0].pageX - windowHalfX, mouseY = a.touches[0].pageY - windowHalfY)
    }, onDocumentTouchMove: function (a) {
        1 === a.touches.length && (a.preventDefault(), mouseX = a.touches[0].pageX - windowHalfX, mouseY = a.touches[0].pageY - windowHalfY)
    }, animate: function () {
        requestAnimationFrame($.proxy(this.animate, this)), this.render()
    }, render: function () {
        this.camera.lookAt(this.scene.position), this.renderer.render(this.scene, this.camera)
    }
}, ib.ComponentLoader.register("ib.Network2", ib.Network2);
var ib = ib || {};
ib.Oomph = function (a, b) {
    this.context = a, this.characters = null, this.animating = !1, this.letterArray = null, this.opts = $.extend(!0, {}, {
        showInitially: !1,
        ...
        animationDelay: 50,
        scrambleDelay: 40,
        scrambleLettersDelay: 11,
        maxTrailingCharacters: 1,
        typed: !1,
        scramble: !1,
        fadeOut: !0,
        before: {position: "relative", opacity: 0, left: -3},
        after: {opacity: 1, left: 0}
    }, b || a.data())
}, ib.Oomph.prototype = {
    init: function () {
        var a = this.context.html().match(/(<([^>]+)>|.)/gi), b = "";
        null !== a && ($.each(a, $.proxy(function (a, c) {
            if (this.opts.typed && " " === c && (c = "&nbsp;<wbr>"), /(<([^>]+))>/gi.test(c)) b += c; else {
                var d = "<span class='char'>" + c + "</span>";
                b += d
            }
        }, this)), this.context.html(b), this.characters = this.context.find(".char"), this.reset(), this.opts.scramble && (this.letterArray = String("!@#$%&<>1234567890~").split("")), this.opts.typed && this.context.css({wordWrap: "break-word"}))
    }, animate: function (a) {
        if (null !== this.characters && !this.animating) {
            this.animating = !0;
            var b = this.characters.length;
            this.context.is(":visible") || this.context.show(), this.opts.scramble ? this.scramble(b, a) : this.animateProperties(b, a)
        }
    }, animateProperties: function (a, b) {
        setTimeout($.proxy(function () {
            $.each(this.characters, $.proxy(function (c, d) {
                var e = $(d), f = null;
                this.opts.typed && (f = e.clone(), e.text("_")), e.css({zIndex: c + 1}).stop().delay(c * this.opts.animationDelay).animate(this.opts.after, {
                    duration: this.opts.animationDuration,
                    easing: this.opts.easing,
                    complete: $.proxy(function () {
                        c === a - 1 && (b && b(), this.animating = !1), this.opts.typed && setTimeout($.proxy(function () {
                            e.text(f.text())
                        }, this), this.opts.animationDelay)
                    }, this)
                })
            }, this))
        }, this), this.opts.animationStartDelay)
    }, scramble: function (a, b) {
        function c(a) {
            for (var b, c, d = a.length; d--;) c = 0 | Math.random() * (d + 1), b = a[d], a[d] = a[c], a[c] = b;
            return a
        }

        function d(d, e, g) {
            c(this.letterArray);
            for (var h = parseInt(Math.random() * this.opts.maxTrailingCharacters, 10) + 1, i = "", j = 0; h > j; j++) {
                var k = Math.floor(Math.random() * this.letterArray.length);
                i += this.letterArray[k]
            }
            e.text(i), d >= this.letterArray.length - 1 && (e.text(g), ++f === a && (b && b(), this.animating = !1))
        }

        function e(a, b) {
            var c = $(a), e = c.text();
            c.text(""), c.show();
            for (var f = this.letterArray.length, g = 0; --f > 0;) g++, setTimeout($.proxy(d, this, g, c, e, b), this.opts.scrambleLettersDelay * g)
        }

        var f = 0;
        setTimeout($.proxy(function () {
            $.each(this.characters, $.proxy(function (a, b) {
                setTimeout($.proxy(e, this, b, a), this.opts.scrambleDelay * a)
            }, this))
        }, this), this.opts.animationStartDelay)
    }, reset: function () {
        this.animating = !1, this.opts.showInitially || (this.opts.scramble ? this.characters.hide() : $.each(this.characters, $.proxy(function (a, b) {
            $(b).css(this.opts.before).finish()
        }, this)), this.context.hide())
    }, fadeout: function () {
        this.context.stop().fadeOut("slow")
    }, updateProgress: function (a) {
        a >= this.opts.start && a < this.opts.end ? this.animating || this.animate() : this.opts.fadeOut && this.context.is(":visible") ? this.context.fadeOut("slow") : this.reset()
    }
}, ib.ComponentLoader.register("ib.Oomph", ib.Oomph);
var ib = ib || {};
ib.ShareSurveyResults = function (a, b) {
    this.$context = a, this.$headline = $(".headline", a), this.$factNum = $(".fact-num", a), this.$fact = $(".fact-body", a), this.facts = ib.ChapterData["chapter-4"].getText().facts, this.opts = $.extend({}, b || a.data())
}, ib.ShareSurveyResults.prototype = {
    init: function () {
        $(ib).on(ib.Events.FACT_CHOSEN, $.proxy(this.onFactChosen, this))
    }, onFactChosen: function (a, b) {
        this.setFact(b.fact)
    }, setFact: function (a) {
        factCopy = this.facts[a], this.$headline.html(factCopy.headline), this.$factNum.html(factCopy.factNum), this.$fact.html(factCopy.fact)
    }
}, ib.ComponentLoader.register("ib.ShareSurveyResults", ib.ShareSurveyResults);
var ib = ib || {};
ib.SharedNetworkGraph = function (a, b) {
    this.$context = a, this.active = !1, this.network = null, this.toggleTimeout = null, this.opts = $.extend({startChapterIndex: 2}, b || a.data())
}, ib.SharedNetworkGraph.prototype = {
    init: function () {
        Modernizr.canvas && (this.network = new ib.Network.Dots(this.$context, {
            zoomNormalZ: 0,
            zoomOutEasing: "easeInCubic",
            dotColor: "#1e1e1e",
            initialYRange: .35,
            forceReducedBallCount: !0
        }, !0), $(window).on("resize", $.throttle(1e3, $.proxy(this.network.resize, this.network))), $(ib).on(ib.Events.CHAPTER_DID_CHANGE, $.proxy(this.onChapterChange, this)))
    }, onChapterChange: function () {
        var a = ib.ScrollController.getCurrentChapterIndex(), b = this;
        clearTimeout(this.toggleTimeout), b.toggleTimeout = setTimeout(function () {
            !b.active && a >= b.opts.startChapterIndex ? b.show() : b.active && a < b.opts.startChapterIndex && b.hide()
        }, 200)
    }, show: function () {
        this.active = !0;
        var a = this;
        a.network.canBegin = !0, a.network.show(), a.network.connectDots()
    }, hide: function () {
        this.active = !1, this.network.hide()
    }
}, ib.ComponentLoader.register("ib.SharedNetworkGraph", ib.SharedNetworkGraph);
var ib = ib || {};
ib.SocialMap = function (a, b) {
    this.$context = a, this.$parentChapter = a.parents(".chapter"), this.animating = !1, this.complete = !1, this.largestCount = 0, this.opts = $.extend({
        start: 0,
        end: 0,
        dots: null,
        maxFontSizeEm: 5,
...
}, ib.SocialMap.prototype = {
    init: function () {
        this.largestCount = Math.max.apply(Math, $.map(this.opts.dots, function (a) {
            return a.count
        })), this.populate(), this.reset()
    }, populate: function () {
        var a, b, c = (new Date).getTime(), d = 4 * (1 + Math.max(0, Math.min(5, (c - 1392068532196) / 1728e6))),
            e = parseInt(d * this.largestCount, 10);
        for (var f in this.opts.dots) a = this.opts.dots[f], a.sCount = parseInt(d * a.count, 10), a.left = 100 * a.x + "%", a.top = 100 * a.y + "%", a.delay = f * this.opts.delay, a.displayedCount = this.opts.dots.length - f < 9 ? a.sCount : "", a.fontSize = a.sCount / e * this.opts.maxFontSizeEm + "em", b = ib.Templates["map-dot.html"](a), this.$context.append(b)
    }, animate: function () {
        this.animating = !0, this.show(), ib.SoundController.playSfx("wd-ctos_all_text", 1300)
    }, reset: function () {
        this.animating = !1, this.complete = !0, this.hide()
    }, show: function () {
        var a = this;
        $.each(this.$context.find("li"), function (b, c) {
            var d = a.opts.dots[b];
            TweenLite.to($(c), a.opts.duration, {
                left: d.left,
                top: d.top,
                fontSize: d.fontSize,
                delay: d.delay,
                ...
                opacity: 1,
                onComplete: function () {
                    b === a.opts.dots.length - 1 && (this.complete = !0), b === a.opts.dots.length - 18 && ib.SoundController.playSfx("wd-ctos_connect_numbers-fly-out-of-map-01")
                }
            })
        })
    }, hide: function () {
        this.$context.find("li").css({left: "45%", top: "45%", fontSize: "0.1em", opacity: 0})
    }, updateProgress: function (a) {
        a >= this.opts.start && a < this.opts.end ? this.animating || this.animate() : this.complete && a < this.opts.start && this.reset()
    }
}, ib.ComponentLoader.register("ib.SocialMap", ib.SocialMap), ib.Super = function (a, b) {
    this.$context = a, this.$elements = a.find("li"), this.$activeEl = null, this.timeout = null, this.active = !1, this.opts = $.extend({}, b || a.data())
}, ib.Super.prototype = {
    init: function () {
    }, show: function () {
        this.active = !0;
        var a = this;
        $.each(this.$elements, function (b) {
            var c = a.opts.steps[b];
            a.timeout = setTimeout($.proxy(a.showNext, a, b), c.delay)
        })
    }, showNext: function (a) {
        this.$activeEl && this.$activeEl.fadeOut();
        var b = this.opts.steps[a], c = this.$elements.eq(a);
        c.stop().fadeIn(b.duration), this.$activeEl = c, ib.SoundController.playSfx(this.opts.steps[a].sfxId)
    }, hide: function () {
        this.active = !1, this.$elements.fadeOut(), clearTimeout(this.timeout)
    }, updateProgress: function (a) {
        !this.active && a >= this.opts.start && a < this.opts.end ? this.show() : this.active && (a < this.opts.start || a >= this.opts.end) && this.hide()
    }
}, ib.ComponentLoader.register("ib.Super", ib.Super);
var ib = ib || {};
ib.Testimonials = function (a, b) {
    this.$context = a, this.progress = null, this.$parentChapter = a.parents(".chapter"), this.active = !1, this.$testimonials = $(".testimonial", a), this.opts = $.extend({
        start: 0,
        end: .999,
        duration: 1e3,
        resetWaitTime: 2e3,
        firstTestimonyDelay: 2e3,
        delay: 0,
        easing: "linear",
        maxDelayStagger: 200,
        numImages: 1
    }, b || a.data())
}, ib.Testimonials.prototype = {
    init: function () {
        this.$context.on("click", "img", $.proxy(this.onClickTestimonial, this)), this.$context.on("mouseenter", "img", $.proxy(this.onHoverTestimonial, this)), this.$context.on("click", $.proxy(this.onBGClick, this)), this.setPictures()
    }, onHoverTestimonial: function () {
        $(".active", this.$context).removeClass("active"), this.$context.removeClass("active")
    }, setPictures: function () {
        var a = $("img", this.$context), b = Math.floor(Math.random() * this.opts.numImages), c = this;
        a.each(function (a) {
            var d = (b + a) % c.opts.numImages + 1;
            $(this).attr("src", ib.Config.assetBasePath + "/images/chapter-2/testimonial-" + d + ".jpg")
        })
    }, onBGClick: function () {
        this.$context.hasClass("active") && (this.$context.removeClass("active"), $(".active", this.$context).removeClass("active"))
    }, onClickTestimonial: function (a) {
        var b = $(a.currentTarget).parents(".testimonial");
        return $(".active", this.$context).removeClass("active"), b.addClass("active"), this.$context.addClass("active"), !1
    }, updateProgress: function (a) {
        !this.active && a >= this.opts.start && a < this.opts.end ? this.startAutoTestimony() : this.active && (a < this.opts.start || a >= this.opts.end) && this.stopAutoTestimony()
    }, startAutoTestimony: function () {
        this.active = !0, setTimeout($.proxy(this.showFirstTestimonial, this), this.opts.firstTestimonyDelay)
    }, showFirstTestimonial: function () {
        $(".testimonial-0 img", this.$context).click()
    }, stopAutoTestimony: function () {
        this.active = !1, this.$context.removeClass("active"), $(".active", this.$context).removeClass("active")
    }
}, ib.ComponentLoader.register("ib.Testimonials", ib.Testimonials);
var ib = ib || {};
